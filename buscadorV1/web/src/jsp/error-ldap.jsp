...
<%@ taglib prefix="integracionLdap" uri="/WEB-INF/tlds/integracionLdap.tld" %>
...
<h2><bean:message key='gestorFlujo.error'/></h2>
...
<input class="boton_125"  type="submit"  value="<bean:message key='gestorFlujo.aceptar'/>" />
</fieldset>
<!-- Fin Botones  -->
<!-- Fin Botones  -->
</form>
