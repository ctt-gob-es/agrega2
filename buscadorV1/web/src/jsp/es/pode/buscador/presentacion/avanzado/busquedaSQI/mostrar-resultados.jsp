	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<!--  INICIO CAJA DE FORMULARIO   -->
								<div id="formulario" >
								<form method="post" action="<html:rewrite action="/BusquedaSQICU/MostrarResultadosAnalizaTipoBusqueda.do"/>" name="formularioBusqueda">
					  				...
					  				<div class="fila_de_tabla">
										...
										<div class="contenedor_derecha_00">
											<div class="text"><input name="buscadorContenido" value="${form.buscadorContenido}"  onblur="this.style.backgroundColor='#e1e1e1'" id="buscadorContenido" type="text" title="<bean:message key="listar.odecu.mostrar.resultados.consulta.cabecera.descripcionTextoBusqueda"/>"  /><br class="oculto" />
												...
												<input type="hidden" name="busqSimpleAvanz" value="BUSCAR_SIMPLE"/>
											</div>
		...
		<display:table name="${form.lomEsVO}" 
	        ...
	        <display:setProperty name="css.tr.even" value="tr_gris"/>  	
	        	<display:column style="valign:top">
	        			...
	        			<table border="0" style="margin-bottom:3px;border:0" class="imagen_tab" cellpadding="0" cellspacing="0" width="100%" summary="${summary2 }">
	        				<tr>
						 <td class="ancho_det sin_e_pad"  valign="top"><img src="${resultado.imagen}"/></td>
	       					</tr>
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div id="formulario_02" >
  				<div class="fila_de_tabla">
  					<form method="post" action="<html:rewrite action="/BusquedaSQICU/MostrarResultadosAnalizaTipoBusqueda.do"/>">
	  					<div class="contenedor_izquierda_00">
	  						<div class="text">
