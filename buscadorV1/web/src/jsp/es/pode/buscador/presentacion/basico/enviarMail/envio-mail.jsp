...
<!-- ## Para pintar los mensajes de error ## -->
				...
				<div class="globo_gris_02">
					...
					<!--  INICIO CAJA DE FORMULARIO   -->
						<div id="formulario" >		
								...
								<div class="cja limpiar" >
									<div class="cja_02">
										<label for="Tucorreo"><bean:message key="enviar.email.amigo.tu.correo"/></label>										
											<input name="correoDesde" value="${form.correoDesde}"onblur="this.style.backgroundColor='#e1e1e1'"  class="cajatexto"  id="Tucorreo"  title="<bean:message key="enviar.email.amigo.tu.correo.tooltip"/>" type="text" />
									</div>								
									<div class="cja_02" >
							...
							<p class="normas">
								<em >
									<bean:message key="enviar.email.amigo.normas.de.uso.titulo"/>
								</em>
								<br />								
								<span>
	...
	<!-- Inicio Botones  -->
	<!-- Inicio Botones  -->	
	<input class="boton_125_de_2 tipo"  type="submit"  value="<bean:message key="enviar.email.amigo.boton.enviar"/>" />
	...
	<form method="post" action="<html:rewrite action="/EnviarMailCU/EnvioMailCancelar.do" />">		
		<input class="boton_125_de_2_izq tipo"  type="submit"  value="<bean:message key="taxonomias.cancelar.seleccion"/>" />
		<input type="hidden" name="tipoLayoutBuscador" value="${form.tipoLayoutBuscador}"/>
		<input name="identificadorODE" value="${form.identificadorODE}" type="hidden">
		<input name="idioma" value="${form.idioma}" type="hidden">
