					...
					<div class="globo_gris_03">
						<!--  INICIO CAJA DE FORMULARIO   -->
 						<div id="formulario_02" >
							...
							<div class="fila_de_tabla">
								<div class="text ft_lateral">
									<html:select name="form" style="width:535px !important" property="tipoNavegacion" title="" styleId="tipoNavegacion">
										<option value="" class="oscura"><bean:message key="taxonomias.seleccione.taxon"/></option>
										<html:optionsCollection name="form"  property="tipoNavegacionBackingList" label="label" value="value"/>
									</html:select>
								</div>
