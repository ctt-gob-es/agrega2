...
/**
 * Objeto que representa una orgacizaci贸n de un manifiesto
 *                         SCORM2004. Esta clase representa a un objeto
 * Organization.
 */
public class OrganizacionVO  implements java.io.Serializable {
    /* T铆tulo de la organizaci贸n. Representa el atributo title de
     * la
     *                                 clase Organization. */
     ...
     * 
     * @return title   * T铆tulo de la organizaci贸n. Representa el atributo title de
     * la
     *                                 clase Organization.
     */
     ...
     * 
     * @param title   * T铆tulo de la organizaci贸n. Representa el atributo title de
     * la
     *                                 clase Organization.
     */
