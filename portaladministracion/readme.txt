	...
	Project Name:               portaladministracion
	Project Id:                 portaladministracion
	Project version:            1.0
    ...
    /portaladministracion J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\javi mu¤oz\.maven\repository\portaladministracion\

        (*nix)
        /home/javi mu¤oz/.maven/repository/portaladministracion/
