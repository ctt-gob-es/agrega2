...
public class TareaDespublicarODEsVO  implements java.io.Serializable {
    ...
    /* Atributo que nos especifica si creamos la tarea de despublición
     * desde el planificador, como hasta ahora, o desde la
     *                                 despublicación del portalAdminsitrador.
     * en el primera caso será
     ...
     * 
     * @return desdePortal   * Atributo que nos especifica si creamos la tarea de despublición
     * desde el planificador, como hasta ahora, o desde la
     *                                 despublicación del portalAdminsitrador.
     * en el primera caso será
     *                                 false, y en el segundo true.
     ...
     * 
     * @param desdePortal   * Atributo que nos especifica si creamos la tarea de despublición
     * desde el planificador, como hasta ahora, o desde la
     *                                 despublicación del portalAdminsitrador.
     * en el primera caso será
     *                                 false, y en el segundo true.
