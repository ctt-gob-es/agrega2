...
public class SrvNoticiasServiceSoapBindingStub extends org.apache.axis.client.Stub implements es.pode.contenidos.negocio.noticias.servicio.SrvNoticiasService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("eliminarImagenNoticia");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicio.noticias.negocio.contenidos.pode.es", "imagenEliminarSt"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("http://servicio.noticias.negocio.contenidos.pode.es", "eliminarImagenNoticiaReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[5] = oper;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {idList});
  ...
  throw axisFaultException;
    ...
    public java.lang.Boolean eliminarImagenNoticia(java.lang.String imagenEliminarSt) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("eliminarImagenNoticia");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicio.noticias.negocio.contenidos.pode.es", "eliminarImagenNoticia"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {imagenEliminarSt});
