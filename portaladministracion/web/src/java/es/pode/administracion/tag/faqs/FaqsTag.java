			    								...
			    								out.println("<div class=\"contenedor_derecha\">");
			    									out.println("<div class=\"text\">");
			    										out.println("<object type=\"application/x-xstandard\" codebase=\"" + codeBase + "\" name=\"descripcionFaq" + idiomasTraducibles[i].trim() + "\"  id=\"DescripcionFaq\" width=\"350\" height=\"420\" title=\"" + literalDescripcionFaqTooltip + "\">");    													
			    											...
			    											out.println("<textarea name=\"descripcionFaq" + idiomasTraducibles[i].trim() + "\" rows=\"10\" style=\"width:350px\" class=\"ta_minimo_ancho\" id=\"DescripcionFaq\" title=\"" + literalDescripcionFaqTooltip + "\">"+valueDescripcion+"</textarea>");
...
//			Se recorre hasta encontrar las comillas	
			...
			{
				if (charArray[i] == '"') string.append("&quot;");
				else string.append(String.valueOf(charArray[i]));				
									
			}
			stringSinComillas=string.toString().trim();
