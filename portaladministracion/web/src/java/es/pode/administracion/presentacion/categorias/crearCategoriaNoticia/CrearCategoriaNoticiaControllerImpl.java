...
public class CrearCategoriaNoticiaControllerImpl extends CrearCategoriaNoticiaController
{
	...
	//	        	 Gallego
		...
		ArrayList<ArrayList<String>> listaOrdenada = devuelveArraysOrdenados(listaIdiomas.toArray(new String[0]), listaCategorias.toArray(new String[0]));
		listaCategorias = listaOrdenada.get(0);
		listaIdiomas = listaOrdenada.get(1);
...
//		 devolvemos la propiedad
     ...
     * */
    public ArrayList<ArrayList<String>> devuelveArraysOrdenados(String[] idiomas, String[] categorias) throws Exception
    {
	...
	public ArrayList devuelveListaConTexto(ArrayList categorias, ArrayList idiomas) throws Exception
	{
		...
		for (int i = 0; i < categorias.size(); i++)
		{
			...
			if (categoria != null && !"".equals(categoria.trim()))
			{
				...
				categ.add(categoria);
				idio.add(idiomas.get(i));
			}
		}
		listaReturn.add(categ.toArray(new String[0]));
		listaReturn.add(idio.toArray(new String[0]));
