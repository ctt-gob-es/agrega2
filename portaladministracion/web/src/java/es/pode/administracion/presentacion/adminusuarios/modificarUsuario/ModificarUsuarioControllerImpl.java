...
public class ModificarUsuarioControllerImpl extends ModificarUsuarioController {
    ...
    public final void recuperarUsuario(ActionMapping mapping,
		...
		try {
			...
			long cuota = 0l;//(new Long(0)).longValue();
    ...
    */
    public final void recuperarGrupos(ActionMapping mapping,
		...
		try {
		    ...
		    String recibirCorreoStr=request.getParameter("recibirCorreo");
		    boolean recibirCorreo = false;
		    if (recibirCorreoStr!=null && recibirCorreoStr.length()>0)
		    {
		    	 recibirCorreo = Boolean.parseBoolean(recibirCorreoStr);
		    }
		    ...
		    if (tipoVisualizador.length() <= 0) {
		    	...
		    	if(log.isDebugEnabled())log.debug("visualizador .length() <= 0");
		    	throw new ValidatorException("{errors.modificarusuario.tipoVisualizador}");
		    }
    ...
    public final void asignarGruposTrabajo(org.apache.struts.action.ActionMapping mapping, es.pode.administracion.presentacion.adminusuarios.modificarUsuario.AsignarGruposTrabajoForm form, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws java.lang.Exception
    {
	    ...
	    try
	    {
	    	...
	    	if(log.isDebugEnabled())log.debug("Los identificadores seleccionados son los siguientes "+Arrays.toString(ids));
    ...
    public final String modificarUsuario(ActionMapping mapping,
		...
		try {
		    ...
		    log.error("Error al modificar un usuario ", e);
		    resultado = "FALLO";
	...
	private GrupoVOCheck[] obtenerGrupoCheck(GrupoVO[] grupoVO, UsuarioVO usuarioVO) {
		...
		Vector<Long> vRol = new Vector<Long>();
    ...
    public static class GrupoVOCheck {
		private Long id;
    ...
    public static class GrupoTrabajoVOCheck {
		private Long id;
