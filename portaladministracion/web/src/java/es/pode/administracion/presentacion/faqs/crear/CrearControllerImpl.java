...
public class CrearControllerImpl extends CrearController
{
    ...
    public final void obtenerCategoria(ActionMapping mapping, es.pode.administracion.presentacion.faqs.crear.ObtenerCategoriaForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
		...
		{	
			...
			Collection<CategoriaTraducidaVO> categorias = Arrays.asList(this.getSrvFaqService().obtenerCategoriasTraducidas(noticiasController.
...
//		Si hay nuevas traducciones de la categoria se inserta en la base de datos
		...
		if (nuevasCategorias != null && nuevasCategorias.size() > 0)
		{
			try
			{
				...
				ArrayList<CategoriaIdiomaFaqVO> categoriasIdiomas = new ArrayList<CategoriaIdiomaFaqVO>();	
				...
				for (int j = 0; j < nuevasCategorias.size(); j++)
				{
					...
					categoriaNueva.setNombre(nuevasCategorias.get(j).trim());
					categoriasIdiomas.add(categoriaNueva);
				}
				CategoriaIdiomaFaqVO[] categoriasIdiomasVector = categoriasIdiomas.toArray(new CategoriaIdiomaFaqVO[0]);
	...
	//		Se forma el vo de la faq
			...
			ArrayList<DescripcionFaqVO> descripcionesFaq = new ArrayList<DescripcionFaqVO>();
...
//			Castellano		
	...
	//		Gallego
			...
			DescripcionFaqVO[] descripcionesFaqArray = descripcionesFaq.toArray(new DescripcionFaqVO[0]);	
...
//		 devolvemos la propiedad
	...
	public ArrayList<String> dameDescripciones (String[] castellano,String[] catalan,String[] ingles,String[] euskera,String[] gallego,String[] valenciano)throws Exception
	{
	...
	public ArrayList<String> dameValuePosiciones (String[] castellano,String[] catalan,String[] ingles,String[] euskera,String[] gallego,String[] valenciano)throws Exception
	{
	...
	public ArrayList<DescripcionFaqVO> devuelveListaDescripcionesFaq (ArrayList<DescripcionFaqVO> lista, String idioma, String titulo, String descripcion, String posicion, int numFaqs) throws Exception
	{			
		...
		if (numFaqs == 0)//Es la primera
			descripcionFaqAux.setPosicion(1);
		else if (numFaqs == 1)//Es la segunda
			descripcionFaqAux.setPosicion(2);
		else
		{
