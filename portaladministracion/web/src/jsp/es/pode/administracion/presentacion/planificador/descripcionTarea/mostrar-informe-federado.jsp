...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-informe-federado-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarInformeFederadoVolverForm" action="/DescripcionTarea/MostrarInformeFederadoVolver" method="post" >
