...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<%@ include file="/taglib-imports.jspf" %>
		...
		<div class="plantilla_contenido">
	        ...
	        <html:form  styleId="crearTareaFormularioInformeFechasRangoAceptarForm" action="/CrearTarea/FormularioInformeFechasRangoAceptar" method="post" enctype="multipart/form-data" >
			...
			<input class="fechazo_02" id="year2"  value="" onblur="this.style.backgroundColor='#e1e1e1'"  name="anioHasta" type="text" title="<bean:message key="crearTarea.introduzcaAnio"/> "/>
				...
				</div>										<div class="linea_separadora"></div>
											<br class="oculto" />
										</div>
				...
				<form id="crearTareaFormularioInformeFechasRangoCancelarForm" action="<html:rewrite action="/CrearTarea/FormularioInformeFechasRangoCancelar"/>" method="post" >
