...
<!-- ## Para pintar los mensajes de error ## -->
	...
	<h2><bean:message key="noticias.modificar.titulo.uno"/></h2>	
	<form method="post" action="<html:rewrite action="/ModificarNoticia/ModificarPaso1Aceptar"/>?progressMonitor=myProgressMonitor" enctype="multipart/form-data" onsubmit="progressBar()">	
		<!--  INICIO GLOBO GRIS   -->
						...
						<div id="formulario" >					
							...
							<div class="fila_de_tabla">
								...
								<br class="oculto" />
			 					...
			 					<!-- ***********************     IMAGEN ANTERIOR     **************************-->
			 					<c:if test="${!empty form.nombreImagenVO}">
				 					<div class="fila_de_tabla">
	  									<div class="contenedor_izquierda">
										...
										<div class="text">
											...
											onclick="document.getElementById('SelImagen').disabled=true;
													 ...
													 document.getElementById('alineaAbajoDcha').disabled=false;
												 	 document.getElementById('alineaAbajoIzq').style.backgroundColor='white'"													 
											value="1"/>	
											<span class="vert"><bean:message key="noticias.crear.modificar.imagen.inicio"/> ${form.nombreImagenVO}</span>											
										</div>
									</div>
									<div class="linea_separadora"></div>
									<br class="oculto" />
								...
								<div class="contenedor_derecha">
									<div class="text">
										...
										<logic:notEqual name="form" property="activarImagen" value="3">
											<html:file disabled="true" name="form" property="imagen" style="width:320px" onblur="this.style.backgroundColor='#e1e1e1'" styleId="SelImagen" styleClass="selimagen0" titleKey="modificar.noticia.formulario.SelectImagen"></html:file>																			
										</logic:notEqual>
									</div>
								</div>		
								<div class="linea_separadora"></div>
											...
											<tr>											
												...
												<td  valign="top">
													<logic:notEqual name="form" property="activarImagen" value="2">
														<html:radio name="form" property="alineamiento" styleId="alineaArribaIzq" styleClass="boton_radio" value="0"/><span class="vert"><bean:message key="modificar.noticia.formulario.AlinearIzq"/></span>
													</logic:notEqual>	
													<logic:equal name="form" property="activarImagen" value="2">
														<html:radio disabled="true" name="form" property="alineamiento" styleId="alineaArribaIzq" styleClass="boton_radio" value="0"/><span class="vert"><bean:message key="modificar.noticia.formulario.AlinearIzq"/></span>
													</logic:equal>
												</td>
											</tr>
											<tr>
												...
												<td valign="top">
													<logic:notEqual name="form" property="activarImagen" value="2">
														<html:radio name="form" property="alineamiento" styleId="alineaArribaDcha" styleClass="boton_radio" value="1"/><span class="vert"><bean:message key="modificar.noticia.formulario.AlinearDer"/></span>
													</logic:notEqual>
													<logic:equal name="form" property="activarImagen" value="2">
														<html:radio disabled="true" name="form" property="alineamiento" styleId="alineaArribaDcha" styleClass="boton_radio" value="1"/><span class="vert"><bean:message key="modificar.noticia.formulario.AlinearDer"/></span>
													</logic:equal>
												</td>										
											</tr>
											<tr>
												...
												<td valign="top">
													<logic:notEqual name="form" property="activarImagen" value="2">
													<html:radio name="form" property="alineamiento" styleId="alineaAbajoIzq" styleClass="boton_radio" value="2"/><span class="vert"><bean:message key="noticias.crear.alinear.abajo.izquierda"/></span>
												</logic:notEqual>
												<logic:equal name="form" property="activarImagen" value="2">
													<html:radio disabled="true" name="form" property="alineamiento" styleId="alineaAbajoIzq" styleClass="boton_radio" value="2"/><span class="vert"><bean:message key="noticias.crear.alinear.abajo.izquierda"/></span>
												</logic:equal>
												</td>
											</tr>
											<tr>
												...
												<td  valign="top">
													<logic:notEqual name="form" property="activarImagen" value="2">
													<html:radio name="form" property="alineamiento"  styleId="alineaAbajoDcha" styleClass="boton_radio" value="3"/><span class="vert"><bean:message key="noticias.crear.alinear.abajo.derecha"/></span>
												</logic:notEqual>
												<logic:equal name="form" property="activarImagen" value="2">
													<html:radio disabled="true" name="form" property="alineamiento" styleId="alineaAbajoDcha" styleClass="boton_radio" value="3"/><span class="vert"><bean:message key="noticias.crear.alinear.abajo.derecha"/></span>
												</logic:equal>	
												</td>
											</tr>
										</table>											
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<html:radio name="form" property="estado" styleClass="boton_radio" value="false" styleId="SelEstado" /><span class="vert"><bean:message key="modificar.noticia.formulario.EstadoDesact"/></span>											
									</div>
								</div>
								<div class="linea_separadora"></div>
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">									
									<div class="text">
										<html:radio name="form" property="estado" styleClass="boton_radio" value="true" styleId="SelEstado_02"/><span class="vert"><bean:message key="modificar.noticia.formulario.EstadoActiv"/></span>
									</div>				
								</div>
								<div class="linea_separadora"></div>
							</div>
...
{
if(document.getElementById('SelImagen').disabled==false)
 {
 startLoading();
 }
