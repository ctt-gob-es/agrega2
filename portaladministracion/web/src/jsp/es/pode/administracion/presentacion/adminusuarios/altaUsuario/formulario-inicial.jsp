								...
								<div class="globo_blanco_02">
									<div class="globo_blanco_03">
										...
										<div class="fila_de_tabla">
											...
											<div class="contenedor_derecha">
												<div class="text">
													<input name="nif" value="${form.nif}" id="NIF" maxlength="30" type="text" title="<bean:message key="usuarios.introduzcaNIF"/>"  />
												</div>
											</div>
											<div class="linea_separadora"></div>
											<br class="oculto" />
										...
										<div class="fila_de_tabla">
											...
											<div class="contenedor_derecha">
												<div class="text">
													...
													<input class="boton_radio" type="checkbox" name="recibirCorreo" value="true" id="recibirCorreo"  />
