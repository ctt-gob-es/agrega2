...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-generar-estadisticas-locales-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarGenerarEstadisticasLocalesVolverForm" action="/DescripcionTarea/MostrarGenerarEstadisticasLocalesVolver" method="post" >
