...
<div class="plantilla_contenido" >
	...
	<form method="post" action="<html:rewrite action="/CrearNoticia/FormularioValida"/>?progressMonitor=myProgressMonitor" enctype="multipart/form-data" onsubmit="progressBar()">
