...
<form id="eliminarTrabajoConfirmacionEliminacionTareasAceptarForm" action='<html:rewrite action="/EliminarTrabajo/ConfirmacionEliminacionTareasAceptar"/>' method="post"  >
				...
				<div class="globo_gris_03">
					...
					<div id="formulario" class="ali_c">	
						...
						<div class="caja_tabla" >
							...
							<display:table name="${form.listaNombres}" uid="fila" requestURI="${pageContext.request.requestURL}"
