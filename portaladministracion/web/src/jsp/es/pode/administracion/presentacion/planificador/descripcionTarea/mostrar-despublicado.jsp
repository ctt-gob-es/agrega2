...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-despublicado-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarDespublicadoVolverForm" action="/DescripcionTarea/MostrarDespublicadoVolver" method="post" >
        <!--  INICIO GLOBO GRIS   -->
				...
				<div class="globo_gris_02">
					<div class="globo_gris_03">
						...
						<div id="formulario">
							...
							<!--  *********************       Caja de Texto de Grupo de Trabajo     *******************  -->
							<div class="fila_de_tabla">
								<div class="contenedor_izquierda">
									<div class="text">
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input DISABLED value="<bean:message key="crearTarea.despublicacionMasiva"/>" id="despublicacionMasiva" name="despublicacionMasiva" type="text" style="background-color:white"/>
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
							...
							<!--		Columna de fichero Excel		-->

							<div class="fila_de_tabla">
								<div class="contenedor_izquierda">
									<div class="text">
										<label for="repetir_tipoTarea"><bean:message key="crearTarea.despublicacionMasiva.archivoDespublicacion"/></label>
									</div>
								</div>
								<div class="contenedor_derecha">
									<div class="text">
										<html:link action="/DescripcionTarea/MostrarDespublicadoRecuperar?nombre=${form.pathDespublicar}">
											${form.pathDespublicar}
										</html:link>
									</div>
								</div>
								<div class="linea_separadora"></div>
