...
<form id="eliminarInformesFederadosResultadoEliminacionAceptarForm" action='<html:rewrite action="/EliminarInformesFederados/ResultadoEliminacionFederadosAceptar"/>' method="post"  >
