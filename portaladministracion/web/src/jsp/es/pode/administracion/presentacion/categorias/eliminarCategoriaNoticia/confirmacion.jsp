...
<form action='<html:rewrite action="/EliminarCategoriaNoticiaCU/ConfirmacionAceptarEliminacion"/>' method="post"  >
	...
	<div class="globo_gris" >
		<div class="globo_gris_01">
			...
			<input type="hidden" name="listaIds" value="${form.listaIds}"/>	
						...
						<p><bean:message key="categorias.noticias.eliminacionCategorias.confirmacion"/></p>
						...
						<display:table name="${form.categoriasNoticias}" uid="fila" requestURI="${pageContext.request.requestURL}"
...
<form action='<html:rewrite action="/EliminarCategoriaNoticiaCU/ConfirmacionCancelar"/>' method="post">
