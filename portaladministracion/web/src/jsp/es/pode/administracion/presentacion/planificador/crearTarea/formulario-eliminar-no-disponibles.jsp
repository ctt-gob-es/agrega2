...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="crearTareaFormularioEliminarNoDisponiblesAceptarForm" action='/CrearTarea/FormularioEliminarNoDisponiblesAceptar' method="post" >
	...
	<form id="crearTareaFormularioEliminarNoDisponiblesCancelarForm" action="<html:rewrite action="/CrearTarea/FormularioEliminarNoDisponiblesCancelar"/>" method="post" >
