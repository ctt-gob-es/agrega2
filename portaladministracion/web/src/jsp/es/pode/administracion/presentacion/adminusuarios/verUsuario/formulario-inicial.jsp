								...
								<div class="globo_blanco_02">
									<div class="globo_blanco_03">
										...
										<div class="fila_de_tabla">
											...
											<div class="contenedor_derecha">
												<div class="text">
													...
													<bean:define id="tipoVisualizadorValue"><bean:message key="usuarios.visualizador.${form.tipoVisualizador}"/></bean:define>
													<input DISABLED style="background-color:white" name="tipoVisualizador" value="${tipoVisualizadorValue}" id="tipoVisualizador" type="text" />
										...
										<div class="fila_de_tabla">
											...
											<div class="contenedor_derecha">
												<div class="text">
													<input DISABLED class="boton_radio" type="checkbox" name="recibirCorreo" value="true"  <c:if test="${form.recibirCorreo==true}"> checked="checked"  </c:if> id="recibirCorreo"  />
												</div>
