...
<form id="listarTaxonomiasFormListarTaxonomiasSubmitForm" 
	action="<html:rewrite action="/ListarTaxonomias/FormListarTaxonomiasSubmit"/>" method="post">


		
<logic:iterate id="vdex" name="form" property="taxonomias" indexId="i">
		...
		<div class="globo_gris_02">
			<div class="globo_gris_03" style="padding-bottom:16px;">
				...
				<div class="caja_tabla bordeada" > 
					...
					<bean:define id="summary"><b><bean:message key='estructuras.taxonomias.titulo.summary'/></b></bean:define>
				        ...
				        <display:caption><strong><bean:message key='estructuras.taxonomias.titulo.summary'/></strong></display:caption>
...
<c:if test="${i>0}">
					        <display:column style="valign:top;" class="numeracion">        	
								<label for="${row}" class="etiq_invisible" ><bean:message key="estructuras.taxonomias.seleccione"/> </label>	
						...
						<c:set var="idioma" value="${fn:substring(row, inicio , fin )}"/>
				           ...
				           <display:column  
					        ...
					        <display:column media="html" autolink="true" paramId="titulo">
					            ...
					            <c:set var="link"><html:rewrite action="/ListarTaxonomias/FormListarTaxonomiasExportar"/>?nombre=${row}&amp;tipo=${vdex.tipo}</c:set>
					        	<html:link href="${link}">
				...
				<fieldset class="tipo_interior_04">
					<a href="<html:rewrite action="/ListarTaxonomias/FormListarTaxonomiasModificar"/>?identificadorVdex=${vdex.identificador}&amp;tipo=${vdex.tipo}" class="boton_125_de_2_izq" title="<bean:message key="estructuras.modificar"/>"><span><bean:message key="estructuras.modificar"/></span></a>
<c:if test="${i>0}">
...
<form id="listarTaxonomiasFormListarTaxonomiasAlta"
	...
	<fieldset class="tipo ft_centrada">
		<input class="boton_125" type="submit"  value="<bean:message key="estructuras.taxonomias.crear"/>" />
	</fieldset>
	<!-- Fin Botones  -->
	<!-- Fin Botones  -->
</form>
