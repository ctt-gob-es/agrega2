...
<bean:define id="usuarioVO" name="altaUsuarioPendienteBSession" property="usuarioPendiente" scope="session" />
<h2><bean:message key="usuariosPendientes.alta2.cabecera"/> - <bean:write name="usuarioVO" property="usuario" /></h2>


<!--		Inicio del formulario principal		-->

<form id="altaUsuarioPendienteFormularioAltaUsuarioPendienteAceptarForm" action='<html:rewrite action="/AltaUsuarioPendiente/FormularioAltaUsuarioPendienteAceptar"/>' method="post" >
