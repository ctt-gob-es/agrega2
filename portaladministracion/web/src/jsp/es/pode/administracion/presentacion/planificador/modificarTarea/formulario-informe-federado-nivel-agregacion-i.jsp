...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioInformeFederadoNivelAgregacionIContinuarForm" action="/ObtenerTCargaODEs/FormularioInformeFederadoNivelAgregacionIContinuar" method="post" enctype="multipart/form-data">
				...
				<div class="globo_gris_02">
					...
					<!--  *********************       INICIO CAJA DE FORMULARIO     *******************  -->
						<div id="formulario" >
							...
							<input type="hidden" name="mesInicioInforme" value="${form.mesInicioInforme}" />
							<input type="hidden" name="anioInicioInforme" value="${form.anioInicioInforme}" />
