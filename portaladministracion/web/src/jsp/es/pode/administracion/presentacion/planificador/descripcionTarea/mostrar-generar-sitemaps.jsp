...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-generar-sitemaps-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarGenerarSitemapsVolverForm" action="/DescripcionTarea/MostrarGenerarSitemapsVolver" method="post" >
