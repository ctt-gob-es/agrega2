...
<!-- ************************     INICIO PLANTILLA CONTENIDO     *************************  -->
	...
	<html:form styleId="crearInformeListadoFechasAceptarForm" action="/CrearInforme/ListadoFechasAceptar" method="post" enctype="multipart/form-data">
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha" id="cont_esp_fech">
									<div class="text">
										...
										<input name="diaDesde" type="text" class="fechazo" value="${form.diaDesde}" maxlength="2" id="day1" onblur="this.style.backgroundColor='#e1e1e1'"  title="<bean:message key="informes.crearInforme.introduzcaDia"/> "  />
										...
										<input name="anioDesde" value="${form.anioDesde}" maxlength="4" class="fechazo" id="year1" type="text" onblur="this.style.backgroundColor='#e1e1e1'" title="<bean:message key="informes.crearInforme.introduzcaAnio"/> "  />
