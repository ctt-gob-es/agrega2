...
<tiles:put name="codigo-head" type="string">
	...
	<html:form styleId="obtenerTCargaODEsFormularioIContinuarForm" action="/ObtenerTCargaODEs/FormularioIContinuar" method="post" enctype="multipart/form-data">
				...
				<div class="globo_gris_02">
					...
					<!--  *********************       INICIO CAJA DE FORMULARIO     *******************  -->
						<div id="formulario" >
							...
							<input type="hidden" name="pathODEs" value="${form.pathODEs}" />
							
							<input type="hidden" name="pathODEsCarg" value="${form.pathODEsCarg}" />
							
							<input type="hidden" name="pathODEsNoCarg" value="${form.pathODEsNoCarg}" />
							...
							<input type="hidden" name="sobrescribir" value="${form.sobrescribir}" />
							
							<input type="hidden" name="nombreLote" value="${form.nombreLote}" />
							
							<input type="hidden" name="descripcionTarea" value="${form.descripcionTarea}" />
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input name="tipoTareaEscrito" READONLY value="<bean:message key="crearTarea.tareaCargaODEs"/>" style="background-color: #e1e1e1" id="tipoTareaEscrito" type="text" title="<bean:message key='crearTarea.seleccioneTipoTarea'/>" />
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
