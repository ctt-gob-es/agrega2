...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-informe-fecha-rango-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarInformeFechaRangoVolverForm" action="/DescripcionTarea/MostrarInformeFechaRangoVolver" method="post" >
					...
					<div class="globo_gris_03">
						...
						<div id="formulario">
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input DISABLED name="rango" value="${form.rango}" id="rango" type="text" style="background-color:white"/>
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
