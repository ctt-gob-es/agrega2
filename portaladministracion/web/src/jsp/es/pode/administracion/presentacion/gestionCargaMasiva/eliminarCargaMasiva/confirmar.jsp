...
<h2><bean:message key="informes.carga.eliminar"/></h2>


<!--		Inicio del formulario principal		-->

<form id="eliminarInformesCargaConfirmarAceptarForm" action='<html:rewrite action="/EliminarInformesCarga/ConfirmarAceptar"/>' method="post"  >
			...
			<div class="globo_gris_02">
				<div class="globo_gris_03">
					...
					<div id="formulario" class="ali_c">
						...
						<input type="hidden" name="informes" value="${form.informesCarga}"/>
						...
						<div class="caja_tabla" >
							...
							<display:table name="${form.informesCarga}" uid="fila" requestURI="${pageContext.request.requestURL}"
...
<form id="eliminarInformesCargaConfirmarCancelarForm" action='<html:rewrite action="/EliminarInformesCarga/ConfirmarCancelar"/>' method="post">
