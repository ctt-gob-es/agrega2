...
<form id="bajaTesaurosConfirmacionSubmitForm" 
	action="<html:rewrite action="/BajaTesauros/ConfirmacionSubmit"/>" method="post">
<jsp:include page="/layout/messages.jsp" flush="true" />
 <h2> <bean:message key="estructuras.tesauros.baja.titulo"/> </h2>
			...
			<div class="globo_gris_02">
				<div class="globo_gris_03">
					<div id="formulario" class="ali_c">
						...
						<p><bean:message key="estructuras.tesauros.baja.mensaje"/></p>
						<p>
						<!--		INICIO CAJA TABLA		-->
