...
<h2><bean:message key="grupos.alta2.cabecera"/> - <bean:write name="altaGrupoBSession" property="descripcion" scope="session"/></h2>


<!--		Inicio del formulario principal		-->

<form id="altaGrupoFormularioAltaAceptarForm" action='<html:rewrite action="/AltaGrupo/FormularioAltaAceptar"/>' method="post" >
								...
								<div class="globo_blanco_02">
									<div class="globo_blanco_03">
										...
										<!-- en caso de no tener registros de usuarios se tiene que poner el div		-->
											...
											<c:if test="${fn:length(form.roles) < 1}" >
