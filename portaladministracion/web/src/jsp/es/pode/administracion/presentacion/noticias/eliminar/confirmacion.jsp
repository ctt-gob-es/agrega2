...
<h2><bean:message key="noticia.eliminacionNoticias.cabecera"/></h2>


<!--		Inicio del formulario principal		-->

<form id="eliminarNoticiasConfirmacionAceptarEliminacionForm" action='<html:rewrite action="/EliminarNoticias/ConfirmacionAceptarEliminacion"/>' method="post"  >
	...
	<div class="globo_gris" >
		<div class="globo_gris_01">
			...
			<input type="hidden" name="listaIds" value="${form.listaIds}"/>	
						...
						<p><bean:message key="noticias.eliminacionNoticias.confirmacion"/></p>
						...
						<display:table name="${form.noticias}" uid="fila" requestURI="${pageContext.request.requestURL}"
