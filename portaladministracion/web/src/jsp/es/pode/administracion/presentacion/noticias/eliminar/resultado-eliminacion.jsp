			...
			<div class="globo_gris_02">
				<div class="globo_gris_03">
					...
					<input type="hidden" name="listaIds" value="${form.listaIds}"/>	
						...
						<p><bean:message key="noticias.eliminacionNoticias.confirmacion2"/></p>
						...
						<display:table name="${form.noticiasDeleted}" uid="fila" requestURI="${pageContext.request.requestURL}"
