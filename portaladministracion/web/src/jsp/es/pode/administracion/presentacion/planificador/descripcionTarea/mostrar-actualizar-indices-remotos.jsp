...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-actualizar-indices-remotos-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarActualizarIndicesRemotosVolverForm" action="/DescripcionTarea/MostrarActualizarIndicesRemotosVolver" method="post" >
...
</tiles:insert>  <%@ page language="java" contentType="text/html; charset=ISO-8859-1"
