...
<div class="globo_gris uno_b" >
		...
		<div class="fila_de_tabla">
			<div class="contenedor_izquierda">
			<div class="text"><bean:message key="crearDescarga.descarga.offline" /> </div>
			</div>
			<div class="contenedor_derecha">
			<div class="text">
			 <html:checkbox name="form" property="esHerramientaOffline"></html:checkbox>
			
				<!--<input type="checkbox" name="esHerramientaOffline"
					checked="${form.esHerramientaOffline}"/> -->
			</div> 
			</div>
			<div class="linea_separadora"></div>
		</div>
