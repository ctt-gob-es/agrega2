...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioInformesFechaRangoIContinuarForm" action="/ObtenerTCargaODEs/FormularioInformesFechaRangoIContinuar" method="post" enctype="multipart/form-data">
				...
				<div class="globo_gris_02">
					...
					<!--  *********************       INICIO CAJA DE FORMULARIO     *******************  -->
						<div id="formulario" >
							...
							<input type="hidden" name="rango" value="${form.rango}" />
	...
	<form id="obtenerTCargaODEsFormularioInformesFechaRangoICancelarForm" action='<html:rewrite action="/ObtenerTCargaODEs/FormularioInformesFechaRangoICancelar"/>' method="post" >
