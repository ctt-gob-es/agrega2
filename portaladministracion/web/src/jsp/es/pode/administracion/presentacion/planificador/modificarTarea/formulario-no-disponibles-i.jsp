...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioNoDisponiblesIContinuarForm" action="/ObtenerTCargaODEs/FormularioNoDisponiblesIContinuar" method="post" enctype="multipart/form-data">
				...
				<div class="globo_gris_02">
					...
					<!--  *********************       INICIO CAJA DE FORMULARIO     *******************  -->
						<div id="formulario" >
							...
							<input type="hidden" name="msgEliminado" value="${form.msgEliminado}" />
										
							<input type="hidden" name="msgNoEliminado" value="${form.msgNoEliminado}" />
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input name="tipoTarea" READONLY value="<bean:message key="crearTarea.tareaEliminarODEs"/>" style="background-color: #e1e1e1" id="tipoTarea" type="text" title="<bean:message key='crearTarea.seleccioneTipoTarea'/>" />
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
	...
	<form id="obtenerTCargaODEsFormularioNoDisponiblesICancelarForm" action="<html:rewrite action="/ObtenerTCargaODEs/FormularioNoDisponiblesICancelar"/>" method="post" >
