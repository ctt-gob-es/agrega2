...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-generar-estadisticas-totales-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarGenerarEstadisticasTotalesVolverForm" action="/DescripcionTarea/MostrarGenerarEstadisticasTotalesVolver" method="post" >
