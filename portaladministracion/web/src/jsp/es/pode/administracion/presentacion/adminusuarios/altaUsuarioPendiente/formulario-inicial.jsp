...
<h2><bean:message key="usuariosPendientes.alta1.cabecera"/></h2>


<!--		Inicio del formulario principal		-->

<form id="altaUsuarioPendienteFormularioInicialContinuarForm" action='<html:rewrite action="/AltaUsuarioPendiente/FormularioInicialContinuar"/>' method="post" >
