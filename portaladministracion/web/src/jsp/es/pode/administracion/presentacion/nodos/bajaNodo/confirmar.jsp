...
<form id="bajaNodoConfirmarAceptarForm" action='<html:rewrite action="/BajaNodo/ConfirmarAceptar"/>' method="post"  >
			...
			<div class="globo_gris_02">
				<div class="globo_gris_03">
					...
					<div id="formulario" class="ali_c">
						...
						<p><bean:message key="nodos.bajaNodo.confirmacion"/></p>
						...
						<display:table name="${form.nodos}" uid="fila" requestURI="${pageContext.request.requestURL}"
