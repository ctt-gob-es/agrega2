...
<!--		Inicio del formulario principal		-->
	<form action='<html:rewrite action="/EliminarCategoriaFaq/ResultadoEliminacionAceptar"/>' method="post"  >
		<!--		INICIO GLOBO GRIS		-->	
					...
					<div class="globo_gris_03">									
						...
						<div id="formulario" class="ali_c">				
							...
							<div class="caja_tabla" >	
								...
								<display:table name="${form.categoriasBorradas}" uid="fila" requestURI="${pageContext.request.requestURL}"
									...
									<display:column>${fila.nombre}</display:column>
