...
<form id="bajaNodoSQIConfirmarAceptarForm" action='<html:rewrite action="/${initParam.url_nodoSQI_baja_confirmar_aceptar }"/>' method="post"  >
			...
			<div class="globo_gris_02">
				<div class="globo_gris_03">
					...
					<div id="formulario" class="ali_c">
						...
						<p><bean:message key="nodos.bajaNodo.confirmacionSQI"/></p>
						...
						<display:table name="${form.nodosSQI}" uid="fila" requestURI="${pageContext.request.requestURL}"
...
<form id="bajaNodoSQIConfirmarCancelarForm" action='<html:rewrite action="/${initParam.url_nodoSQI_baja_confirmar_cancelar }"/>' method="post">
