...
<tiles:put name="title" type="string">
	...
	<%@ include file="/taglib-imports.jspf" %>
		...
		<div class="plantilla_contenido">
			...
			<html:form  styleId="crearTareaFormularioInformeFederadoAceptarForm" action="/CrearTarea/FormularioInformeFederadoAceptar" method="post" enctype="multipart/form-data" >
