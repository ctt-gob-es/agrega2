...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioInformeCatalogoIContinuarForm" action="/ObtenerTCargaODEs/FormularioInformeCatalogoIContinuar" method="post" enctype="multipart/form-data">
				...
				<div class="globo_gris_02">
					...
					<!--  *********************       INICIO CAJA DE FORMULARIO     *******************  -->
						<div id="formulario" >
							...
							<input type="hidden" name="repositorio" value="${form.repositorio}" />
							<input type="hidden" name="diaActualizacion" value="${form.diaActualizacion}" />
							<input type="hidden" name="mesActualizacion" value="${form.mesActualizacion}" />
							<input type="hidden" name="anoActualizacion" value="${form.anoActualizacion}" />
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input name="informe" READONLY value="<bean:message key="crearTarea.repositorio"/>"  style="background-color: #e1e1e1" id="tipoTarea" type="text" title="<bean:message key='crearTarea.seleccioneTipoTarea'/>" />
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
	...
	<form id="obtenerTCargaODEsFormularioInformeCatalogoICancelarForm" action='<html:rewrite action="/ObtenerTCargaODEs/FormularioInformeCatalogoICancelar"/>' method="post" >
