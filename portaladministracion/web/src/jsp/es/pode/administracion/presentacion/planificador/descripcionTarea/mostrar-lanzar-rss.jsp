...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-lanzar-rss-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarLanzarRSSVolverForm" action="/DescripcionTarea/MostrarLanzarRSSVolver" method="post" >
