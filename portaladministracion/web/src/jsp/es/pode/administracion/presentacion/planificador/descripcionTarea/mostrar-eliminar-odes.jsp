...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-eliminar-odes-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarEliminarOdesVolverForm" action="/DescripcionTarea/MostrarEliminarOdesVolver" method="post" >
