...
<tiles:put name="title" type="string">
	...
	<%@ include file="/taglib-imports.jspf" %>
		...
		<div class="plantilla_contenido">
	        ...
	        <html:form  action="/CrearTarea/FormularioTareaCargaODEsAceptar" method="post" enctype="multipart/form-data" >
								...
								<h3><bean:message key="crearTarea.cargaDeContenidos"/></h3>
				                   ...
				                   <div class="fila_de_tabla">
					  					<div class="contenedor_izquierda">
					  						<div class="text">
												<label for="nombreLote"><bean:message key="crearTarea.nombreLote"/></label>
											</div>
					 					</div>
										<div class="contenedor_derecha">
											<div class="text">
												<input name="nombreLote" maxlength="250" value="${form.nombreLote}"  onblur="this.style.backgroundColor='#e1e1e1'" id="nombreLote" type="text" title="<bean:message key="crearTarea.introduzcaNombreLote"/> "  />
											</div>
										</div>
				                   ...
				                   <div class="fila_de_tabla">
					  					<div class="contenedor_izquierda">
					  						<div class="text">
												<label for="descripcionTarea"><bean:message key="crearTarea.descripcionTarea"/></label>
											</div>
					 					</div>
										<div class="contenedor_derecha">
											<div class="text">
												<textarea name="descripcionTarea"   cols="5" rows="4"    onblur="this.style.backgroundColor='#e1e1e1'" id="descripcionTarea"  title="<bean:message key="crearTarea.introduzcaDescripcionTarea"/> "  />${form.descripcionTarea}</textarea>
											</div>
										</div>
										<div class="linea_separadora"></div>
										<br class="oculto" />
									...
									<div class="fila_de_tabla">
										...
										<div class="contenedor_derecha">
											<div class="text">
												<input name="pathODEs" value="${form.pathODEs}"  id="URLLocation" type="text" onblur="this.style.backgroundColor='#e1e1e1'" title="<bean:message key="crearTarea.introduzcaUrlLocation"/>"  />
											</div>
										</div>
										<div class="linea_separadora"></div>
										<br class="oculto" />
				                    ...
				                    <div class="fila_de_tabla">
										...
										<div class="contenedor_derecha">
											<div class="text">
												<input name="pathODEsCarg" value="${form.pathODEsCarg}"  onblur="this.style.backgroundColor='#e1e1e1'" id="URLDestiny" type="text" title="<bean:message key="crearTarea.introduzcaUrlDestiny"/> "  />
											</div>
										</div>
										<div class="linea_separadora"></div>
										<br class="oculto" />
				                   ...
				                   <div class="fila_de_tabla">
										...
										<div class="contenedor_derecha">
											<div class="text">
												<input name="pathODEsNoCarg" value="${form.pathODEsNoCarg}"  onblur="this.style.backgroundColor='#e1e1e1'" id="URLError" type="text" title="<bean:message key="crearTarea.introduzcaUrlError"/> "  />
											</div>
										</div>
										<div class="linea_separadora"></div>
										<br class="oculto" />
				                   ...
				                   <div class="fila_de_tabla">
										...
										<div class="contenedor_derecha">
											<div class="text">
												<input class="boton_radio" type="checkbox" name="sobrescribir" value="on" id="sobrescribir" title="<bean:message key="crearTarea.sobrescribir"/> "  />
											</div>
										</div>
										<div class="linea_separadora"></div>
										<br class="oculto" />
				...
				<form id="crearTareaFormularioTareaCargaODEsCancelarForm" action="<html:rewrite action="/ListarTareasPendientes/ListarTareasPendientes"/>" method="post" >
