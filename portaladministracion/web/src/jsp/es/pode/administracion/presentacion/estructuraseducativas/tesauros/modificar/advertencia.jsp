...
<jsp:include page="/layout/messages.jsp" flush="true" />
 ...
 <h2> <bean:message key="estructuras.tesauros.crear.titulo"/> </h2>
 
<form id="advertenciaSubmit" 
	action="<html:rewrite action="/ModificarTesauros/AdvertenciaSubmitAdvertencia"/>" method="post" enctype="multipart/form-data">
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<c:if test="${form.actualizarVigente}" >	
				<p class="parrafo_comun" ><strong><b><bean:message key="estructuras.tesauros.modi.vigente.advertencia"/></b></strong></p>
			</c:if>
				<p class="parrafo_comun" ><bean:message key="estructuras.tesauros.modi.advertencia" arg0="${form.nombre}"/></p>
				<br class="oculto" />
				<br />
			</div>
