...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-subir-indices-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="" action="/DescripcionTarea/MostrarObtenerOdesDespublicadosFederadosFaltantesVolver" method="post" >
