...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-generar-oai-ore-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarGenerarOaiOreVolverForm" action="/DescripcionTarea/MostrarGenerarOaiOreVolver" method="post" >
