...
<div class="plantilla_contenido" >
	...
	<h2><bean:message key="faqs.crear.titulo.uno"/></h2>	
	
	<form method="post" action="<html:rewrite action="/CrearFAQ/FormularioCategoriaValida"/>" enctype="multipart/form-data">	
