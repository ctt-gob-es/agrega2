					...
					<div class="globo_gris_03">
						...
						<div id="formulario">
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input DISABLED value="<bean:message key="crearTarea.tareaCargaODEs"/>" id="tipoTareaEscrito" name="tipoTareaEscrito" type="text" style="background-color:white"/>
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
						...
						<!--  **********************         NOMBRE LOTE     ******************-->
		                   <div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input DISABLED name="nombreLote" value="${form.nombreLote}" id="nombreLote" type="text" style="background-color:white" "  />
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
		                   ...
		                   <div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<textarea DISABLED name="descripcionTarea"  rows="10" cols="40"  class="ta_minimo_ancho" onblur="this.style.backgroundColor='#e1e1e1'" id="descripcionTarea"  title="<bean:message key="crearTarea.introduzcaDescripcionTarea"/> "  />${form.descripcionTarea}</textarea>
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
