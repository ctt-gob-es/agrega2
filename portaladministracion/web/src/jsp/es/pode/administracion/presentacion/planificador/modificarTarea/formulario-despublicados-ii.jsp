...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/prototype.js"/>"></script>
	...
	<%@ include file="/taglib-imports.jspf" %>
		...
		<div class="plantilla_contenido">
	        ...
	        <html:form styleId="obtenerTCargaODEsFormularioDespublicadosIIAceptarForm" action="/ObtenerTCargaODEs/FormularioDespublicadosIIAceptar?progressMonitor=myProgressMonitor" method="post" enctype="multipart/form-data" onsubmit="startLoading()">
				...
				<form id="obtenerTCargaODEsFormularioDespublicadosIICancelarForm" action="<html:rewrite action="/ObtenerTCargaODEs/FormularioDespublicadosIICancelar"/>" method="post" >
