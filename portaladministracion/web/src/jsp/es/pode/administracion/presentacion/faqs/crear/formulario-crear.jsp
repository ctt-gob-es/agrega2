...
<div class="plantilla_contenido">
	<form method="post" action="<html:rewrite action="/CrearFAQ/FormularioCrearValidarFormu"/>" enctype="multipart/form-data">		
		<!-- ## Para pintar los mensajes de error ## -->
		<jsp:include page="/layout/messages.jsp" flush="true" />	
		<h2><bean:message key="faqs.crear.titulo.dos"/></h2>	
		
		<!--************************          TAG QUE PINTA LAS PANTALLAS DE CATEGORIASFAQS Y FAQS     ****************************-->
		<faqs:faqsTag action="altaFaq" 
	...
	<form action='<html:rewrite action="/CrearFAQ/FormularioCrearVolver"/>' method="post">	
