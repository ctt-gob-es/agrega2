...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioInformeFechaIContinuarForm" action="/ObtenerTCargaODEs/FormularioInformeFechaIContinuar" method="post" enctype="multipart/form-data">
	...
	<form id="obtenerTCargaODEsFormularioInformeFechaICancelarForm" action='<html:rewrite action="/ObtenerTCargaODEs/FormularioInformeFechaICancelar"/>' method="post" >
