...
<form id="eliminarTareasConfirmacionEliminacionAceptarForm" action='<html:rewrite action="/EliminarTareas/ConfirmacionEliminacionAceptar"/>' method="post"  >
			...
			<div class="globo_gris_02">
				<div class="globo_gris_03">
					...
					<div id="formulario" class="ali_c">	
						...
						<input type="hidden" name="listaTrabajoPlana" value="${form.listaTrabajoPlana}"/>
						
						<p><bean:message key="eliminarTareasPendientes.confirmacion"/></p>
						...
						<div class="caja_tabla" >
							...
							<display:table name="${form.listaTrabajo}" uid="fila" requestURI="${pageContext.request.requestURL}"
