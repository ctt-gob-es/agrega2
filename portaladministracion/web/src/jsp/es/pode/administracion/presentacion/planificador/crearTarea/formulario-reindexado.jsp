...
<tiles:insert definition="layout-administrador">
	...
	<%@ include file="/taglib-imports.jspf" %>
		...
		<div class="plantilla_contenido">
			...
			<html:form styleId="crearTareaFormularioReindexadoAceptarForm" action="/CrearTarea/FormularioReindexadoAceptar" method="post" enctype="multipart/form-data">
						...
						<div class="globo_gris_02">
							<div class="globo_gris_03">
								...
								<div id="formulario" >
									...
									<input type="hidden" name="msgReindexado" value="<bean:message key="crearTarea.msgReindexado"/>" />
									
									<input type="hidden" name="msgNoReindexado" value="<bean:message key="crearTarea.msgNoReindexado"/>" />
									
									<input type="hidden" name="msgDescReindexado" value="<bean:message key="crearTarea.msgDescReindexado"/>" />
										...
										<div class="contenedor_derecha2">
											...
											<c:choose>
						                        <c:when test="${!empty form.idiomaBackingList}">
						                           <html:select name="form" property="repositorioIndices" styleId="Idioma" title="${idiomaAlt}">
			...
			<form id="crearTareaFormularioReindexadoCancelarForm" action="<html:rewrite action="/CrearTarea/FormularioReindexadoCancelar"/>" method="post">
