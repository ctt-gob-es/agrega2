...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-informe-fecha-usuario-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarInformeFechaUsuarioVolverForm" action="/DescripcionTarea/MostrarInformeFechaUsuarioVolver" method="post" >
					...
					<div class="globo_gris_03">
						...
						<div id="formulario">
							...
							<div class="fila_de_tabla">
								<div class="contenedor_izquierda">
									<div class="text">
										<label for="usuario"><bean:message key="usuarios.usuario"/></label>
									</div>
								</div>
								<div class="contenedor_derecha">
									<div class="text">
										<input DISABLED name="usuario" value="${form.usuario}" id="usuario" type="text" style="background-color:white"/>
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
