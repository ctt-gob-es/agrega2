...
<h2><bean:message key="informes.eliminarInformesFederados.cabecera"/></h2>


<!--		Inicio del formulario principal		-->

<form id="eliminarInformeFederadoConfirmarAceptarForm" action='<html:rewrite action="/EliminarInformesFederados/ConfirmarFederadosAceptar"/>' method="post"  >
...
<form id="eliminarInformeFederadosConfirmarCancelarForm" action='<html:rewrite action="/EliminarInformesFederados/ConfirmarFederadosCancelar"/>' method="post">
