...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<h2><bean:message key="modificarTarea.cabecera3"/></h2>
	<html:form styleId="obtenerTCargaODEsFormularioActualizarIndicesRemotosAceptarForm" action="/ObtenerTCargaODEs/FormularioActualizarIndicesRemotosAceptar" method="post" enctype="multipart/form-data">
					...
					<!--  *********************       INICIO CAJA DE FORMULARIO     *******************  -->
						<div id="formulario" >
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input name="tipoTarea" READONLY value="<bean:message key="crearTarea.actualizarIndicesRemotos"/>" style="background-color: #e1e1e1" id="tipoTarea" type="text" title="<bean:message key='crearTarea.seleccioneTipoTarea'/>" />
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
	...
	<form id="obtenerTCargaODEsFormularioActualizarIndicesRemotosCancelarForm" action="<html:rewrite action="/ObtenerTCargaODEs/FormularioActualizarIndicesRemotosCancelar"/>" method="post" >
	
	
		<!-- ********************     Formulario del boton cancelar    **************** -->
