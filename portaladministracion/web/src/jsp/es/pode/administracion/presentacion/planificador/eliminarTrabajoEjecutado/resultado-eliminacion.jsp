...
<form id="eliminarTrabajoResultadoEliminacionAceptarForm" action='<html:rewrite action="/EliminarTrabajo/ResultadoEliminacionAceptar"/>' method="post"  >
			...
			<div class="globo_gris_02">
				<div class="globo_gris_03">
					...
					<div id="formulario" class="ali_c">
						...
						<br />
						<bean:define id="OkValue"><bean:message key="tareas.OK.eliminacion"/></bean:define>
						<logic:equal name="form" property="resultado" value="${OkValue}" >
							<p><em class="correcto">${form.descripcionBaja}</em></p>
	                    </logic:equal>
	                    
	                    <bean:define id="ErrorValue"><bean:message key="tareas.ERROR.eliminacion"/></bean:define>
