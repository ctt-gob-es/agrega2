...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioInformeFechaIIAceptarForm" action="/ObtenerTCargaODEs/FormularioInformeFechaIIAceptar" method="post" >
			...
			<div class="globo_gris_01">
				<div class="globo_gris_02">
					...
					<!--  *********************       INICIO CAJA DE FORMULARIO     *******************  -->
						...
						<label class="oculto" for="month1"><bean:message key="crearTarea.mes"/></label><input class="fechazo_02" value="${form.mesDesde}" onblur="this.style.backgroundColor='#e1e1e1'" id="month1" name="mesDesde" type="text" title="<bean:message key="crearTarea.introduzcaMes"/> "/>
	...
	<form id="obtenerTCargaODEsFormularioInformeFechaIICancelarForm" action='<html:rewrite action="/ObtenerTCargaODEs/FormularioInformeFechaIICancelar"/>' method="post" >
