...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-informe-federado-nivel-agregacion-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarInformeFederadoNivelAgregacionVolverForm" action="/DescripcionTarea/MostrarInformeFederadoNivelAgregacionVolver" method="post" >
					...
					<div class="globo_gris_03">
						...
						<div id="formulario">
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input DISABLED name="tipoTarea" value="<bean:message key="informesFederados.nombre.cabecera"/>" id="tipoTarea" type="text" style="background-color:white"/>
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
							...
							<div class="fila_de_tabla" style="">
								...
								<div class="text" style="white-space:nowrap">
									<label class="oculto" for="day1"><bean:message key="crearTarea.fechaDia"/></label><input DISABLED class="fechazo_02" value="25" onblur="this.style.backgroundColor='#e1e1e1'" id="day1" name="dia" type="hidden" title="<bean:message key="crearTarea.introduzcaDia"/> "/>
									
									<label class="oculto" for="month1"><bean:message key="crearTarea.mes"/></label>
										
										<input DISABLED class="fechazo_02" value="${form.mesInicioInforme}" onblur="this.style.backgroundColor='#e1e1e1'" id="month1" name="mesInicioInforme" type="text" title="<bean:message key="crearTarea.introduzcaMes"/> "/>
												
									<label class="oculto"  for="year1" ><bean:message key="crearTarea.fechaAnio"/></label>
									<input DISABLED class="fechazo_02" id="year1"  value="${form.anioInicioInforme}" onblur="this.style.backgroundColor='#e1e1e1'"  name="anioInicioInforme" type="text" onfocus="limpiarTexto(this)" title="<bean:message key="crearTarea.introduzcaAnio"/> "/>
								</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
