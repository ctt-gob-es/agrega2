...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioSubirIndicesAceptarForm" action="/ObtenerTCargaODEs/FormularioSubirIndicesAceptar" method="post" enctype="multipart/form-data">
					...
					<!--  *********************       INICIO CAJA DE FORMULARIO     *******************  -->
						<div id="formulario" >
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input name="tipoTarea" READONLY value="<bean:message key="crearTarea.subirIndices"/>" style="background-color: #e1e1e1" id="tipoTarea" type="text" title="<bean:message key='crearTarea.seleccioneTipoTarea'/>" />
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
