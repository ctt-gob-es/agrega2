...
<%@ include file="/es/pode/administracion/presentacion/planificador/descripcionTarea/mostrar-regenerar-imagenes-vars.jspf" %>
...
<div class="plantilla_contenido">
	...
	<html:form styleId="descripcionTareaMostrarRegenerarImagenesVolverForm" action="/DescripcionTarea/MostrarRegenerarImagenesVolver" method="post" >
