...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioInformeFechaUsuarioIContinuarForm" action="/ObtenerTCargaODEs/FormularioInformeFechaUsuarioIContinuar" method="post" enctype="multipart/form-data">
	...
	<form id="obtenerTCargaODEsFormularioInformeFechaUsuarioICancelarForm" action='<html:rewrite action="/ObtenerTCargaODEs/FormularioInformeFechaUsuarioICancelar"/>' method="post" >
