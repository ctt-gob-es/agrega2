...
<%@ include file="/es/pode/administracion/presentacion/adminusuarios/buscarUsuarios/listado-usuarios-encontrados-vars.jspf" %>
...
<jsp:include page="/layout/messages.jsp" flush="true" />
	...
	<fieldset>
		<form id="listarUsuariosFormularioListadoUsuariosBajaForm" action='<html:rewrite action="/BuscarUsuarios/ListadoUsuariosEncontradosBajaUsuario"/>' method="post" >
		...
		<!--		Inicio del formulario secundario y boton Volver		-->
	
		<form id="buscarUsuariosListadoUsuariosEncontradosVolverForm" action="<html:rewrite action="/BuscarUsuarios/ListadoUsuariosEncontradosVolver"/>" method="post" >
			<input class="boton_125_de_2_izq bot_mar_der"  type="submit"  value="<bean:message key='usuarios.volver'/>" />
		</form>
		</fieldset>
