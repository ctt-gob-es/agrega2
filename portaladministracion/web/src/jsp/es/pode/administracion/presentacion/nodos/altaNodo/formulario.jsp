...
<h2><bean:message key="nodos.alta.cabecera"/></h2>


<!--		Inicio del formulario principal		-->

<html:form styleId="altaNodoFormularioAceptarForm" action='/AltaNodo/FormularioAceptar' method="post" >
								...
								<div class="text">
									...
									<c:choose>
			                        	<c:when test="${!empty form.ccaaBackingList}">
			                        		<html:select name="form" property="comunidad" styleId="ccaa" title="${introCcaa} " >
