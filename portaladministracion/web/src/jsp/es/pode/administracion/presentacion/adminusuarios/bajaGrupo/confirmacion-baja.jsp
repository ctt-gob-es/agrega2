...
<h2><bean:message key="usuarios.bajaGrupo.cabecera"/></h2>


<!--		Inicio del formulario principal		-->

<form id="bajaGrupoConfirmacionBajaAceptarForm" action='<html:rewrite action="/BajaGrupo/ConfirmacionBajaAceptar"/>' method="post"  >
			...
			<div class="globo_gris_02">
				<div class="globo_gris_03">
					...
					<div id="formulario" class="ali_c">
						...
						<p><bean:message key="usuarios.bajaGrupo.confirmacion"/></p>
