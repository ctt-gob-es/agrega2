...
<h2><bean:message key="usuarios.activarUsuario.cabecera"/></h2>


<!--		Inicio del formulario principal		-->

<form id="activarUsuarioConfirmacionActivarUsuarioAceptarForm" action='<html:rewrite action="/ActivarUsuario/ConfirmacionActivarUsuarioAceptar"/>' method="post"  >
			...
			<div class="globo_gris_02">
				<div class="globo_gris_03">
					...
					<div id="formulario" class="ali_c">
						...
						<p><bean:message key="usuarios.activarUsuario.confirmacion"/> ${form.usuario}</p>
