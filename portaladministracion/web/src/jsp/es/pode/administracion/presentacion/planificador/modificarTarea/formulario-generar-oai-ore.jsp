...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioGenerarOaiOreAceptarForm" action="/ObtenerTCargaODEs/FormularioGenerarOaiOreAceptar" method="post" enctype="multipart/form-data">
					...
					<!--  *********************       INICIO CAJA DE FORMULARIO     *******************  -->
						<div id="formulario" >
							...
							<div class="fila_de_tabla">
								...
								<div class="contenedor_derecha">
									<div class="text">
										<input name="tipoTarea" READONLY value="<bean:message key="crearTarea.generarOaiOre"/>" style="background-color: #e1e1e1" id="tipoTarea" type="text" title="<bean:message key='crearTarea.seleccioneTipoTarea'/>" />
									</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
	...
	<form id="obtenerTCargaODEsFormularioGenerarOaiOreCancelarForm" action="<html:rewrite action="/ObtenerTCargaODEs/FormularioGenerarOaiOreCancelar"/>" method="post" >
