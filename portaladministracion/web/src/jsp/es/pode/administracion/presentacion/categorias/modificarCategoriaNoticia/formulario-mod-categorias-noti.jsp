...
<div class="plantilla_contenido">
	<form method="post" action="<html:rewrite action="/ModificarCategoriaNoticiaCU/FormularioModCategoriasNotiValidarFormulario"/>" >
		<!-- ## Para pintar los mensajes de error ## -->
		<jsp:include page="/layout/messages.jsp" flush="true" />			
		<h2><bean:message key="categorias.noticias.titulo.modificar"/></h2>	
		<news:noticiasTag action="modificaCategoriaNoticia" 
							sessionScope="" 
		...
		<input type="hidden" name="idCategoriaNoticia" value="${form.idCategoriaNoticia}"/>		
	</form>
