...
<%@ taglib uri="/WEB-INF/tags/tags-portalAdministracion.tld" prefix="el"%>
...
<h2><bean:message key="usuarios.modificar.cabecera"/></h2>


<!--		Inicio del formulario principal		-->

<form id="modificarUsuarioFormularioInicialContinuarForm" action='<html:rewrite action="/ModificarUsuario/FormularioInicialContinuar"/>' method="post" >
								...
								<div class="globo_blanco_02">
									<div class="globo_blanco_03">
										...
										<div class="fila_de_tabla">
											...
											<div class="contenedor_derecha">
												<div class="text">
													<input READONLY name="NIF" value="${form.NIF}" id="NIF" style="background-color:#e1e1e1" maxlength="11" type="text" title="<bean:message key="usuarios.introduzcaNIF"/>"  />
												</div>
											</div>
											<div class="linea_separadora"></div>
											<br class="oculto" />
								...
								<div class="globo_blanco_02">
									<div class="globo_blanco_03">
										...
										<div class="fila_de_tabla">
											...
											<div class="contenedor_derecha">
												<div class="text">
													<input READONLY name="usuario" value="${form.usuario}" id="Usuario" style="background-color:#e1e1e1" maxlength="25" type="text" title="<bean:message key="usuarios.introduzcaUsuario"/> "  />
												</div>
											</div>
											<div class="linea_separadora"></div>
											<br class="oculto" />
							...
							<div class="globo_blanco_01">
								<div class="globo_blanco_02">
									<div class="globo_blanco_03">
										...
										<div class="fila_de_tabla">
						  					<div class="contenedor_izquierda">
						  						<div class="text"><label for="Editor">*<bean:message key="usuarios.tipoVisualizador"/></label></div>
						 					</div>
											<div class="contenedor_derecha">
												<div class="text">
												
													<html:select name="form" property="tipoVisualizador" titleKey="usuarios.seleccioneVisualizador" styleId="Editor">
										...
										<div class="fila_de_tabla">
											...
											<div class="contenedor_derecha">
												<div class="text">
													...
													<input type="text" name="cuota" style="width:50px" value="${form.cuota}" id="cuota" maxlength="5" title="<bean:message key="usuarios.IntroduzcaCuota"/> "  />
										...
										<!--  CAMPO DE RECIBIR CORREO -->
										
											<div class="fila_de_tabla">
							  					<div class="contenedor_izquierda">
							  						<div class="text"><label for="recibirCorreoPublicacion"><bean:message key="usuario.recibirCorreoPublicacion"/></label></div>
							 					</div>
												<div class="contenedor_derecha">
													<div class="text">
													
													<input class="boton_radio" type="checkbox" name="recibirCorreo" value="true"  <c:if test="${form.recibirCorreo==true}"> checked="checked"  </c:if> id="recibirCorreo"  />
