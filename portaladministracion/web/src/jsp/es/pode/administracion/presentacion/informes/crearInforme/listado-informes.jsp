...
<jsp:include page="/layout/messages.jsp" flush="true" />
	...
	<!--		Formulario secundario y boton volver		-->
  		<form id="crearInformeListadoInformesCancelarForm" action="<html:rewrite action='/CrearInforme/ListadoInformesCancelar'/>" method="post" >
			<input class="boton_125_de_2_izq"  type="submit"  value="<bean:message key='informes.crearInforme.volver'/>" />
		</form>
