...
<form id="formModificarTaxonomiaSubmit" 
	action="<html:rewrite action="/ModificarTaxonomias/FormModificarTaxonomiaSubmit"/>" method="post" enctype="multipart/form-data">
			...
			<div id="formulario">
			 	<div class="fila_de_tabla">
  					<div class="text ft_lateral">
  						...
  						<label for="actualizarVigente" class="alineada"><bean:message key="estructuras.taxonomias.modi.actualizar"/></label>
  					</div>
...
<c:if test="${nombre!=''}">			
  				<div class="fila_de_tabla">
  					<div class="contenedor_izquierda">
  						<div class="text"><label for="Seleccione"><bean:message key="estructuras.taxonomias.modi.actual"/></label></div>
 					</div>
				...
				<div class="fila_de_tabla">
  					<div class="contenedor_izquierda">
  						<div class="text"><label for="fichero"><bean:message key="estructuras.taxonomias.modi.nuevo"/></label></div>
 					</div>
					<div class="contenedor_derecha">
						<div class="text">
