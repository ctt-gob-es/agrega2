...
<script type="text/javascript" src="<rewrite:rewrite url="static/js/calendar.rc4.js"/>"></script>
	...
	<html:form styleId="obtenerTCargaODEsFormularioInformeFederadoNivelAgregacionIIAceptarForm" action="/ObtenerTCargaODEs/FormularioInformeFederadoNivelAgregacionIIAceptar" method="post" >
						...
						<div id="formulario" >
							...
							<div class="fila_de_tabla" style="">
								...
								<div class="text" style="white-space:nowrap">
									<label class="oculto" for="day1"><bean:message key="crearTarea.fechaDia"/></label><input class="fechazo_02" value="25" onblur="this.style.backgroundColor='#e1e1e1'" id="day1" name="dia" type="hidden" title="<bean:message key="crearTarea.introduzcaDia"/> "/>
									
									<label class="oculto" for="month1"><bean:message key="crearTarea.mes"/></label>
									<input class="fechazo_02" value="${form.mesInicioInforme}" onblur="this.style.backgroundColor='#e1e1e1'" id="month1" name="mesInicioInforme" type="text" title="<bean:message key="crearTarea.introduzcaMes"/> "/>
												
									<label class="oculto"  for="year1" ><bean:message key="crearTarea.fechaAnio"/></label>
									<input class="fechazo_02" id="year1"  value="${form.anioInicioInforme}" onblur="this.style.backgroundColor='#e1e1e1'"  name="anioInicioInforme" type="text" onfocus="limpiarTexto(this)" title="<bean:message key="crearTarea.introduzcaAnio"/> "/>
								</div>
								</div>
								<div class="linea_separadora"></div>
								<br class="oculto" />
	...
	<form id="obtenerTCargaODEsFormularioInformeFederadoNivelAgregacionIICancelarForm" action='<html:rewrite action="/ObtenerTCargaODEs/FormularioInformeFederadoNivelAgregacionIICancelar"/>' method="post" >
