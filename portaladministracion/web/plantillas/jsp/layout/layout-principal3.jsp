...
<!--
<script type="text/javascript" src="<rewrite:rewrite url="http://andreslopezjosenge.com/clientes/red/agrega/prod/js/menu_arbol.js"/>"></script>
-->
...
<tiles:put name="urlImagen"><tiles:getAsString name="urlImagen"/></tiles:put>
