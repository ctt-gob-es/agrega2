...
<ol>
	...
	<li id="titulo_empa"><span><bean:message key="metanavegacion.empaquetador.basico"/></span></li>
	...
	<li>
		<a href="<html:rewrite action="/AsistenteAyuda/AsistenteAyuda"/>?returnURL=${urlAsistente }" title="<bean:message key="cabecera.asistente" />" id="asis">
			<c:choose>
				<c:when test="${empaquetadorSession.asistenteAyuda==false}">
...
<bean:define id="ode" name="empaquetadorSession" property="ode" />
