...
public interface SrvAdminUsuariosService extends java.rmi.Remote {
    ...
    /**
     * Los usuarios podr谩n solicitar una nueva clave y que est谩 se
     * les
     *                 env铆e por correo electr贸nico a la cuenta que tienen
     * dada de alta
     *                 en el sistema. Para ello deber谩n introducir la direcci贸n
     * de
     *                 correo electr贸nico y el NIF
     */
