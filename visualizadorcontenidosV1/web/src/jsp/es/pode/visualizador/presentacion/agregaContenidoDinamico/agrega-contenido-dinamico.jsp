					...
					<div id="formulario" >
						...
						<div class="fila_de_tabla">
							...
							<div class="text" style="text-align:center">
								...
								<textarea name="codigo" rows="10" cols="40" class="ta_minimo_ancho"  readonly="readonly" id="codigo"  title="<bean:message key="agregaContenidoDinamico.codigo" />" >${form.codigo}</textarea>
							</div>
