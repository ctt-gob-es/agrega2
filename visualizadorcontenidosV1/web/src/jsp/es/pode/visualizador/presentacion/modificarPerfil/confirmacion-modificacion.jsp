		...
		<div class="globo_gris_01">
			<div class="globo_gris_02">
				...
				<div id="formulario" class="ali_c">
					<br />
					<logic:equal name="form" property="resultadoModificacion" value="OK.MODIFICARUSUARIO" >
							<p><em class="correcto"><bean:message key="usuarios.modificadoPerfil" /></em></p>
		       </logic:equal>
						<logic:equal name="form" property="resultadoModificacion" value="FALLO.MODIFICARUSUARIO" >
                        	<p><em class="incorrecto"><bean:message key="usuarios.modificadoPerfilKO" /></em></p>
	                    </logic:equal>
					<br />
				</div>
