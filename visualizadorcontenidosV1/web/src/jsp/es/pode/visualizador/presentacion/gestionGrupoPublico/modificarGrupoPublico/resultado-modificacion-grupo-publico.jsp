...
<form id="desasociarFavoritoDesasociarFavoritoVolverForm" action='<html:rewrite action="/ModificarGrupoPublico/ResultadoModificacionGrupoPublicoVolver"/>' method="post"  >
				...
				<div class="globo_gris_03">
					...
					<input type="hidden" id="nombre" name="nombre" value="${form.nombre}" />
						...
						<logic:equal name="form" property="resultado" value="OK" >
							<p><em class="correcto"><bean:message key="usuario.modificar.grupo.confirmacion2OK" /></em></p>
							<p>${form.nombre}</p>
	                    </logic:equal>
						<logic:equal name="form" property="resultado" value="FALLO" >
                        	<p><em class="incorrecto"><bean:message key="usuario.modificar.grupo.confirmacion2KO" /></em></p>
                        	<p>${form.nombre}</p>
	                    </logic:equal>
						<br />
					</div>
