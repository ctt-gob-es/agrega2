...
<form id="agregaSliderCodigoEmbebidoVolverForm" action='<html:rewrite action="/AgregaSlider/CodigoEmbebidoVolver"/>' method="post" >
	...
	<p class="parrafo_comun"><bean:message key="agregaSlider.explicacionCodigo" /></p>
					...
					<div id="formulario" >
						...
						<div class="fila_de_tabla">
							...
							<div class="text" style="text-align:center">
								...
								<textarea name="codigo_embebido" rows="10" cols="40" class="ta_minimo_ancho"  readonly="readonly" id="codigo_embebido"  title="<bean:message key="agregaSlider.codigo" />" >${form.codigo}</textarea>
							</div>
						<br class="oculto" />
