...
<form id="eliminarGrupoPublicoConfirmacionEliminacionObtenerAccionForm" action='<html:rewrite action="/EliminarGrupoPublico/ConfirmacionEliminacionObtenerAccion"/>' method="post"  >
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<!--  INICIO CAJA DE FORMULARIO   -->
					...
					<br />
						<p><em class="corrector"><bean:message key="usuario.eliminar.grupo.confirmacion"/></em></p>
