...
<form id="eliminarContactoConfirmarEliminacionContactoVolverForm" action='<html:rewrite action="/EliminarContacto/ResultadoEliminacionContactoVolver"/>' method="post"  >
		...
		<div class="globo_gris_02">
			...
			<br />
			 <logic:equal name="form" property="resultado" value="OK" >
							<p><em class="correcto"><bean:message key="usuarios.contacto.eliminar.confirmacion2OK" /></em></p>
							<p>${form.usuarioContacto}</p>
	                    </logic:equal>
						<logic:equal name="form" property="resultado" value="FALLO" >
                        	<p><em class="incorrecto"><bean:message key="usuarios.contacto.eliminar.confirmacion2KO" /></em></p>
                        	<p>${form.usuarioContacto}</p>
	          </logic:equal>
				<br />
				</div>
