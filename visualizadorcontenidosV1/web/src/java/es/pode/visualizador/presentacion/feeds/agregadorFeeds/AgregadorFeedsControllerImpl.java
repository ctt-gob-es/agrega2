...
public class AgregadorFeedsControllerImpl extends AgregadorFeedsController
{
	...
	protected static final String FILE_NAME_PROPERTIES = "/spring_visualizadorcontenidos.properties";
...
//				 devolvemos la propiedad
 		...
 		log.error("ListadoNubeTag - Error recuperando propiedad de spring_visualizadorcontenidos.properties=",e);
        }
