...
public class EstadisticasPortadaControllerImpl extends EstadisticasPortadaController
{
	...
	private static Logger logger = Logger.getLogger(EstadisticasPortadaControllerImpl.class);
...
logger.info("Obteniendo estadisticas. ");
    	...
    	try {
			...
			logger.error("Excepción inesperada obteniendo número de usuarios y número de objetos: "+ e);
			throw e;
		}
    }
}