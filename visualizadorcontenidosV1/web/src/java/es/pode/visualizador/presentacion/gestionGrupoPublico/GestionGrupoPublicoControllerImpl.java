...
//			       GrupoPublicoVO[] gruposSelec = usuarioPublico.getGrupoPublico();
      ...
      form.setCodigoEmbeb(codigoEmbeb);
    	   ...
    	   logger.error("No existe ning�n grupo con ese nombre");
...
//				 devolvemos la propiedad
 		...
 		logger.error("GestionGrupoPublico - Error recuperando propiedad de spring_visualizadorcontenidos.properties=",e);
        }
    	...
    	OdeConURLs[] odesURL=null;
	    	try{
	    		...
	    		for(int i=0;i<odes.length;i++){
	    			...
	    			String urlFicha=ODEPublico.urlFichaPrivadaODEPublicado(identificador, idioma);
