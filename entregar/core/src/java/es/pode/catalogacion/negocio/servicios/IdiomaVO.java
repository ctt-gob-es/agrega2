...
public class IdiomaVO  implements java.io.Serializable {
    ...
    /**
     * Gets the texto value for this IdiomaVO.
     * 
     * @return texto
     */
    ...
    /**
     * Sets the texto value for this IdiomaVO.
     * 
     * @param texto
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "IdiomaVO"));
