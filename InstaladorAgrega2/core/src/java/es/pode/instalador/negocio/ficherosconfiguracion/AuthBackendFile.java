...
public class AuthBackendFile {
	...
	/**
	 * Array con la lista de las variables que estaban contenidas en el fichero de authbackend.properties y que se modificaban en la instalacion.
	 */
	public static String[] variables = new String[]{
		...
		InstalacionVariables.USERCNPREFIX,
		InstalacionVariables.ROLEBINDSUBPATH,
		InstalacionVariables.CASURL,
	...
	public static String ficheroPlantilla = "/authbackend.properties";
	/**
	 * Lista con las variables que estaban contenidas en el fichero de authbackend.properties y que se modificaban en la instalacion.
	 */
	public static List<String> listaVariables = (List<String>) Arrays.asList(variables);
	
	/**
	 * Metodo que indica si la variable que se le pasa es de las contenidas anteriormente en el fichero de authbackend.properties
	 * o no.
	 * @param variable Valor de la variable que se quiere averiguar si estaba reflejada en el fichero authbackend.properties en la instalacion.
	...
	/**
	 * Metodo que chequea que las variables que se le pasan contienen todas las variables necesarias para rellenar con exito el fichero authbackend.properties
	 * @param prop
	 */
...
//		Me copio las variables que hacen falta en el fichero
		...
		{	
			...
			throw new Exception("Imposible modificar fichero authbackedn.properties. El numero de propiedades suministradas no es correcto. Faltan por rellenar ["+copiaVariables.size()+"] valores de variables de ["+variables.length+"] totales. Faltan: "+faltan);
		}
	}
}
