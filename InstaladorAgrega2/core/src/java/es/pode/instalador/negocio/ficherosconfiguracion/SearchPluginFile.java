...
public class SearchPluginFile {
	...
	/**
	 * Array con la lista de las variables que estaban contenidas en el fichero de searchPlugin.xml y que se modificaban en la instalacion.
	 */
	...
	/**
	 * Lista con las variables que estaban contenidas en el fichero de searchPlugin.xml y que se modificaban en la instalacion.
	 */
	 ...
	 */
	public static String directorioDestino = "searchPlugin";
	public static String ficheroDestino = "searchPlugin.xml";
	
	public static String ficheroPlantilla = "/searchPlugin.xml";
	/**
	 * Metodo que indica si la variable que se le pasa es de las contenidas anteriormente en el fichero de searchPlugin.xml
	 * o no.
	 * @param variable Valor de la variable que se quiere averiguar si estaba reflejada en el fichero searchPlugin.xml en la instalacion.
	...
	public static void modificaVariables(PropiedadVO[] prop, String homeFile, String typeJboss)throws Exception
	{
		...
		InputStream ipstrm = SearchPluginFile.class.getResourceAsStream(ficheroPlantilla);
		Sed.sustituir(ipstrm, ficheroDestinoDisco,propiedades);
		return;
	}

	/**
	 * Metodo que chequea que las variables que se le pasan contienen todas las variables necesarias para rellenar con exito el fichero searchPlugin.xml
	 * @param prop
	 */
...
//		Me copio las variables que hacen falta en el fichero
		...
		{	
			...
			throw new Exception("Imposible modificar fichero searchPlugin.xml. El numero de propiedades suministradas no es correcto. Faltan por rellenar["+copiaVariables.size()+"] valores de variables de ["+variables.length+"]totales. Faltan: "+faltan);
		}
	}
}
