...
public class Robots {
	...
	/**
	 * Array con la lista de las variables que estaban contenidas en los ficheros de robots.txt y que se modificaban en la instalacion.
	 */
	...
	/**
	 * Lista con las variables que estaban contenidas en los ficheros de robots.txt y que se modificaban en la instalacion.
	 */
	...
	public static String ficheroDestino = "robots.txt";
	
	public static String ficheroPlantilla = "/robots.txt";
	
	/**
	 * Metodo que indica si la variable que se le pasa es de las contenidas anteriormente en los ficheros de robots.txt
	 * o no.
	 * @param variable Valor de la variable que se quiere averiguar si estaba reflejada en los ficheros robots.txt en la instalacion.
	...
	/**
	 * Este metodo modifica el valor de las variables que le pasan en la plantilla del fichero robots.txt
	...
	public static void modificaVariables(PropiedadVO[] prop, String homeFile, String typeJboss)throws Exception
	{
		...
		InputStream ipstrm = Robots.class.getResourceAsStream(ficheroPlantilla);
		Sed.sustituir(ipstrm, ficheroDestinoDisco,propiedades);
		return;
	}

	/**
	 * Metodo que chequea que las variables que se le pasan contienen todas las variables necesarias para rellenar con exito el fichero robots.txt
	 * @param prop
	 */
...
//		Me copio las variables que hacen falta en el fichero
		...
		{	
			...
			throw new Exception("Imposible modificar fichero robots.txt. El numero de propiedades suministradas no es correcto. Faltan por rellenar["+copiaVariables.size()+"] valores de variables de ["+variables.length+"]totales. Faltan: "+faltan);
		}
	}
}
