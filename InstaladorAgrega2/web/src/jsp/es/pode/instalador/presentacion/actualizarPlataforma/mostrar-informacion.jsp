...
<form method="post" action="<html:rewrite action="/ActualizarPlataformaCU/MostrarInformacionSubmit2.do"/>" enctype="multipart/form-data" onsubmit="startLoading()">	

	<input type="hidden" name="rutaContenidoActualizacion" value="${form.rutaContenidoActualizacion}"/>
	...
	<div id="formulario" >
	 	...
	 	<div class="fila_de_tabla">
			<div class="text" style="text-align:left">
				<br>
				<c:if test="${form.contieneNotas=='true'}">	
					<strong><bean:message key="actualizarPlataforma.notasPaquete" /></strong>
					<br>
					${form.notas}
					<br>
					<br>
				</c:if> 
				<c:if test="${form.contieneActualizacionDB=='true'}">
					- <bean:message key="actualizarPlataforma.contieneActualizacionDB" />
					<br>
				</c:if> 
				<c:if test="${form.contieneActualizacionSH=='true'}">	
					- <bean:message key="actualizarPlataforma.contieneActualizacionSH" />
					<br>
				</c:if> 				
				<br class="oculto">
			</div>
			...
			<div class="text" style="text-align:center">
				<bean:message key="actualizarPlataforma.deseaContinuar" />
			</div>
