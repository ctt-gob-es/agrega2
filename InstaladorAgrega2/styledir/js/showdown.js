...
var _9=function(_19){
_19=_1a(_19);
var key=_1c("<hr class='especialhr' />");
...
_4f=_4f.replace(/^(.+)[ \t]*\n=+[ \t]*\n+/gm,function(_50,m1){
return _1c("<h1 class='especialh1'>"+_21(m1)+"</h1>");
});
_4f=_4f.replace(/^(.+)[ \t]*\n-+[ \t]*\n+/gm,function(_52,m1){
return _1c("<h2 class='especialh2'>"+_21(m1)+"</h2>");
});
...
_83=_83.replace(/(\*\*|__)(?=\S)([^\r]*?\S[*_]*)\1/g,"<strong class='especial'>$2</strong>");
...
return _1c("<blockquote class='especialbq' >\n"+bq+"\n</blockquote>");
});
return _84;
};
