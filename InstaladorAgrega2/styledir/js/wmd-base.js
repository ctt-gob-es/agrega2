...
_2b.height="100%";
_2b.width=_2a;
_2b.filter="progid:DXImageTransform.Microsoft."+"AlphaImageLoader(src='"+_2.basePath+"../img/bg.png')";
_2b.position="absolute";
if(_2e&1){
_2b.top="0";
}else{
...
_2b.height="100%";
_2b.width=_2a;
_2b.filter="progid:DXImageTransform.Microsoft."+"AlphaImageLoader(src='"+_2.basePath+"../img/bg-fill.png',sizingMethod='scale')";
_2b.position="absolute";
_33.appendChild(_34);
if(_32){
_2b.left="0";
...
if(!_2c){
_2b.backgroundImage="url("+_2.basePath+"../img/bg-fill.png)";
...
var _d0=function(){
var _d1=_6.createImage("../img/separator.png",20,20);
...
_e1();
_6.skin(_b8,_2.basePath+"../img/bg.png",_b2,_b3);
...
_b8.appendChild(_b9);
_cd(_8.autoindent);
var _e8=_6.createImage("../img/bg.png");
var _e9=_6.createImage("../img/bg-fill.png");
_e2();
_d9();
if(_bd){
_d0();
...
_fb.target="_blank";
_fb.title="Editor";
var _fc=_6.createImage("../img/wmd.png");
var _fd=_6.createImage("../img/wmd-on.png");
_fb.appendChild(_fc);
_fb.onmouseover=function(){
_6.setImage(_fc,"../img/wmd-on.png");
_fb.style.cursor="pointer";
};
_fb.onmouseout=function(){
_6.setImage(_fc,"../img/wmd.png");
};
_b8.appendChild(_fb);
};
var _e1=function(){
...
return _8.doBorI(_132,2,"Texto en negrita");
};
_8.doItalic=function(_133){
return _8.doBorI(_133,1,"Texto en cursiva");
};
...
if(_152){
_154=_6.prompt("<h3 class='h3_generico'>Introduzca la URL de la imagen.</h3><p style='font:80% Verdana, Arial, Helvetica, sans-serif; color:#333;padding:5px 0'>Puede también ponerle un titulo a la imagen.</p><p style='font:80% Verdana, Arial, Helvetica, sans-serif; color:#333;padding-bottom:5px'>Ejemplo: http://agrega.com/img/logo.jpg   \"Título opcional\"</p>","http://",_155);
}else{
_154=_6.prompt("<h3 class='h3_generico'>Introduzca la URL del enlace.</h3><p style='font:80% Verdana, Arial, Helvetica, sans-serif; color:#333;padding:5px 0'>Puede también ponerle un titulo al enlace</p><p style='font:80% Verdana, Arial, Helvetica, sans-serif; color:#333;padding-bottom:5px'>Ejemplo: http://agrega.com/   \"Título opcional\"</p>","http://",_155);
}
return true;
}
};
_8.bold={};
_8.bold.description="Negrita <strong>";
_8.bold.image="../img/bold.png";
_8.bold.key="b";
_8.bold.textOp=_8.doBold;
_8.italic={};
_8.italic.description="Cursiva <em>";
_8.italic.image="../img/italic.png";
_8.italic.key="i";
_8.italic.textOp=_8.doItalic;
_8.link={};
_8.link.description="Agregar un enlace de una URL <a>";
_8.link.image="../img/link.png";
_8.link.key="l";
_8.link.textOp=function(_159,_15a){
return _8.doLinkOrImage(_159,false,_15a);
};
_8.undo={};
_8.undo.description="Deshacer";
_8.undo.image="../img/undo.png";
_8.undo.execute=function(_15b){
_15b.undo();
};
_8.redo={};
_8.redo.description="Rehacer";
_8.redo.image="../img/redo.png";
