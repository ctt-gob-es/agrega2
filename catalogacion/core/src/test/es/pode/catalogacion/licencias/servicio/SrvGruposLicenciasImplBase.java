 ...
 */
public class SrvGruposLicenciasImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvGruposLicenciasImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.catalogacion.licencias.servicio.SrvGruposLicencias
    */
    
    protected es.pode.catalogacion.licencias.servicio.SrvGruposLicencias servicio;
	public void setServicio(es.pode.catalogacion.licencias.servicio.SrvGruposLicencias servicio) {
