...
//		   
//	   }
	   public void testTraducirLomBasico() {
	    	SrvCatalogacionBasicaService catalogacionBasica = this.servicio;
	    	LomBasicoVO lomBas = new LomBasicoVO();
	    	lomBas = catalogacionBasica.obtenerLomBasico("idLOM1", "prueba", "es");
	    	LomBasicoVO lomBasico = catalogacionBasica.traducirLomes("idLOM1", "prueba", "en", lomBas, "es", true);
	    	assertTrue(true);
