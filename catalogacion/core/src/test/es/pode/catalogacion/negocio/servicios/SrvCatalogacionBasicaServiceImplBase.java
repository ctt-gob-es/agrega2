 ...
 */
public class SrvCatalogacionBasicaServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvCatalogacionBasicaServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.catalogacion.negocio.servicios.SrvCatalogacionBasicaService
    */
    
    protected es.pode.catalogacion.negocio.servicios.SrvCatalogacionBasicaService servicio;
	public void setServicio(es.pode.catalogacion.negocio.servicios.SrvCatalogacionBasicaService servicio) {
