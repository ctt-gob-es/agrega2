...
import es.pode.modificador.negocio.cambios.configuracion.castor.RemovalType;

/**
 * Class RemovalTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RemovalTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RemovalTypeDescriptor() {
        super();
        _nsURI = "Agrega";
        _xmlName = "removalType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RemovalType target = (RemovalType) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.modificador.negocio.cambios.configuracion.castor.RemovalType.class;
    }
