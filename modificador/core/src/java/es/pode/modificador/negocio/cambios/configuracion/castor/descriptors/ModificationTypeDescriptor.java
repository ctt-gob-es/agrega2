...
import es.pode.modificador.negocio.cambios.configuracion.castor.ModificationType;

/**
 * Class ModificationTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ModificationTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ModificationTypeDescriptor() {
        super();
        _nsURI = "Agrega";
        _xmlName = "modificationType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ModificationType target = (ModificationType) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _regExp
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Boolean.TYPE, "_regExp", "reg-exp", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ModificationType target = (ModificationType) object;
                if (!target.hasRegExp()) { return null; }
                return (target.getRegExp() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setRegExp( ((java.lang.Boolean) value).booleanValue());
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setValidator(fieldValidator);
        //-- _replaceAll
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Boolean.TYPE, "_replaceAll", "replace-all", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ModificationType target = (ModificationType) object;
                if (!target.hasReplaceAll()) { return null; }
                return (target.getReplaceAll() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setReplaceAll( ((java.lang.Boolean) value).booleanValue());
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _replaceAll
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            org.exolab.castor.xml.validators.BooleanValidator typeValidator;
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.modificador.negocio.cambios.configuracion.castor.ModificationType.class;
    }
