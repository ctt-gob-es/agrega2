 ...
 */
public class ModificationType implements java.io.Serializable {
    ...
    /**
     * keeps track of state for field: _replaceAll
     */
    private boolean _has_replaceAll;
    ...
    /**
     */
    public void deleteReplaceAll(
    ) {
        this._has_replaceAll= false;
    }
    ...
    /**
     * Returns the value of field 'replaceAll'.
     * 
     * @return the value of field 'ReplaceAll'.
     */
    ...
    /**
     * Method hasReplaceAll.
     * 
     * @return true if at least one ReplaceAll has been added
     */
    public boolean hasReplaceAll(
    ) {
        return this._has_replaceAll;
    }
    ...
    /**
     * Sets the value of field 'replaceAll'.
     * 
     * @param replaceAll the value of field 'replaceAll'.
     */
    public void setReplaceAll(
            final boolean replaceAll) {
        this._replaceAll = replaceAll;
        this._has_replaceAll = true;
    }
