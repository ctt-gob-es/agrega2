...
public class Exportacion implements Cambio {

	private Logger logger = Logger.getLogger(Exportacion.class);
...
//		esta tarea ha sido reemplazada por la tarea de Transformacion, se reemplaza las llamadas al anterior metodo del servicio
//		entregar para tener la misma respuesta que la tarea Transformacion y así mantener compatibilidad con tareas pre-existentes.
...
//			if(logger.isDebugEnabled()) logger.debug(e);
    ...
    protected final es.pode.entregar.negocio.servicios.SrvEntregarService getSrvEntregarService()
		...
		logger.debug("srvEntregarServiceEndPointAddress del fichero --> "
				+ srvEntregarServiceEndPointAddress);
