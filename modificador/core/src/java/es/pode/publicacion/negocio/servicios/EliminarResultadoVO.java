...
public class EliminarResultadoVO  implements java.io.Serializable {
    ...
    /* Valor entero del mensaje con el que ha terminado la operacion
     * de
     ...
     * 
     * @return code   * Valor entero del mensaje con el que ha terminado la operacion
     * de
     *                                 eliminado sobre ese ODE.
     */
    public int getCode() {
     ...
     * 
     * @param code   * Valor entero del mensaje con el que ha terminado la operacion
     * de
     *                                 eliminado sobre ese ODE.
     */
