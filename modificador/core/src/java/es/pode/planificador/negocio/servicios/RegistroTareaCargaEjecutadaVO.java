...
public class RegistroTareaCargaEjecutadaVO  implements java.io.Serializable {
    ...
    /* Conjunto de identificadores mec similares al ode cargado (ser谩
     ...
     * 
     * @return odesSimilares   * Conjunto de identificadores mec similares al ode cargado (ser谩
     * una lista de identificadores separados por comas)
     */
     ...
     * 
     * @param odesSimilares   * Conjunto de identificadores mec similares al ode cargado (ser谩
     * una lista de identificadores separados por comas)
     */
