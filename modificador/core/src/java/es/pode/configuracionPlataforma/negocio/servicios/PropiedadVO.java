...
public class PropiedadVO  implements java.io.Serializable {
    ...
    /**
     * Gets the subcategoria value for this PropiedadVO.
     * 
     * @return subcategoria
     */
    ...
    /**
     * Sets the subcategoria value for this PropiedadVO.
     * 
     * @param subcategoria
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.negocio.configuracionPlataforma.pode.es", "subcategoria"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
