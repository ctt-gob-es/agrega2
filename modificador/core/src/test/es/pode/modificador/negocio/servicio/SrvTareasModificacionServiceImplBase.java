 ...
 */
public class SrvTareasModificacionServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvTareasModificacionServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.modificador.negocio.servicio.SrvTareasModificacionService
    */
    
    protected es.pode.modificador.negocio.servicio.SrvTareasModificacionService servicio;
	public void setServicio(es.pode.modificador.negocio.servicio.SrvTareasModificacionService servicio) {
