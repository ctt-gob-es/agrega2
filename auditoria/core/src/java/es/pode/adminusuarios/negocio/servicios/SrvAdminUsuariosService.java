...
public interface SrvAdminUsuariosService extends java.rmi.Remote {
    ...
    /**
     * Descripci贸n de los datos de un grupo
     */
    ...
    /**
     * Comprueba si existe en el sistema un usuario con ese
     * 				usuario (login)
     */
    ...
    /**
     * Listado de todos los usuarios del nodo que ya han sido
     * 				dados de alta por el administrador
     */
    public es.pode.adminusuarios.negocio.servicios.UsuarioVO[] listarUsuarios() throws java.rmi.RemoteException;

    /**
     * Listado de los usuarios del nodo que no han sido dados
    ...
    /**
     * Modificaci贸n de los datos de un grupo
     */
    public void modificarGrupo(es.pode.adminusuarios.negocio.servicios.GrupoVO grupo) throws java.rmi.RemoteException;

    /**
     * Datos nuevos del usuario. La propiedad id del objeto
     * 				UsuarioVO es el identificado del usuarioque va a ser
     * 				modificado
     */
    ...
    /**
     * Los usuarios podr谩n solicitar una nueva clave y que est谩
     * 				se les env铆e por correo electr贸nico a la cuenta que
     * 				tienen dada de alta en el sistema. Para ello deber谩n
     * 				introducir la direcci贸n de correo electr贸nico y el NIF
     */
