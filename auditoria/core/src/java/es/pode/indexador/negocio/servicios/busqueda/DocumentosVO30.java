...
public class DocumentosVO30  implements java.io.Serializable {
    private es.pode.indexador.negocio.servicios.busqueda.DocVO30[] resultados;
    ...
    private es.pode.indexador.negocio.servicios.busqueda.TaxonVO30[] tesauros;
    ...
    public DocumentosVO30(
           es.pode.indexador.negocio.servicios.busqueda.DocVO30[] resultados,
           ...
           es.pode.indexador.negocio.servicios.busqueda.TaxonVO30[] tesauros,
     ...
     * @return resultados
     */
    public es.pode.indexador.negocio.servicios.busqueda.DocVO30[] getResultados() {
        return resultados;
    }
     ...
     * @param resultados
     */
    public void setResultados(es.pode.indexador.negocio.servicios.busqueda.DocVO30[] resultados) {
        this.resultados = resultados;
    }
     ...
     * @return tesauros
     */
    public es.pode.indexador.negocio.servicios.busqueda.TaxonVO30[] getTesauros() {
        return tesauros;
    }
     ...
     * @param tesauros
     */
    public void setTesauros(es.pode.indexador.negocio.servicios.busqueda.TaxonVO30[] tesauros) {
        this.tesauros = tesauros;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "DocumentosVO30"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "DocVO30"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "TaxonVO30"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "item"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("versionComunidadSolicitada");
        elemField.setXmlName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "versionComunidadSolicitada"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
