...
public class InformeCargaVO  implements java.io.Serializable {
     ...
     * 
     * @return pathCarga   * Es el path raíz donde se encuentran los ODEs
     */
     ...
     * 
     * @param pathCarga   * Es el path raíz donde se encuentran los ODEs
     */
     ...
     * 
     * @return descripcionCarga   * La descripción de la carga
     */
     ...
     * 
     * @param descripcionCarga   * La descripción de la carga
     */
