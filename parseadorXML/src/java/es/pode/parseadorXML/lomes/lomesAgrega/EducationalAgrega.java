...
//		 Devuelve null
   ...
   //para obtener un arrayList de DescripcionesAV
   public ArrayList getOrientacionesDidacticas(){
	   
	   ArrayList l= new ArrayList();
	   
	   try {
		l = getDescripcionesAv();
   ...
   //para obtener un arraylist con las descripciones correspondientes a un idioma
   
   public ArrayList getOrientacionesDidacticas(String idioma){
	   ...
	   if(idioma!=null){
		   ...
		   lAux = getOrientacionesDidacticas();
	   
		   Iterator i = lAux.iterator();
		   LangStringAgrega lString=new LangStringAgrega();
	  
		   while(i.hasNext()){
		   
			   lString = (LangStringAgrega)i.next();
			   if(idioma.equals(lString.getIdioma())){
