...
//  método que añade una contribución de publicacion en primer lugar en el array de contribuciones. Hay que indicar la entidad y la fecha
...
//    método que añade una contribución de creación en primer lugar en el array de contribuciones. Hay que indicar la entidad y la fecha
    ...
    // método que recoge todos los autores que estén indicados en la categoría LifeCycle
    ...
    public EntidadAgrega interpretaVCard (java.lang.String vcard) throws java.lang.Exception{
 	   ...
 	   if ((vcard != null) && (vcard.startsWith(cabeceraVCard))){
	   		...
	   		//o pasamos los parámetros en blanco
	   		ent.setCorreo("");
	   		ent.setNombre("");
	   		ent.setOrganizacion("");
