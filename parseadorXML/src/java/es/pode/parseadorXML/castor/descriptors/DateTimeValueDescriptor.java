...
import es.pode.parseadorXML.castor.DateTimeValue;

/**
 * Class DateTimeValueDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class DateTimeValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DateTimeValueDescriptor() {
        super();
        _nsURI = "http://ltsc.ieee.org/xsd/LOM";
        _xmlName = "DateTimeValue";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DateTimeValue target = (DateTimeValue) object;
        ...
        { //-- local scope
            ...
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
            fieldValidator.setValidator(typeValidator);
            typeValidator.setFixed("dateTime");
            typeValidator.setWhiteSpace("preserve");
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.DateTimeValue.class;
    }
