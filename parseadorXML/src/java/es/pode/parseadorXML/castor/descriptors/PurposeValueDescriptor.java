...
import es.pode.parseadorXML.castor.PurposeValue;

/**
 * Class PurposeValueDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PurposeValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PurposeValueDescriptor() {
        super();
        _nsURI = "http://ltsc.ieee.org/xsd/LOM";
        _xmlName = "purposeValue";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PurposeValue target = (PurposeValue) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.PurposeValue.class;
    }
