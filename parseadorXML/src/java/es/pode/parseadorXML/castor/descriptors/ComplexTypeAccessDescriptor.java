...
import es.pode.parseadorXML.castor.ComplexTypeAccess;

/**
 * Class ComplexTypeAccessDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ComplexTypeAccessDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ComplexTypeAccessDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ComplexTypeAccess target = (ComplexTypeAccess) object;
        ...
        //-- _accessType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(es.pode.parseadorXML.castor.AccessType.class, "_accessType", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ComplexTypeAccess target = (ComplexTypeAccess) object;
                    target.setAccessType( (es.pode.parseadorXML.castor.AccessType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new es.pode.parseadorXML.castor.AccessType();
            }
        };
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new es.pode.parseadorXML.castor.descriptors.AccessTypeDescriptor());
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.ComplexTypeAccess.class;
    }
