...
import es.pode.parseadorXML.castor.DependencyType;

/**
 * Class DependencyTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class DependencyTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DependencyTypeDescriptor() {
        super();
        _nsURI = "http://www.imsglobal.org/xsd/imscp_v1p1";
        _xmlName = "dependencyType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DependencyType target = (DependencyType) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.DependencyType.class;
    }
