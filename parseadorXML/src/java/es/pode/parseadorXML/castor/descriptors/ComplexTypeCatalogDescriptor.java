...
import es.pode.parseadorXML.castor.ComplexTypeCatalog;

/**
 * Class ComplexTypeCatalogDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ComplexTypeCatalogDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ComplexTypeCatalogDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ComplexTypeCatalog target = (ComplexTypeCatalog) object;
        ...
        { //-- local scope
            ...
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
            fieldValidator.setValidator(typeValidator);
            typeValidator.setFixed("catalog");
            typeValidator.setWhiteSpace("preserve");
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.ComplexTypeCatalog.class;
    }
