...
import es.pode.parseadorXML.castor.DurationValue;

/**
 * Class DurationValueDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class DurationValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DurationValueDescriptor() {
        super();
        _nsURI = "http://ltsc.ieee.org/xsd/LOM";
        _xmlName = "DurationValue";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DurationValue target = (DurationValue) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.DurationValue.class;
    }
