...
import es.pode.parseadorXML.castor.ResourceType;
...
public class ResourceTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ResourceTypeDescriptor() {
        ...
        // PRUEBA SCORMTYPE *********************************
//      -- _type
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_scormType", "scormType", org.exolab.castor.xml.NodeType.Attribute);
        desc.setNameSpacePrefix("adlcp");
        desc.setNameSpaceURI("http://www.adlnet.org/xsd/adlcp_v1p3");
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ResourceType target = (ResourceType) object;
                    target.setScormType( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _scormType
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            org.exolab.castor.xml.validators.StringValidator typeValidator;
        ...
        desc.setValidator(fieldValidator);
        //-- _fileList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(es.pode.parseadorXML.castor.File.class, "_fileList", "file", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ResourceType target = (ResourceType) object;
                    target.addFile( (es.pode.parseadorXML.castor.File) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new es.pode.parseadorXML.castor.File();
            }
        };
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.imsglobal.org/xsd/imscp_v1p1");
        ...
        desc.setValidator(fieldValidator);
        //-- _dependencyList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(es.pode.parseadorXML.castor.Dependency.class, "_dependencyList", "dependency", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ResourceType target = (ResourceType) object;
                    target.addDependency( (es.pode.parseadorXML.castor.Dependency) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public void resetValue(Object object) throws IllegalStateException, IllegalArgumentException {
                try {
                    ResourceType target = (ResourceType) object;
                    target.removeAllDependency();
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new es.pode.parseadorXML.castor.Dependency();
            }
        };
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.imsglobal.org/xsd/imscp_v1p1");
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.ResourceType.class;
    }
