...
import es.pode.parseadorXML.castor.StructureValue;

/**
 * Class StructureValueDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class StructureValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public StructureValueDescriptor() {
        super();
        _nsURI = "http://ltsc.ieee.org/xsd/LOM";
        _xmlName = "structureValue";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                StructureValue target = (StructureValue) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.StructureValue.class;
    }
