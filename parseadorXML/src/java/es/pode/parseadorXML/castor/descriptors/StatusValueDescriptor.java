...
import es.pode.parseadorXML.castor.StatusValue;

/**
 * Class StatusValueDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class StatusValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public StatusValueDescriptor() {
        super();
        _nsURI = "http://ltsc.ieee.org/xsd/LOM";
        _xmlName = "statusValue";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                StatusValue target = (StatusValue) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.StatusValue.class;
    }
