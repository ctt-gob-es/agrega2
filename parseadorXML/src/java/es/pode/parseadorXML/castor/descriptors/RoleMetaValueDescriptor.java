...
import es.pode.parseadorXML.castor.RoleMetaValue;

/**
 * Class RoleMetaValueDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RoleMetaValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RoleMetaValueDescriptor() {
        super();
        _nsURI = "http://ltsc.ieee.org/xsd/LOM";
        _xmlName = "roleMetaValue";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RoleMetaValue target = (RoleMetaValue) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.RoleMetaValue.class;
    }
