...
import es.pode.parseadorXML.castor.ComplexTypeResource;

/**
 * Class ComplexTypeResourceDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ComplexTypeResourceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ComplexTypeResourceDescriptor() {
        super();
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ComplexTypeResource target = (ComplexTypeResource) object;
        ...
        { //-- local scope
            ...
            typeValidator.setFixed("resource");
        ...
        //-- _identifier
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(es.pode.parseadorXML.castor.Identifier.class, "_identifier", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ComplexTypeResource target = (ComplexTypeResource) object;
                    target.setIdentifier( (es.pode.parseadorXML.castor.Identifier) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
    ...
    public java.lang.Class getJavaClass(
        ...
        return es.pode.parseadorXML.castor.ComplexTypeResource.class;
    }
