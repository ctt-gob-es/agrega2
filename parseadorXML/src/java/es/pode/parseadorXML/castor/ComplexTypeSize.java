...
/**
 * Class ComplexTypeSize.
 * 
 * @version $Revision$ $Date$
 */
public class ComplexTypeSize implements java.io.Serializable {
     ...
     */
    private java.lang.String _uniqueElementName = "size";
    ...
    public ComplexTypeSize() {
        super();
        setUniqueElementName("size");
    }
     ...
     * es.pode.parseadorXML.castor.ComplexTypeSize
     */
    public static es.pode.parseadorXML.castor.ComplexTypeSize unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (es.pode.parseadorXML.castor.ComplexTypeSize) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.ComplexTypeSize.class, reader);
    }
