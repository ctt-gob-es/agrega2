 ...
 */
public class Location extends LocationType 
implements java.io.Serializable
{
    ...
    public Location() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Location()
    ...
    public static es.pode.parseadorXML.castor.lomieee.LocationType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.LocationType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Location.class, reader);
