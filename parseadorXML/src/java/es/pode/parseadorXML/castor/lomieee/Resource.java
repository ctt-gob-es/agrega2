...
implements java.io.Serializable
{
    ...
    public Resource() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Resource()
    ...
    public static es.pode.parseadorXML.castor.lomieee.ResourceType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.ResourceType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Resource.class, reader);
