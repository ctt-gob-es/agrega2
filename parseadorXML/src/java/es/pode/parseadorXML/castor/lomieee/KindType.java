 ...
 */
public class KindType implements java.io.Serializable {
    ...
    public static es.pode.parseadorXML.castor.lomieee.KindType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.KindType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.KindType.class, reader);
