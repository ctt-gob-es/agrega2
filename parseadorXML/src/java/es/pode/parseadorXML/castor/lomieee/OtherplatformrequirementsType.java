...
/**
 * Class OtherplatformrequirementsType.
 * 
 * @version $Revision$ $Date$
 */
public class OtherplatformrequirementsType implements java.io.Serializable {
    ...
    public OtherplatformrequirementsType() 
     {
        super();
        this._langstringList = new java.util.Vector();
    } //-- es.pode.parseadorXML.castor.lomieee.OtherplatformrequirementsType()
     ...
     * es.pode.parseadorXML.castor.lomieee.OtherplatformrequirementsType
     */
    public static es.pode.parseadorXML.castor.lomieee.OtherplatformrequirementsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.OtherplatformrequirementsType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.OtherplatformrequirementsType.class, reader);
    } //-- es.pode.parseadorXML.castor.lomieee.OtherplatformrequirementsType unmarshal(java.io.Reader) 
