...
/**
 * Class IntendedenduserroleType.
 * 
 * @version $Revision$ $Date$
 */
public class IntendedenduserroleType implements java.io.Serializable {
    ...
    public IntendedenduserroleType() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.IntendedenduserroleType()
     ...
     * es.pode.parseadorXML.castor.lomieee.IntendedenduserroleType
     */
    public static es.pode.parseadorXML.castor.lomieee.IntendedenduserroleType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.IntendedenduserroleType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.IntendedenduserroleType.class, reader);
    } //-- es.pode.parseadorXML.castor.lomieee.IntendedenduserroleType unmarshal(java.io.Reader) 
