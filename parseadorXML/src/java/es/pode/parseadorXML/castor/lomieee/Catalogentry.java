 ...
 */
public class Catalogentry extends CatalogentryType 
implements java.io.Serializable
{
    ...
    public Catalogentry() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Catalogentry()
    ...
    public static es.pode.parseadorXML.castor.lomieee.CatalogentryType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.CatalogentryType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Catalogentry.class, reader);
