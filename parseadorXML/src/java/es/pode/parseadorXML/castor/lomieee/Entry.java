...
implements java.io.Serializable
{
    ...
    public Entry() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Entry()
    ...
    public static es.pode.parseadorXML.castor.lomieee.EntryType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.EntryType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Entry.class, reader);
