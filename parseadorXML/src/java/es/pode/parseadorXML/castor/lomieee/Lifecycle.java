 ...
 */
public class Lifecycle extends LifecycleType 
implements java.io.Serializable
{
    ...
    public Lifecycle() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Lifecycle()
    ...
    public static es.pode.parseadorXML.castor.lomieee.LifecycleType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.LifecycleType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Lifecycle.class, reader);
