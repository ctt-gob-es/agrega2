 ...
 */
public class Rights extends RightsType 
implements java.io.Serializable
{
    ...
    public Rights() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Rights()
    ...
    public static es.pode.parseadorXML.castor.lomieee.RightsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.RightsType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Rights.class, reader);
