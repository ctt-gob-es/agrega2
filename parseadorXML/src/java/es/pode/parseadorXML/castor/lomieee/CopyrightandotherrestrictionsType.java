...
/**
 * Class CopyrightandotherrestrictionsType.
 * 
 * @version $Revision$ $Date$
 */
public class CopyrightandotherrestrictionsType implements java.io.Serializable {
    ...
    public static es.pode.parseadorXML.castor.lomieee.CopyrightandotherrestrictionsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.CopyrightandotherrestrictionsType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.CopyrightandotherrestrictionsType.class, reader);
