 ...
 */
public class Classification extends ClassificationType 
implements java.io.Serializable
{
    ...
    public Classification() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Classification()
    ...
    public static es.pode.parseadorXML.castor.lomieee.ClassificationType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.ClassificationType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Classification.class, reader);
