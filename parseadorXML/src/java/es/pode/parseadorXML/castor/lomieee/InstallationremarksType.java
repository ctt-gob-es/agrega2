...
/**
 * Class InstallationremarksType.
 * 
 * @version $Revision$ $Date$
 */
public class InstallationremarksType implements java.io.Serializable {
    ...
    public InstallationremarksType() 
     {
        super();
        this._langstringList = new java.util.Vector();
    } //-- es.pode.parseadorXML.castor.lomieee.InstallationremarksType()
     ...
     * es.pode.parseadorXML.castor.lomieee.InstallationremarksType
     */
    public static es.pode.parseadorXML.castor.lomieee.InstallationremarksType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.InstallationremarksType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.InstallationremarksType.class, reader);
    } //-- es.pode.parseadorXML.castor.lomieee.InstallationremarksType unmarshal(java.io.Reader) 
