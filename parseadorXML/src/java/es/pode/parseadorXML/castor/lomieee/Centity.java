 ...
 */
public class Centity extends CentityType 
implements java.io.Serializable
{
    ...
    public Centity() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Centity()
    ...
    public static es.pode.parseadorXML.castor.lomieee.CentityType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.CentityType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Centity.class, reader);
