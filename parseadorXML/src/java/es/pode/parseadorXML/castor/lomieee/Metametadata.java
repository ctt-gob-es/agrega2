 ...
 */
public class Metametadata extends MetametadataType 
implements java.io.Serializable
{
    ...
    public Metametadata() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Metametadata()
    ...
    public static es.pode.parseadorXML.castor.lomieee.MetametadataType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.MetametadataType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Metametadata.class, reader);
