...
/**
 * Class KeywordTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class KeywordTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public KeywordTypeDescriptor() 
     {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                KeywordType target = (KeywordType) object;
    ...
    } //-- es.pode.parseadorXML.castor.lomieee.KeywordTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.KeywordType.class;
