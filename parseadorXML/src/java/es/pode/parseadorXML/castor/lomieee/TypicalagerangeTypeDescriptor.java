...
/**
 * Class TypicalagerangeTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TypicalagerangeTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TypicalagerangeTypeDescriptor() 
     {
        super();
        nsURI = "http://www.imsglobal.org/xsd/imsmd_rootv1p2p1";
        xmlName = "typicalagerangeType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TypicalagerangeType target = (TypicalagerangeType) object;
    ...
    } //-- es.pode.parseadorXML.castor.lomieee.TypicalagerangeTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.TypicalagerangeType.class;
