...
/**
 * Class AggregationlevelType.
 * 
 * @version $Revision$ $Date$
 */
public class AggregationlevelType implements java.io.Serializable {
    ...
    public static es.pode.parseadorXML.castor.lomieee.AggregationlevelType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.AggregationlevelType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.AggregationlevelType.class, reader);
