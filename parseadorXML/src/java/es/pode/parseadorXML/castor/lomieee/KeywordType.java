 ...
 */
public class KeywordType implements java.io.Serializable {
    ...
    public static es.pode.parseadorXML.castor.lomieee.KeywordType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.KeywordType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.KeywordType.class, reader);
