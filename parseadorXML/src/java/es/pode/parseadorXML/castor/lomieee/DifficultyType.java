 ...
 */
public class DifficultyType implements java.io.Serializable {
    ...
    public static es.pode.parseadorXML.castor.lomieee.DifficultyType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.DifficultyType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.DifficultyType.class, reader);
