...
implements java.io.Serializable
{
    ...
    public Status() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Status()
    ...
    public static es.pode.parseadorXML.castor.lomieee.StatusType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.StatusType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Status.class, reader);
