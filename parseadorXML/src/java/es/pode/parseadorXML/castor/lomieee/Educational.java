 ...
 */
public class Educational extends EducationalType 
implements java.io.Serializable
{
    ...
    public Educational() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Educational()
    ...
    public static es.pode.parseadorXML.castor.lomieee.EducationalType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.EducationalType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Educational.class, reader);
