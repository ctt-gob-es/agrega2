...
/**
 * Class VersionTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class VersionTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public VersionTypeDescriptor() 
     {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                VersionType target = (VersionType) object;
    ...
    } //-- es.pode.parseadorXML.castor.lomieee.VersionTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.VersionType.class;
