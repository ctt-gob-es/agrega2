 ...
 */
public class Contribute extends ContributeType 
implements java.io.Serializable
{
    ...
    public Contribute() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Contribute()
    ...
    public static es.pode.parseadorXML.castor.lomieee.ContributeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.ContributeType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Contribute.class, reader);
