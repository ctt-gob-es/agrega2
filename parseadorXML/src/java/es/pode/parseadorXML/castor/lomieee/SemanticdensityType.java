...
/**
 * Class SemanticdensityType.
 * 
 * @version $Revision$ $Date$
 */
public class SemanticdensityType implements java.io.Serializable {
    ...
    public static es.pode.parseadorXML.castor.lomieee.SemanticdensityType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.SemanticdensityType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.SemanticdensityType.class, reader);
