...
/**
 * Class TypicalagerangeType.
 * 
 * @version $Revision$ $Date$
 */
public class TypicalagerangeType implements java.io.Serializable {
    ...
    public TypicalagerangeType() 
     {
        super();
        this._langstringList = new java.util.Vector();
    } //-- es.pode.parseadorXML.castor.lomieee.TypicalagerangeType()
     ...
     * es.pode.parseadorXML.castor.lomieee.TypicalagerangeType
     */
    public static es.pode.parseadorXML.castor.lomieee.TypicalagerangeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.TypicalagerangeType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.TypicalagerangeType.class, reader);
    } //-- es.pode.parseadorXML.castor.lomieee.TypicalagerangeType unmarshal(java.io.Reader) 
