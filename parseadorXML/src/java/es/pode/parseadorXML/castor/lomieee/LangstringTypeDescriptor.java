...
/**
 * Class LangstringTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class LangstringTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LangstringTypeDescriptor() 
     {
        super();
        nsURI = "http://www.imsglobal.org/xsd/imsmd_rootv1p2p1";
        xmlName = "langstringType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                LangstringType target = (LangstringType) object;
    ...
    } //-- es.pode.parseadorXML.castor.lomieee.LangstringTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.LangstringType.class;
