 ...
 */
public class Relation extends RelationType 
implements java.io.Serializable
{
    ...
    public Relation() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Relation()
    ...
    public static es.pode.parseadorXML.castor.lomieee.RelationType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.RelationType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Relation.class, reader);
