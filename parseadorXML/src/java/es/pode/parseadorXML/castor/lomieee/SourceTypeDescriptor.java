...
public class SourceTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SourceTypeDescriptor() 
     {
        ...
        //-- _langstring
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(es.pode.parseadorXML.castor.lomieee.Langstring.class, "_langstring", "langstring", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SourceType target = (SourceType) object;
                    target.setLangstring( (es.pode.parseadorXML.castor.lomieee.Langstring) value);
                }
        ...
        //-- validation code for: _langstring
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- es.pode.parseadorXML.castor.lomieee.SourceTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.SourceType.class;
