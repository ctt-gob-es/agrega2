 ...
 */
public class Requirement extends RequirementType 
implements java.io.Serializable
{
    ...
    public Requirement() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Requirement()
    ...
    public static es.pode.parseadorXML.castor.lomieee.RequirementType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.RequirementType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Requirement.class, reader);
