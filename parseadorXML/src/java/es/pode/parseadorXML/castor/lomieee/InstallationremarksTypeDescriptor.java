...
/**
 * Class InstallationremarksTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class InstallationremarksTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public InstallationremarksTypeDescriptor() 
     {
        super();
        nsURI = "http://www.imsglobal.org/xsd/imsmd_rootv1p2p1";
        xmlName = "installationremarksType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                InstallationremarksType target = (InstallationremarksType) object;
    ...
    } //-- es.pode.parseadorXML.castor.lomieee.InstallationremarksTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.InstallationremarksType.class;
