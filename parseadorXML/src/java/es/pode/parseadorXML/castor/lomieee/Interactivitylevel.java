 ...
 */
public class Interactivitylevel extends InteractivitylevelType 
implements java.io.Serializable
{
    ...
    public Interactivitylevel() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Interactivitylevel()
    ...
    public static es.pode.parseadorXML.castor.lomieee.InteractivitylevelType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.InteractivitylevelType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Interactivitylevel.class, reader);
