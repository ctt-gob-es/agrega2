...
/**
 * Class EntryTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class EntryTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EntryTypeDescriptor() 
     {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                EntryType target = (EntryType) object;
    ...
    } //-- es.pode.parseadorXML.castor.lomieee.EntryTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.EntryType.class;
