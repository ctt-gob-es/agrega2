...
/**
 * Class LearningresourcetypeType.
 * 
 * @version $Revision$ $Date$
 */
public class LearningresourcetypeType implements java.io.Serializable {
    ...
    public LearningresourcetypeType() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.LearningresourcetypeType()
     ...
     * es.pode.parseadorXML.castor.lomieee.LearningresourcetypeType
     */
    public static es.pode.parseadorXML.castor.lomieee.LearningresourcetypeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.LearningresourcetypeType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.LearningresourcetypeType.class, reader);
    } //-- es.pode.parseadorXML.castor.lomieee.LearningresourcetypeType unmarshal(java.io.Reader) 
