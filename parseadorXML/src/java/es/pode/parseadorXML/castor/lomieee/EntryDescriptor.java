 ...
 */
public class EntryDescriptor extends EntryTypeDescriptor {
    ...
    } //-- es.pode.parseadorXML.castor.lomieee.EntryDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.Entry.class;
