 ...
 */
public class Annotation extends AnnotationType 
implements java.io.Serializable
{
    ...
    public Annotation() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Annotation()
    ...
    public static es.pode.parseadorXML.castor.lomieee.AnnotationType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.AnnotationType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Annotation.class, reader);
