 ...
 */
public class Taxon extends TaxonType 
implements java.io.Serializable
{
    ...
    public Taxon() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Taxon()
    ...
    public static es.pode.parseadorXML.castor.lomieee.TaxonType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.TaxonType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Taxon.class, reader);
