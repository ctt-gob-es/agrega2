 ...
 */
public class Lom extends LomType 
implements java.io.Serializable
{
    ...
    public Lom() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Lom()
    ...
    public static es.pode.parseadorXML.castor.lomieee.LomType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.LomType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Lom.class, reader);
