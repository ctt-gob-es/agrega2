 ...
 */
public class Technical extends TechnicalType 
implements java.io.Serializable
{
    ...
    public Technical() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Technical()
    ...
    public static es.pode.parseadorXML.castor.lomieee.TechnicalType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.TechnicalType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Technical.class, reader);
