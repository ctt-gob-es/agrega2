 ...
 */
public class General extends GeneralType 
implements java.io.Serializable
{
    ...
    public General() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.General()
    ...
    public static es.pode.parseadorXML.castor.lomieee.GeneralType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.GeneralType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.General.class, reader);
