...
/**
 * Class OtherplatformrequirementsTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class OtherplatformrequirementsTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OtherplatformrequirementsTypeDescriptor() 
     {
        super();
        nsURI = "http://www.imsglobal.org/xsd/imsmd_rootv1p2p1";
        xmlName = "otherplatformrequirementsType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                OtherplatformrequirementsType target = (OtherplatformrequirementsType) object;
    ...
    } //-- es.pode.parseadorXML.castor.lomieee.OtherplatformrequirementsTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.OtherplatformrequirementsType.class;
