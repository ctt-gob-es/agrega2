 ...
 */
public class Taxonpath extends TaxonpathType 
implements java.io.Serializable
{
    ...
    public Taxonpath() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Taxonpath()
    ...
    public static es.pode.parseadorXML.castor.lomieee.TaxonpathType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.TaxonpathType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Taxonpath.class, reader);
