...
/**
 * Class DurationTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class DurationTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DurationTypeDescriptor() 
     {
        super();
        nsURI = "http://www.imsglobal.org/xsd/imsmd_rootv1p2p1";
        xmlName = "durationType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DurationType target = (DurationType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- es.pode.parseadorXML.castor.lomieee.DurationTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.DurationType.class;
