...
/**
 * Class AnnotationTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class AnnotationTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AnnotationTypeDescriptor() 
     {
        super();
        nsURI = "http://www.imsglobal.org/xsd/imsmd_rootv1p2p1";
        xmlName = "annotationType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                AnnotationType target = (AnnotationType) object;
        ...
        //-- _person
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(es.pode.parseadorXML.castor.lomieee.Person.class, "_person", "person", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    AnnotationType target = (AnnotationType) object;
                    target.setPerson( (es.pode.parseadorXML.castor.lomieee.Person) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new es.pode.parseadorXML.castor.lomieee.Person();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- es.pode.parseadorXML.castor.lomieee.AnnotationTypeDescriptor()
    ...
    {
        return es.pode.parseadorXML.castor.lomieee.AnnotationType.class;
