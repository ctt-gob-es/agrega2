...
/**
 * Class InteractivitytypeType.
 * 
 * @version $Revision$ $Date$
 */
public class InteractivitytypeType implements java.io.Serializable {
    ...
    public static es.pode.parseadorXML.castor.lomieee.InteractivitytypeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.InteractivitytypeType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.InteractivitytypeType.class, reader);
