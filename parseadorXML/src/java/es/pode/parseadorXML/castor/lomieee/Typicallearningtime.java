 ...
 */
public class Typicallearningtime extends TypicallearningtimeType 
implements java.io.Serializable
{
    ...
    public Typicallearningtime() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Typicallearningtime()
    ...
    public static es.pode.parseadorXML.castor.lomieee.TypicallearningtimeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.TypicallearningtimeType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Typicallearningtime.class, reader);
