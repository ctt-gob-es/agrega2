...
implements java.io.Serializable
{
    ...
    public Value() 
     {
        super();
    } //-- es.pode.parseadorXML.castor.lomieee.Value()
    ...
    public static es.pode.parseadorXML.castor.lomieee.ValueType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (es.pode.parseadorXML.castor.lomieee.ValueType) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.lomieee.Value.class, reader);
