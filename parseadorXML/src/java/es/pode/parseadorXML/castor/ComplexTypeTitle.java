...
/**
 * Class ComplexTypeTitle.
 * 
 * @version $Revision$ $Date$
 */
public class ComplexTypeTitle extends es.pode.parseadorXML.castor.LanguageString 
implements java.io.Serializable
{
     ...
     */
    private java.lang.String _uniqueElementName = "title";
    ...
    public ComplexTypeTitle() {
        super();
        setUniqueElementName("title");
    }
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (es.pode.parseadorXML.castor.LanguageString) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.ComplexTypeTitle.class, reader);
    }
