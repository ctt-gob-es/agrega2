...
/**
 * Class ComplexTypeStatus.
 * 
 * @version $Revision$ $Date$
 */
public class ComplexTypeStatus extends es.pode.parseadorXML.castor.StatusVocab 
implements java.io.Serializable
{
     ...
     */
    private java.lang.String _uniqueElementName = "status";
    ...
    public ComplexTypeStatus() {
        super();
        setUniqueElementName("status");
    }
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (es.pode.parseadorXML.castor.StatusVocab) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.ComplexTypeStatus.class, reader);
    }
