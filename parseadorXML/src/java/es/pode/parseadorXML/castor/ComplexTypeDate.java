...
/**
 * Class ComplexTypeDate.
 * 
 * @version $Revision$ $Date$
 */
public class ComplexTypeDate extends es.pode.parseadorXML.castor.ComplexTypeDateTime 
implements java.io.Serializable
{
     ...
     */
    private java.lang.String _uniqueElementName = "date";
    ...
    public ComplexTypeDate() {
        super();
        setUniqueElementName("date");
    }
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (es.pode.parseadorXML.castor.ComplexTypeDateTime) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.ComplexTypeDate.class, reader);
    }
