...
/**
 * Class ComplexTypeDifficulty.
 * 
 * @version $Revision$ $Date$
 */
public class ComplexTypeDifficulty extends es.pode.parseadorXML.castor.DifficultyVocab 
implements java.io.Serializable
{
     ...
     */
    private java.lang.String _uniqueElementName = "difficulty";
    ...
    public ComplexTypeDifficulty() {
        super();
        setUniqueElementName("difficulty");
    }
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (es.pode.parseadorXML.castor.DifficultyVocab) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.ComplexTypeDifficulty.class, reader);
    }
