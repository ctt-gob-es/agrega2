...
/**
 * Class ComplexTypeAccessType.
 * 
 * @version $Revision$ $Date$
 */
public class ComplexTypeAccessType extends es.pode.parseadorXML.castor.AccessTypeVocab 
implements java.io.Serializable
{
     ...
     */
    private java.lang.String _uniqueElementName = "accessType";
    ...
    public ComplexTypeAccessType() {
        super();
        setUniqueElementName("accessType");
    }
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (es.pode.parseadorXML.castor.AccessTypeVocab) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.ComplexTypeAccessType.class, reader);
    }
