...
/**
 * Any namespaced element from any namespace may be included within
 * an "any" element. The namespace for the imported element must be
...
public class Grp_any implements java.io.Serializable {
     ...
     * es.pode.parseadorXML.castor.Grp_any
     */
    public static es.pode.parseadorXML.castor.Grp_any unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (es.pode.parseadorXML.castor.Grp_any) Unmarshaller.unmarshal(es.pode.parseadorXML.castor.Grp_any.class, reader);
    }
