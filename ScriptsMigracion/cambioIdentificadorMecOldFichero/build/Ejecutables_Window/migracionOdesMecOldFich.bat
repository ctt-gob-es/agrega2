...
goto start
:hello
  cd cambioIdentificadorMecOldFichero
  java -Darchivo=D:/localRepo/MigracionTaxones/migracionMecOldFormatFich/migracionOdesMecOldFich.txt -jar cambioIdentificadorMecOldFichero-1.0.jar
  cd ..
goto end
:bye  
  echo.
