...
read opcion
if [ "$opcion" = "y" ];then
#Preguntamos al usuario si desea que se sobrescriban las licencias 
repetir=true
while [ $repetir = "true" ]
do
echo -e "¿Desea sobrescribir las licencias de los odes? [y]es, [n]o: \c"
read opcion
if [ "$opcion" = "y" ];then
sobrescribir="y"
repetir=false
...
java -Drepositorio=$urlRepositorio -Dsobrescribir=$sobrescribir -jar migracionLicencias-1.0.jar
cd ..
