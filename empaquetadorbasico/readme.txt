	...
	Project Name:               Servicio de Empaquetador Basico
	Project Id:                 empaquetadorbasico
	Project version:            1
	Base Project Package:       es.pode.empaquetador.negocio
    ...
    /Servicio de Empaquetador Basico J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\The I-Builder Team\.maven\repository\empaquetadorbasico\

        (*nix)
        /home/The I-Builder Team/.maven/repository/empaquetadorbasico/
