 ...
 */
public class SrvFachadaAgregarServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvFachadaAgregarServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.empaquetador.negocio.servicio.SrvFachadaAgregarService
    */
    
    protected es.pode.empaquetador.negocio.servicio.SrvFachadaAgregarService servicio;
	public void setServicio(es.pode.empaquetador.negocio.servicio.SrvFachadaAgregarService servicio) {
    ...
    protected String[] getConfigLocations() {
        return new String[] { "testContext.xml", "user-applicationContext.xml" , "applicationContext-external.xml"};
    }
