...
//		OdeVO manifestConSubm = servicio.editarODE(identificador4);
	...
	public void testguardarManifiesto() {
		...
		servicio.guardarManifiesto(identificador_manifest, false);
...

	{
		...
		Boolean prueba_Choice = true;
		Boolean prueba_choiceExit = true;
		Boolean prueba_flow = true;
		Boolean prueba_forwardOnly = true;
