 ...
 */
public class SrvEmpaquetadorBasicoServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvEmpaquetadorBasicoServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.empaquetador.negocio.servicio.SrvEmpaquetadorBasicoService
    */
    
    protected es.pode.empaquetador.negocio.servicio.SrvEmpaquetadorBasicoService servicio;
	public void setServicio(es.pode.empaquetador.negocio.servicio.SrvEmpaquetadorBasicoService servicio) {
    ...
    protected String[] getConfigLocations() {
        return new String[] { "testContext.xml","applicationContext-external_empaquetadorbasico.xml","user-applicationContext_empaquetadorbasico.xml" };
    }
