 ...
 */
public class SrvGestorManifestServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvGestorManifestServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.empaquetador.negocio.servicio.SrvGestorManifestService
    */
    
    protected es.pode.empaquetador.negocio.servicio.SrvGestorManifestService servicio;
	public void setServicio(es.pode.empaquetador.negocio.servicio.SrvGestorManifestService servicio) {
