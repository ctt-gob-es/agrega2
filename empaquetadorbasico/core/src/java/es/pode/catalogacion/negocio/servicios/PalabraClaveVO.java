...
public class PalabraClaveVO  implements java.io.Serializable {
    ...
    /**
     * Gets the textos value for this PalabraClaveVO.
     * 
     * @return textos
     */
    ...
    /**
     * Sets the textos value for this PalabraClaveVO.
     * 
     * @param textos
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "PalabraClaveVO"));
