	...
	Project Name:               Publicacion
	Project Id:                 publicacion
	Project version:            1
	Base Project Package:       es.pode.publicacion.negocio
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\crmunoz\.maven\repository\publicacion\

        (*nix)
        /home/crmunoz/.maven/repository/publicacion/
