...
public class SrvIndexadorServiceSoapBindingStub extends org.apache.axis.client.Stub implements es.pode.indexador.negocio.servicios.indexado.SrvIndexadorService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenerOdesConUsuarioEnContribucion");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "idUsuario"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "ArrayOfxsd_string"));
        oper.setReturnClass(java.lang.String[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "obtenerOdesConUsuarioEnContribucionReturn"));
        param = oper.getReturnParamDesc();
        param.setItemQName(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "item"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {odes});
  ...
  throw axisFaultException;
    ...
    public java.lang.String[] obtenerOdesConUsuarioEnContribucion(java.lang.String idUsuario) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("obtenerOdesConUsuarioEnContribucion");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "obtenerOdesConUsuarioEnContribucion"));
