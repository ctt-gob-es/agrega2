...
public class ItemVO  implements java.io.Serializable {
    ...
    /**
     * Gets the visible value for this ItemVO.
     * 
     * @return visible
     */
    ...
    /**
     * Sets the visible value for this ItemVO.
     * 
     * @param visible
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.negocio.entregar.pode.es", "visible"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
