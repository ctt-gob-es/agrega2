...
public class SrvAuditoriaServicioServiceLocator extends org.apache.axis.client.Service implements es.pode.auditoria.negocio.servicios.SrvAuditoriaServicioService {
 ...
 */
    ...
    public es.pode.auditoria.negocio.servicios.SrvAuditoriaServicio getSrvAuditoriaServicio() throws javax.xml.rpc.ServiceException {
    ...
    public es.pode.auditoria.negocio.servicios.SrvAuditoriaServicio getSrvAuditoriaServicio(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.pode.auditoria.negocio.servicios.SrvAuditoriaServicioSoapBindingStub _stub = new es.pode.auditoria.negocio.servicios.SrvAuditoriaServicioSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.pode.auditoria.negocio.servicios.SrvAuditoriaServicio.class.isAssignableFrom(serviceEndpointInterface)) {
                es.pode.auditoria.negocio.servicios.SrvAuditoriaServicioSoapBindingStub _stub = new es.pode.auditoria.negocio.servicios.SrvAuditoriaServicioSoapBindingStub(new java.net.URL(SrvAuditoriaServicio_address), this);
                _stub.setPortName(getSrvAuditoriaServicioWSDDServiceName());
                return _stub;
            }
        }
