...
public class SrvCorreoSoapBindingStub extends org.apache.axis.client.Stub implements es.pode.gestorCorreo.negocio.servicios.SrvCorreo {
    ...
    private static void _initOperationDesc2(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "listaDestinatarios"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "listaEnCopia"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "tipoIncidencia"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "ResultadoEnvioCorreoVO"));
        oper.setReturnClass(es.pode.gestorCorreo.negocio.servicios.ResultadoEnvioCorreoVO.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "enviarCorreoIncidenciaReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[10] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("enviarCorreoTareaUnificacion");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "listaDestinatarios"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "listaNodosConError"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "tipoIncidencia"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "listaEnCopia"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "ResultadoEnvioCorreoVO"));
        oper.setReturnClass(es.pode.gestorCorreo.negocio.servicios.ResultadoEnvioCorreoVO.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "enviarCorreoTareaUnificacionReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[11] = oper;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {correoUsuarioVO});
  ...
  throw axisFaultException;
    ...
    public es.pode.gestorCorreo.negocio.servicios.ResultadoEnvioCorreoVO enviarCorreoIncidencia(java.lang.String listaDestinatarios, java.lang.String listaEnCopia, java.lang.String tipoIncidencia) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "enviarCorreoIncidencia"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {listaDestinatarios, listaEnCopia, tipoIncidencia});
  ...
  throw axisFaultException;
    ...
    public es.pode.gestorCorreo.negocio.servicios.ResultadoEnvioCorreoVO enviarCorreoTareaUnificacion(java.lang.String listaDestinatarios, java.lang.String listaNodosConError, java.lang.String tipoIncidencia, java.lang.String listaEnCopia) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("enviarCorreoTareaUnificacion");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicios.negocio.gestorCorreo.pode.es", "enviarCorreoTareaUnificacion"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {listaDestinatarios, listaNodosConError, tipoIncidencia, listaEnCopia});
