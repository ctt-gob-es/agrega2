 ...
 */
public class TestSrvSyncServiceImpl
    extends SrvSyncServiceImplBase
{
     ...
     * 	 {@link es.indra.servicios.SrvSyncServiceImplBase#initAthenticationUser(String, String) 
