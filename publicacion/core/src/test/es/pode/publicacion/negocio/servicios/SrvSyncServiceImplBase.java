 ...
 */
public class SrvSyncServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvSyncServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.publicacion.negocio.servicios.SrvSyncService
    */
    
    protected es.pode.publicacion.negocio.servicios.SrvSyncService servicio;
	public void setServicio(es.pode.publicacion.negocio.servicios.SrvSyncService servicio) {
