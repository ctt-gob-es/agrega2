 ...
 */
public class SrvAuditaPublicacionServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvAuditaPublicacionServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.publicacion.negocio.servicios.SrvAuditaPublicacionService
    */
    
    protected es.pode.publicacion.negocio.servicios.SrvAuditaPublicacionService servicio;
	public void setServicio(es.pode.publicacion.negocio.servicios.SrvAuditaPublicacionService servicio) {
