 ...
 */
public class SrvContenidoInapropiadoServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvContenidoInapropiadoServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.publicacion.negocio.servicios.SrvContenidoInapropiadoService
    */
    
    protected es.pode.publicacion.negocio.servicios.SrvContenidoInapropiadoService servicio;
	public void setServicio(es.pode.publicacion.negocio.servicios.SrvContenidoInapropiadoService servicio) {
