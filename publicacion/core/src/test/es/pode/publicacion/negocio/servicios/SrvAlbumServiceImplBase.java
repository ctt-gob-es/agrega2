 ...
 */
public class SrvAlbumServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvAlbumServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.publicacion.negocio.servicios.SrvAlbumService
    */
    
    protected es.pode.publicacion.negocio.servicios.SrvAlbumService servicio;
	public void setServicio(es.pode.publicacion.negocio.servicios.SrvAlbumService servicio) {
