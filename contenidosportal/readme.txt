    ...
    The project located in this directory has been generated by Javier Espino
    ...
    /Contenidos Portal J2EE project
         |
    ...
    list of examples:
        ...
        Los argumentos son: 
            ...
            - overwriteXMI = true por defecto (cuidado al ser un proyecto BPM ya que contiene un xmi generado)
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\Javier Espino\.maven\repository\contenidosportal\

        (*nix)
        /home/Javier Espino/.maven/repository/contenidosportal/
