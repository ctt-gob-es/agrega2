 ...
 */
public class SrvFaqServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvFaqServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.contenidos.negocio.faqs.servicio.SrvFaqService
    */
    
    protected es.pode.contenidos.negocio.faqs.servicio.SrvFaqService servicio;
	public void setServicio(es.pode.contenidos.negocio.faqs.servicio.SrvFaqService servicio) {
