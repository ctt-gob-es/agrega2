 ...
 */
public class SrvDescargasImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvDescargasImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.contenidos.negocio.descargas.servicio.SrvDescargas
    */
    
    protected es.pode.contenidos.negocio.descargas.servicio.SrvDescargas servicio;
	public void setServicio(es.pode.contenidos.negocio.descargas.servicio.SrvDescargas servicio) {
