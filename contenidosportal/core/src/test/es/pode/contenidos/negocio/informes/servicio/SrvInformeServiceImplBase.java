 ...
 */
public class SrvInformeServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvInformeServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.contenidos.negocio.informes.servicio.SrvInformeService
    */
    
    protected es.pode.contenidos.negocio.informes.servicio.SrvInformeService servicio;
	public void setServicio(es.pode.contenidos.negocio.informes.servicio.SrvInformeService servicio) {
