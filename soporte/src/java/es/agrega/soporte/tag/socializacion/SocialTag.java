...
public class SocialTag extends TagSupport {
	...
	private static Logger logger = Logger.getLogger(SocialTag.class); 
	...
	private String tieneIdentidadFederada = null;
...
//	private static ArrayList itemList = null;	
	...
	public String getTieneIdentidadFederada() {
		return tieneIdentidadFederada;
	}

	public void setTieneIdentidadFederada(String tieneIdentidadFederada) {
		this.tieneIdentidadFederada = tieneIdentidadFederada;
	}
	...
	public int doStartTag() throws JspException {
	      try {
	    	  ...
	    	  if (sRequest != null && sRequest instanceof HttpServletRequest)
	    	  {
	    		  ...
	    		  this.setUrl(URLEncoder.encode(this.getServerName(httpRequest.getScheme(), LdapUserDetailsUtils.getHost(), httpRequest.getServerPort())+this.getUrl(),"UTF-8"));
...
//	    	  //Se pinta el enlace para enviar un correo (subdominio + path)
  			  String pathCorreo = "/buscador2/EnviarMailCU/EnviarMailCU.do?identificadorODE=" + identificadorODE + "&amp;idioma=" + idioma + "&amp;tipoLayoutBuscador=" + buscadorEmpaquetador + "&amp;urlODE=" + urlEnviar + "&amp;titulo=" + titulo + "&amp;mostrarVuelta=" + mostrarVuelta +"&amp;urlImagen=" + urlImagen +"&amp;nodoOrigen=" + nodoOrigen +"&amp;tieneIdentidadFederada=" + tieneIdentidadFederada;
  			  String subdominio = AgregaPropertiesImpl.getInstance().getProperty(AgregaProperties.SUBDOMINIO);
  			  if(subdominio!=null && !"".equals(subdominio)) pathCorreo = subdominio + pathCorreo;
  	   	  out.println("<li class=\"enviar_objeto\"><a href=\""+ pathCorreo + "\" title=\""+ literalEnviar +"\"><span>" + literalEnviar + "</span></a></li>");
  	   	  out.println("<li class=\"addthis\"><a class=\"addthis_button\"><span>AddThis</span></a></li>");
//	    	  out.println("<li class=\"addthis\"><a href=\"http://www.addthis.com/bookmark.php?v=20\" title=\"AddThis\" target=\"_blank\"><span>AddThis</span></a></li>");
