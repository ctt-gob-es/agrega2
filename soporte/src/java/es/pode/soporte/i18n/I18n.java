...
public class I18n {
	...
	/**
	 * @param idioma String idioma a localizar
...
//		Comprobamos que existe el fichero de bundle del idioma al que se quiere traducir.
		ResourceBundle fichero = getBundleFile(idioma);
		if (idioma == null) {
			logger.error("ERROR: idioma no encontrado: [null]");
			throw new Exception("Excepcion: obtenerIdiomasBuscablesLocalizados: Idioma[null] sin fichero de localizacion registrado.");
		}
...
//		String[] listaIdiomasBuscables = (idiomas!= null)?idiomas.split(","):null;
		String[] listaIdiomasBuscables =idiomas.split(",");
...
//		Comprobamos que existe el fichero de bundle del idioma al que se quiere traducir.
		...
		if (idioma == null) {
			logger.error("ERROR: idioma no encontrado: [null]");
			throw new Exception("Excepcion: obtenerIdiomasPlataformaLocalizados: Idioma[null] sin fichero de localizacion registrado.");
		}
...
//		String[] listaIdiomasPlataforma = (idiomas!= null)?idiomas.split(","):null;
		String[] listaIdiomasPlataforma = idiomas.split(",");
//		Para cada idioma voy buscando en el fichero de bundle su correspondiente traduccion y genero el vo
...
//		Obtenemos el idioma secundario de la plataforma
	...
	/**
	 * @param idiomaNavegacion String idioma a identificar
...
//		devuelvo si el idioma de navegacion del tipo esta entre los que reconozco
		return (setIdiomasSoportados.contains(idiomaNavegacion)); 
	}
	
	/**
	 * @param idiomaTraducir String  Idioma que se va a traducir
	 * @param idiomaTraduccion String  Idioma al que se quiere traducir.
...
//		Obtengo la lista de idiomas de los que tengo traduccion
		...
		String[] arrayIdiomasPlataforma = (idiomasTraducibles!= null)?idiomasTraducibles.split(","):new String[]{""};
...
//		Comprobamos que existe el fichero de bundle del idioma al que se quiere traducir.
	...
	/**
	 * @param idiomaTraducir String[]  Idiomas que se van a traducir
	 * @param idiomaTraduccion String  Idioma al que se quiere traducir.
...
//		Comprobamos que existe el fichero de bundle del idioma al que se quiere traducir.
	 ...
	 * @return Stirng[] Devuelve la lista de los idiomas para los que la plataforma esta traducida.
	 */
	public String[] obtenerIdiomasEstructurasEducativas() throws Exception {
//		Obtenemos la lista de los idiomas del fichero de properties del propio i18n
		String idiomas = getPropertyValue(ConstantesAgrega.LISTA_IDIOMAS_ESTRUCTURAS_EDUCATIVAS);
		if (idiomas != null && idiomas.length() > 0)
			return idiomas.split(",");
		return null;
	}
