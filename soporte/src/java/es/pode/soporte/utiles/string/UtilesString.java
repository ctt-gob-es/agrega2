...
public class UtilesString {
	...
	public static String translateUnicodeSpecialCharacters (String s) {
		...
		//Examinamos si existen la tilde combinada de la Ò (combining tilde)
