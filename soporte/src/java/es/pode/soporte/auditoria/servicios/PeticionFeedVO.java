...
public class PeticionFeedVO  implements java.io.Serializable {
    ...
    /* Formato del Feed al que se ha realizado la peticion. */
    private java.lang.String formatoFeed;

    /* Periodo del Feed (solo se aplica a algunos canales). */
     ...
     * 
     * @return formatoFeed   * Formato del Feed al que se ha realizado la peticion.
     */
     ...
     * 
     * @param formatoFeed   * Formato del Feed al que se ha realizado la peticion.
     */
     ...
     * 
     * @return periodo   * Periodo del Feed (solo se aplica a algunos canales).
     */
     ...
     * 
     * @param periodo   * Periodo del Feed (solo se aplica a algunos canales).
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "PeticionFeedVO"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("idFeed");
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "idFeed"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("formatoFeed");
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "formatoFeed"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("periodo");
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "periodo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
