...
public class ParametroInformeGenericoVO  implements java.io.Serializable {
    ...
    private es.pode.soporte.auditoria.servicios.ParametroVO[] parametros;
    ...
    public ParametroInformeGenericoVO(
           ...
           es.pode.soporte.auditoria.servicios.ParametroVO[] parametros,
     ...
     */
    public es.pode.soporte.auditoria.servicios.ParametroVO[] getParametros() {
        return parametros;
    }
     ...
     */
    public void setParametros(es.pode.soporte.auditoria.servicios.ParametroVO[] parametros) {
        this.parametros = parametros;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "ParametroInformeGenericoVO"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "pathDestinoInforme"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("parametros");
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "parametros"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "ParametroVO"));
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "nombreFicheroInforme"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
