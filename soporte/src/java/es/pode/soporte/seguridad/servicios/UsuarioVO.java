...
public class UsuarioVO  implements java.io.Serializable {
    ...
    private es.pode.soporte.seguridad.servicios.UsuarioPublicoVO usuarioPublico;
    ...
    public UsuarioVO(
           ...
           java.lang.String tipoVisualizador,
           ...
           es.pode.soporte.seguridad.servicios.UsuarioPublicoVO usuarioPublico) {
           this.id = id;
           this.nombre = nombre;
    ...
    /**
     * Gets the tipoVisualizador value for this UsuarioVO.
     * 
    ...
    /**
     * Sets the tipoVisualizador value for this UsuarioVO.
     * 
     * @param tipoVisualizador
     */
    ...
    /**
     * Gets the recibirCorreoPublicacion value for this UsuarioVO.
     * 
    ...
    /**
     * Sets the recibirCorreoPublicacion value for this UsuarioVO.
     * 
     * @param recibirCorreoPublicacion
     */
    public void setRecibirCorreoPublicacion(java.lang.Boolean recibirCorreoPublicacion) {
        this.recibirCorreoPublicacion = recibirCorreoPublicacion;
    }
    ...
    /**
     * Gets the usuarioPublico value for this UsuarioVO.
     * 
     * @return usuarioPublico
     */
    public es.pode.soporte.seguridad.servicios.UsuarioPublicoVO getUsuarioPublico() {
        return usuarioPublico;
    }


    /**
     * Sets the usuarioPublico value for this UsuarioVO.
     * 
     * @param usuarioPublico
     */
    public void setUsuarioPublico(es.pode.soporte.seguridad.servicios.UsuarioPublicoVO usuarioPublico) {
        this.usuarioPublico = usuarioPublico;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.tipoVisualizador==null && other.getTipoVisualizador()==null) || 
             (this.tipoVisualizador!=null &&
              this.tipoVisualizador.equals(other.getTipoVisualizador()))) &&
            ((this.recibirCorreoPublicacion==null && other.getRecibirCorreoPublicacion()==null) || 
             (this.recibirCorreoPublicacion!=null &&
              this.recibirCorreoPublicacion.equals(other.getRecibirCorreoPublicacion()))) &&
            ...
            ((this.usuarioPublico==null && other.getUsuarioPublico()==null) || 
             (this.usuarioPublico!=null &&
              this.usuarioPublico.equals(other.getUsuarioPublico())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getTipoVisualizador() != null) {
            _hashCode += getTipoVisualizador().hashCode();
        }
        if (getRecibirCorreoPublicacion() != null) {
            _hashCode += getRecibirCorreoPublicacion().hashCode();
        }
        if (getGrupos() != null) {
            for (int i=0;
        ...
        if (getUsuarioPublico() != null) {
            _hashCode += getUsuarioPublico().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("tipoVisualizador");
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.negocio.adminusuarios.pode.es", "tipoVisualizador"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("recibirCorreoPublicacion");
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.negocio.adminusuarios.pode.es", "recibirCorreoPublicacion"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("usuarioPublico");
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.negocio.adminusuarios.pode.es", "usuarioPublico"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://servicios.negocio.adminusuarios.pode.es", "UsuarioPublicoVO"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
