...
public class SrvConfigPortalServiceLocator extends org.apache.axis.client.Service implements es.pode.soporte.configuracionPortal.servicio.SrvConfigPortalService {
...
//    private java.lang.String SrvConfigPortal_address = "http://localhost:8080/contenidosportal-F1/services/SrvConfigPortal";
    private java.lang.String SrvConfigPortal_address = "http://localhost:8080"+LdapUserDetailsUtils.getSubdominioServices()+"/contenidosportal-F1/services/SrvConfigPortal";
    ...
    public es.pode.soporte.configuracionPortal.servicio.SrvConfigPortal getSrvConfigPortal() throws javax.xml.rpc.ServiceException {
    ...
    public es.pode.soporte.configuracionPortal.servicio.SrvConfigPortal getSrvConfigPortal(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	es.pode.soporte.configuracionPortal.servicio.SrvConfigPortalSoapBindingStub _stub = new es.pode.soporte.configuracionPortal.servicio.SrvConfigPortalSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.pode.soporte.configuracionPortal.servicio.SrvConfigPortal.class.isAssignableFrom(serviceEndpointInterface)) {
            	es.pode.soporte.configuracionPortal.servicio.SrvConfigPortalSoapBindingStub _stub = new es.pode.soporte.configuracionPortal.servicio.SrvConfigPortalSoapBindingStub(new java.net.URL(SrvConfigPortal_address), this);
                _stub.setPortName(getSrvConfigPortalWSDDServiceName());
                return _stub;
            }
        }
