...
public class SrvCatalogacionBasicaServiceSoapBindingStub extends org.apache.axis.client.Stub implements es.pode.catalogacion.negocio.servicios.SrvCatalogacionBasicaService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("eliminarTaxonomiasEnLomBasico");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "lomBasico"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "LomBasicoVO"), es.pode.catalogacion.negocio.servicios.LomBasicoVO.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "idArbol"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "ArrayOfxsd_string"), java.lang.String[].class, false, false);
        param.setItemQName(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "item"));
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "LomBasicoVO"));
        oper.setReturnClass(es.pode.catalogacion.negocio.servicios.LomBasicoVO.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "eliminarTaxonomiasEnLomBasicoReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[5] = oper;
    ...
    private static void _initOperationDesc2(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "lom"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "LomBasicoVO"), es.pode.catalogacion.negocio.servicios.LomBasicoVO.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "LomBasicoVO"));
        oper.setReturnClass(es.pode.catalogacion.negocio.servicios.LomBasicoVO.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "traducirLomesReturn"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[11] = oper;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {identificador, nomTaxonomia, new java.lang.Integer(idArbol)});
  ...
  throw axisFaultException;
    ...
    public es.pode.catalogacion.negocio.servicios.LomBasicoVO eliminarTaxonomiasEnLomBasico(es.pode.catalogacion.negocio.servicios.LomBasicoVO lomBasico, java.lang.String[] idArbol) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("eliminarTaxonomiasEnLomBasico");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "eliminarTaxonomiasEnLomBasico"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {identificador, usuario, lomBasico, idioma});
  ...
  throw axisFaultException;
    ...
    public es.pode.catalogacion.negocio.servicios.LomBasicoVO importarLomes(javax.activation.DataHandler ficheroLomes, java.lang.String idioma) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {ficheroLomes, idioma});
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {ids});
  ...
  throw axisFaultException;
    ...
    public es.pode.catalogacion.negocio.servicios.LomBasicoVO traducirLomes(java.lang.String identificador, java.lang.String usuario, java.lang.String idiomaTrad, es.pode.catalogacion.negocio.servicios.LomBasicoVO lom, java.lang.String idiomaOri, boolean soloCoincidentes) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("traducirLomes");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "traducirLomes"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {identificador, usuario, idiomaTrad, lom, idiomaOri, new java.lang.Boolean(soloCoincidentes)});
