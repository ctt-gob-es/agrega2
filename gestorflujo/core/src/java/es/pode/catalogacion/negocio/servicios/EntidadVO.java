...
public class EntidadVO  implements java.io.Serializable {
    ...
    /**
     * Gets the texto value for this EntidadVO.
     * 
     * @return texto
     */
    ...
    /**
     * Sets the texto value for this EntidadVO.
     * 
     * @param texto
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "EntidadVO"));
