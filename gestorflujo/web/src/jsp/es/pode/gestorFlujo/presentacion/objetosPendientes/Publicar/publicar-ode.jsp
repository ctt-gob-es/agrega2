...
<tiles:insert definition="layout-administrador">
	...
	<tiles:put name="body" type="string">
		...
		<form method="post" action ="<html:rewrite action="PublicarCU/PublicarODEAceptar"/>" >
		...
		<div class="fila_de_tabla">
  			<div class="text"><input readonly="readonly" name="Tipo" value="${form.identificadorLicencia}"  onblur="this.style.backgroundColor='#e1e1e1'" id="Tipo" type="text" title="<bean:message key="gestorFlujo.aplicar.tipo.licencia"/>"  />
