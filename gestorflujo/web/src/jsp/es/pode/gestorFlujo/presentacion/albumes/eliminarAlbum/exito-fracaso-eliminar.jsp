...
<tiles:insert definition="layout-gestor-flujo-con-style">
	...
	<tiles:put name="body" type="string">
		...
		<div class="plantilla_contenido"><!-- ## Para que los mensajes de error vayan bien en IE6 ## -->
			...
			<form method="post" action='<html:rewrite action="EliminarAlbumCU/ExitoFracasoEliminarAceptarExitoFracaso"/>'>
				...
				<!--		INICIO CAJA DE FORMULARIO		-->
					...
					<c:if test="${(form.exitoFracaso)==true}">
						<p><em class="correcto">  <bean:message key="gestorFlujo.album.eliminacionCorrecta"/></em></p>		
					</c:if> 
