...
<tiles:insert definition="layout-gestor-flujo-con-style">
	...
	<h2><bean:message key="gestorFlujo.mostrarOdes.despublicarAutonomos"/></h2>

		<form method="post"
			action="<html:rewrite action="/${initParam.url_publicadosAutonomos_rechazar_aceptar }" />">
			<!--  INICIO GLOBO GRIS   -->
		...
		<div class="text">
			<label for="Disclaimer" class="oculto" ><bean:message 	key="gestorFlujo.mostrarOdes.despublicarAutonomos" /></label> 
		...
		<form
			action="<html:rewrite action="${initParam.url_objetosPublicadosAutonomos }"/>"
