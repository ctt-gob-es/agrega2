...
<form action='<html:rewrite action="/${initParam.url_personales_eliminar_aceptar}?identificador=${form.identificador}&titulo=${form.titulo}"/>' method="post"  >
...
<form id="" action='<html:rewrite action="/${initParam.url_personales_eliminar_cancelar}"/>' method="post">
