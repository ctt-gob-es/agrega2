...
<tiles:insert definition="layout-gestor-flujo-con-style">
	...
	<tiles:put name="body" type="string">
		...
		<div class="plantilla_contenido"><!-- ## Para que los mensajes de error vayan bien en IE6 ## -->
			...
			<form method="post" action='<html:rewrite action="ModificarAlbumCU/ExitoFracasoModificarAceptarExitoFracaso"/>'>
							...
							<!--		INICIO CAJA DE FORMULARIO		-->
								<div id="formulario" class="ali_c">
									...
									<c:if test="${(form.exitoFracaso)==true}">
										<p><em class="correcto"> <bean:message key="gestorFlujo.album.modificacionCorrecta"/></em></p>		
									</c:if> 
									<c:if test="${(form.exitoFracaso)==false}">
										<p><em class="incorrecto"> ${(form.texto)}</em></p>
									</c:if>
									<br/>
								</div>
