...
<html:hidden name="form" property="retorno" />
...
<p class="parrafo_comun" id="separacion2"><bean:message key ="gestorFlujo.exportar.seleccione"/></p>
<!--  INICIO GLOBO GRIS   -->
<!--  INICIO GLOBO GRIS   -->
<div class="globo_gris" >
	<div class="globo_gris_01">
...
<!-- Inicio Botones  -->
	<fieldset class="tipo">
		<input class="boton_125_de_2"  type="submit" name="accion_bien" value="<bean:message key="gestorFlujo.exportar.descargar"/>" />
		<input class="boton_125_de_2_izq"  type="submit" name="accion_Cancelar" value="<bean:message key="gestorFlujo.exportar.volver"/>" />
	</fieldset>
</form>
