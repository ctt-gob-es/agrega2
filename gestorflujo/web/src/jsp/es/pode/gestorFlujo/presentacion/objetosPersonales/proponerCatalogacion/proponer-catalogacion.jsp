...
<tiles:insert definition="layout-gestor-flujo-con-style">
	...
	<tiles:put name="body" type="string">
		...
		<input type="hidden" name="solicitarNuevaVersion" value="${form.solicitarNuevaVersion}"/>
		<p class="parrafo_comun"><bean:message	key="gestorFlujo.legal1" /></p>
		<p class="parrafo_comun"><bean:message key="gestorFlujo.legal2" /></p>
		<p class="parrafo_comun"><bean:message key="gestorFlujo.legal3" /></p>
		<p class="parrafo_comun"><bean:message key="gestorFlujo.legal4" /></p>
		<p class="parrafo_comun"><bean:message key="gestorFlujo.legal5" /></p>
		<p class="parrafo_comun"><bean:message key="gestorFlujo.legal6" /></p>
		<p class="parrafo_comun"><bean:message	key="gestorFlujo.proponer.comentarios" /></p>
		<div class="fila_de_tabla" style="width:auto;">
		<div class="text">
			<label for="Disclaimer" class="oculto" ><bean:message 	key="gestorFlujo.proponer.proponer" /></label> 
...
<!--  FIN CAJA DE FORMULARIO   -->
		...
		<form
			action="<html:rewrite action="ProponerCatalogacionCU/ProponerCatalogacionCancelar"/>"
