...
<tiles:insert definition="layout-gestor-flujo-con-style">
	...
	<tiles:put name="body" type="string">
		...
		<h2><bean:message key="gestorFlujo.album.modificar" /></h2>

		<form id="modificarAlbumCUModificarAceptarForm" action='<html:rewrite action="/${initParam.url_modificar_aceptar}"/>' method="post" >
		<!--  INICIO GLOBO GRIS   --><!--  INICIO GLOBO GRIS   -->
			...
			<div id="formulario" >
				<p class="parrafo_comun" ><bean:message key="gestorFlujo.album.textoModificar" /></p>
				...
				<div class="globo_blanco_03">
					...
					<div class="contenedor_derecha">
						<div class="text">
							<input name="titulo" value="${form.titulo}" id="titulo" type="text" maxlength="200" onblur="this.style.backgroundColor='#e1e1e1'" title="<bean:message key="gestorFlujo.album.introduzcaNombre"/>" />
						</div>
					</div>
		...
		<form
			action='<html:rewrite action="ModificarAlbumCU/ModificarCancelar"/>'
