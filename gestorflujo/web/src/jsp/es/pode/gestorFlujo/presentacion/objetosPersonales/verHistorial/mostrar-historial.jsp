...
<div class="globo_gris">
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<c:when test="${historial.estadoActual.clave eq 'PUBLICADO_AUTONOMO'}">
				<em class="estado operso_estado_autopublicado" >
				<span><bean:message key="historial.publicadoAutonomo"/></span></em>
			</c:when>	
			</c:choose>
