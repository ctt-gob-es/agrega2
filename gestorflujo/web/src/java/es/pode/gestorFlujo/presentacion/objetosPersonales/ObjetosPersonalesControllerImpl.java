...
public class ObjetosPersonalesControllerImpl extends ObjetosPersonalesController {
	...
	//Este metodo debe ser identico al BuscarPersonalesControllerImpl.buscarOdesPorTitulo
	/**
...
//    	}
    ...
    /**
     * Este metodo debe ser identico al que hay en BuscarPersonalesControllerImpl
     * 
     */
...
//		if (actionSubmit.equals(i18n.getString("gestorFlujo.mostrarOdes.eliminar")) )
//		{
//			result = "Eliminar";
//		} 
//		else if (actionSubmit.equals(i18n.getString("gestorFlujo.mostrarOdes.importar"))) 
//		{
//			String url = HTTP + LdapUserDetailsUtils.getHost();
//			String returnUrl=BARRA + request.getSession().getServletContext().getInitParameter("url_objetosPersonales_importar");
//			
...
//			}
//			url= url + returnUrl;
//			String urlCompleto=url+"?espacioLibre="+form.getEspacioLibre();
...
//		ObjetosPersonalesSession sesion = this.getObjetosPersonalesSession(request);
	...
	@Override
	public void submitEliminar(ActionMapping mapping, SubmitEliminarForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		logger.debug("Pasamos por submitEliminar");
