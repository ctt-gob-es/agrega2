 ...
 */
public class SrvRestServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvRestServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.rest.servicios.SrvRestService
    */
    
    protected es.pode.rest.servicios.SrvRestService servicio;
	public void setServicio(es.pode.rest.servicios.SrvRestService servicio) {
