 ...
 */
public class SrvSQISincronoServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvSQISincronoServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.dri.negocio.servicios.SQI.SrvSQISincronoService
    */
    
    protected es.pode.dri.negocio.servicios.SQI.SrvSQISincronoService servicio;
	public void setServicio(es.pode.dri.negocio.servicios.SQI.SrvSQISincronoService servicio) {
