...
//	private Logger logger = Logger.getLogger(this.getClass());
	 ...
	 * Recoge los resultados que genera y los devuelve teniendo en cuenta el numero maximo de resultados para una query,
	...
	throws java.lang.Exception
	{
		try 
		{
			...
			if (consulta==null || consulta.isEmpty())
			{
				...
				SesionVO sesion=null;
				sesion=this.getSrvSesionesService().consultaSesion(targetSessionID);
				if(sesion==null) {
					String error="<error>No se ha podido recuperar sesion</error>";
					logger.error(error);
					return error;
				}
...
//							throw exception;
							return "<error>Error en parametros de la query. los resultados devueltos deben ser mayores que cero pero menores que el maximo de resultados</error>";
						}
					}else{
//						ServiceSQIException exception = new ServiceSQIException("Error en parametros de la query. los resultados devueltos deben ser mayores que cero pero menores que el maximo de resultados");
						String detallesParametros="con maximos resultados ["+consul.getMaxResultados()+"]"
...
//					throw exception;
					return "<error>Error en parametros de la query. startResult debe ser positivo</error>";
				}
...
//			throw exception;
			return "<error>Error en parametros de la query.</error>";
		} 
...
//			ServiceSQIException exception = new ServiceSQIException("Fallo al realizar query síncrona.",e);
			logger.warn(e);
//			throw exception;
			return "Fallo al realizar query síncrona.";
		}
	}
}