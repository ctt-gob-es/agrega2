 ...
 */
public class SrvSitemapServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvSitemapServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.sitemap.negocio.servicios.SrvSitemapService
    */
    
    protected es.pode.sitemap.negocio.servicios.SrvSitemapService servicio;
	public void setServicio(es.pode.sitemap.negocio.servicios.SrvSitemapService servicio) {
