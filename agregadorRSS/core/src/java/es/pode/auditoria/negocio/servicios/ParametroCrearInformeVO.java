...
public class ParametroCrearInformeVO  implements java.io.Serializable {
    ...
    /* Identificador de la tarea que ha lanzado la ejecuci贸n del
     *                                 informe, se usuar谩 para actualizar
     * la fecha de finalizaci贸n de
     *                                 la tarea una vez haya acabado la generaci贸n
     * del informe */
     ...
     * 
     * @return idTarea   * Identificador de la tarea que ha lanzado la ejecuci贸n del
     *                                 informe, se usuar谩 para actualizar
     * la fecha de finalizaci贸n de
     *                                 la tarea una vez haya acabado la generaci贸n
     * del informe
     ...
     * 
     * @param idTarea   * Identificador de la tarea que ha lanzado la ejecuci贸n del
     *                                 informe, se usuar谩 para actualizar
     * la fecha de finalizaci贸n de
     *                                 la tarea una vez haya acabado la generaci贸n
     * del informe
