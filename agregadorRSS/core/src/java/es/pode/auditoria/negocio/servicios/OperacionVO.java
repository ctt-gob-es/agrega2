...
/**
 * Informaci贸n de las operaciones interesantes que se pueden
 *                         realizar en la plataforma. Contendr谩 el idOde,
 * t铆tuloOde sobre
 *                         el que se ha realizado la operaci贸n, el usuario,
 * la operaci贸n
 *                         (visualizaci贸n de la ficha, previsualizaci贸n,
 * visualizaci贸n,
 *                         descarga, b煤squeda) y la fecha.
 */
public class OperacionVO  implements java.io.Serializable {
     ...
     * 
     * @return idioma   * Idioma de b煤squeda
     */
     ...
     * 
     * @param idioma   * Idioma de b煤squeda
     */
