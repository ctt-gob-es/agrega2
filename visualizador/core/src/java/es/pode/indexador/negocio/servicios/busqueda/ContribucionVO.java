...
public class ContribucionVO  implements java.io.Serializable {
     ...
     * el
     *                                 ODE */
    private es.pode.indexador.negocio.servicios.busqueda.EntidadVO[] entidades;
    ...
    public ContribucionVO(
           ...
           es.pode.indexador.negocio.servicios.busqueda.EntidadVO[] entidades) {
     ...
     *                                 ODE
     */
    public es.pode.indexador.negocio.servicios.busqueda.EntidadVO[] getEntidades() {
        return entidades;
    }
     ...
     *                                 ODE
     */
    public void setEntidades(es.pode.indexador.negocio.servicios.busqueda.EntidadVO[] entidades) {
        this.entidades = entidades;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "ContribucionVO"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("codTipoContribucion");
        elemField.setXmlName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "codTipoContribucion"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "entidades"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "EntidadVO"));
