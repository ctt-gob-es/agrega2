...
public class SrvPropiedadServiceServiceLocator extends org.apache.axis.client.Service implements es.indra.agrega.jmx.SrvPropiedadServiceService {
 ...
 */
    ...
    public es.indra.agrega.jmx.SrvPropiedadService getSrvPropiedadService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.indra.agrega.jmx.SrvPropiedadServiceSoapBindingStub _stub = new es.indra.agrega.jmx.SrvPropiedadServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.indra.agrega.jmx.SrvPropiedadService.class.isAssignableFrom(serviceEndpointInterface)) {
                es.indra.agrega.jmx.SrvPropiedadServiceSoapBindingStub _stub = new es.indra.agrega.jmx.SrvPropiedadServiceSoapBindingStub(new java.net.URL(SrvPropiedadService_address), this);
                _stub.setPortName(getSrvPropiedadServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jmx.agrega.indra.es", "SrvPropiedadServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jmx.agrega.indra.es", "SrvPropiedadService"));
        }
