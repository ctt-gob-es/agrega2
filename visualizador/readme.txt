    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\The I-Builder Team\.maven\repository\visualizador\

        (*nix)
        /home/The I-Builder Team/.maven/repository/visualizador/
