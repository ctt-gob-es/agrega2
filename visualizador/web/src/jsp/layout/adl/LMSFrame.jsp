<%@page import = "es.pode.adl.debug.LogConfig,java.io.*,org.apache.log4j.Logger"%>
...
<%
   ...
   {  
      mLogger.error("---Caught exception " + e);
   }*/
%>
...
function  doNavEvent( navEvent )
{   
	//alert("doNavEvent con boton " + navEvent);
   // Disable the button controls
   document.forms['buttonform'].next.disabled = true;
   document.forms['buttonform'].previous.disabled = true;
   //document.forms['buttonform'].quit.disabled = true;
   ...
   //alert("el valor scoWinType es " + scoWinType);
   if (scoWinType != "undefined" && scoWinType != "unknown")
   {
      if (window.parent.frames['Content'].scoWindow != null)
      {
   ...
   //alert("document.layers " + document.layers + " document.all " + document.all);
   if ( document.layers != null )
   {
      swapLayers();
   }
...
function close_onclick(cursoID) {
 //alert('scoID ' + cursoID);
 //parent.location='/visualizador-1/VisualizarAdl/LmsmainDatosBorrar.do?identificador=' + cursoID;
 var dml = document.buttonform;
 dml.action='/visualizador-1/VisualizarAdl/LmsmainDatosBorrar.do?identificador=' + cursoID;
 dml.submit();
 top.close();
}
...
<form name="buttonform">
 <object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93"
  ...
  <param name = "code" value = "es/pode/adl/client/ClientRTS.class" >
  <param name = "codebase" value = "./" >
  <param name = "type" value="application/x-java-applet;jpi-version=1.4.2">
  <param name = "mayscript" value="true" >
  <param name = "scriptable" value="true" >
  <param name = "archive" 
           value = "../lmsclient.jar,../joda-time-1.1.jar,../cmidatamodel.jar,../debug.jar,../sspserver.jar,../util.jar" >
  <comment>
  <applet code="es/pode/adl/client/ClientRTS.class" 
            archive="../lmsclient.jar,../joda-time-1.1.jar,../cmidatamodel.jar,../debug.jar,../sspserver.jar,../util.jar" 
            codebase="./"
            src="./" 
            height="1" 
            id="APIAdapter" 
    ...
    <tr valign="top"> 
       <td>
          <img border="0" align="Left" src="/static/img/logo_agrega_small.gif" height="39" alt="Agrega Logo"/>
          <img border="0" align="Left" src="adlLogo.gif" height="39" alt="ADL Logo"/>
       </td>
       <td align="center">   
          <b>
    ...
    <tr>
       ...
       <td align="left">
          <input type="button" value="<bean:message key="metanavegacion.Cerrar"/>" id="close" 
		  name="close" 
                 language="javascript" onclick="return close_onclick('<%=request.getSession().getAttribute("COURSEID") %>');"> 
       </td>
       <TD ALIGN="center">
       ...
       <td align="center"> 
          ...
          <input type="button" align ="right" value="<bean:message key="cabecera.adl.anterior"/>" id="previous" 
       ...
       <td align="center">
             ...
             <input type="button" align ="right" value="<bean:message key="cabecera.adl.siguiente"/>" id="next" 
