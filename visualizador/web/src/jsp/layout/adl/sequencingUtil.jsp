<%@page import = "java.io.FileOutputStream, java.io.ObjectOutputStream, 
	es.pode.adl.sequencer.SeqActivityTree,java.io.*,java.util.*"%>
<%
   /***************************************************************************
   **
...
<%!
   private static String ERROR_PAGE = "./endsession.htm";
   ...
   */
   public static String LAUNCH_ERROR = "./error.htm";
   ...
   * <br>[SEQUENCING SUBSYSTEM CONSTANT]
   */
   public static String LAUNCH_BLOCKED = "./blocked.htm";
   ...
   * <br>[SEQUENCING SUBSYSTEM CONSTANT]
   */
   public static String LAUNCH_TOC = "./viewTOC.htm";
   ...
   * <br>[SEQUENCING SUBSYSTEM CONSTANT]
   */
   public static String LAUNCH_ENDSESSION = "./endsession.htm";
   ...
   * <br>[SEQUENCING SUBSYSTEM CONSTANT]
   */
   public static String LAUNCH_NOTHING = "./nothing.htm";
   ...
   * <br>[SEQUENCING SUBSYSTEM CONSTANT]
   */
   public static String LAUNCH_DEADLOCK = "./endsession.htm";
   ...
   ***************************************************************************/
   private boolean persistActivityTree( SeqActivityTree iTree, String iUser, 
                                        String iCourse, String rutaOdes )
   {
    boolean result = true;
   
    String serializeFileName = rutaOdes +  "/serialize.obj";
