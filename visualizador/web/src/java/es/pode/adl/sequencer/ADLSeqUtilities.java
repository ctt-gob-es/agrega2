...
{
	private static Logger logger = Logger.getLogger(ADLSeqUtilities.class);
	public static HashMap datosOjbs = null;
   /**
   ...
   */
   ...
   //metodo no referenciado en el proyecto
   public static void createGlobalObjs(String iLearnerID,
                                       String iScopeID,
                                       Vector iObjList, HashMap datos)
   {
      if ( _Debug )
      {
         System.out.println("  :: ADLSeqUtilities  --> BEGIN - " +
...
//      }
    ...
    * @param iObjList    A list of global objective IDs.
    */   
   //no referenciado en el proyecto
...
//      }
    ...
    * @param iObjList    A list of global objective IDs.
    */
   //////////////ESTE METODO ES LLAMADO Y HAY QUE ARREGLARLOª!!!!!!!!!!!!!!!!!!
...
//      }
   ...
   public static String getGlobalObjMeasure(String iObjID, 
                                            String iLearnerID,
                                            String iScopeID, HashMap datosObjs)
   {
      ...
      measure= datosOjbs.get(iObjID).toString();
...
//      }
   ...
   public static boolean setGlobalObjMeasure(String iObjID, 
                                             String iLearnerID,
                                             String iScopeID,
                                             String iMeasure, HashMap datosObjs)
   {
      ...
      if ( iObjID != null )
	   {
	       if ( iLearnerID != null )
	       {
	    	   datosOjbs.remove(iObjID);
	    	   datosOjbs.put(iObjID, iMeasure);
	       } else {
	    	   success=false;
	       }
	     } else {
         ...
         if ( curNode.getNodeType() == Node.ELEMENT_NODE )
         {
            if ( curNode.getLocalName().equals("controlMode") )
            {
               ...
               if ( tempVal != null )
               {
                  ...
                  {
                     ioAct.
                     setUseCurProgress(Boolean.valueOf(tempVal));
                  }
               }
            }
         ...
         if ( curNode.getNodeType() == Node.ELEMENT_NODE )
         {
            if ( curNode.getLocalName().equals("primaryObjective") )
            {
               ...
               if ( tempVal != null )
               {
                  if ( !isEmpty(tempVal) )
                  {
                     obj.mMinMeasure = (Double.valueOf(tempVal));
                  }
               }
            ...
            else if ( curNode.getLocalName().equals("objective") )
            {
               ...
               if ( tempVal != null )
               {
                  ...
                  {
                     obj.mSatisfiedByMeasure = 
                        (Boolean.valueOf(tempVal)).booleanValue();
                  }
               }
