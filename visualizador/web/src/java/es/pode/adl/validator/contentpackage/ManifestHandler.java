         ...
         if ( nodeName != null )
         {
            ...
            if ( nodeChildren != null )
            {
               for ( int i=0; i < size; i++ )
               {
                  ...
                  if ( nodeChildren.item(i).getNodeType() != Node.TEXT_NODE )
                  {
   ...
   private String getObjectivesList(Node iNode)
   {
      ...
      if (iNode != null)
      {
         ...
         if (objNode != null)
         {
            ...
            StringBuilder resultB = new StringBuilder(result);
            ...
            for(j = 0; j < objNodes.size(); j++)
            {
               ...
               for(k = 0; k < attributesList.getLength(); k++)
               {
                  ...
                  {
                     resultB.append("," + attributesList.item(k).getNodeValue());
                  }
               }
