   ...
   public static String trunc(String iValue, int iType)
   {
      ...
      switch ( iType )
      {
         case InteractionValidator.MULTIPLE_CHOICE :
         {
            ...
            StringBuilder truncB = new StringBuilder();
            ...
            for ( int i = 0; i < 36; i++ )
            {
               ...
               {
                  truncB.append(choices[i].substring(0, 250));
               }
               else
               {
                  truncB.append(choices[i]);
               }
         ...
         { 
            ...
            for ( int i = 0; i < 10; i++ )
            {
               ...
               if ( langString!=null&&langString.length() > 250)
               {
                  trunc = trunc + "{lang=" + 
