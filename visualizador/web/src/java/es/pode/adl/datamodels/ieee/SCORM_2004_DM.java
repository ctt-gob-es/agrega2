...
import es.pode.adl.client.ServletProxy;
...
{
	private static Logger logger = Logger.getLogger(SCORM_2004_DM.class);
   /**
...
//      DMProcessingInfo pi = new DMProcessingInfo();
      ...
      StringBuilder requestB = new StringBuilder(request);
      ...
      for ( int i = 0; i < (count - 1); i++ )
      {
         ...
         try
         {
            req = new DMRequest(newRequest, value.toString());
