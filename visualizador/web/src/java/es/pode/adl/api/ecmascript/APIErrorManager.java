...
public class APIErrorManager
{
    ...
    */
   private static int mCurrentErrorCode = APIErrorCodes.NO_ERROR;
...
//      mCurrentErrorCode = APIErrorCodes.NO_ERROR;
      ...
      if(iAPIVersion == SCORM_2004_API)
      {
         ...
         mErrorCodes.put(APIErrorCodes.NO_ERROR, "0");
         mErrorCodes.put(APIErrorCodes.GENERAL_EXCEPTION,"101");
         mErrorCodes.put(APIErrorCodes.GENERAL_INIT_FAILURE,"102");
         mErrorCodes.put(APIErrorCodes.ALREADY_INITIALIZED,"103");
         mErrorCodes.put(APIErrorCodes.CONTENT_INSTANCE_TERMINATED,"104");
         mErrorCodes.put(APIErrorCodes.GENERAL_TERMINATION_FAILURE,"111");
         mErrorCodes.put(APIErrorCodes.TERMINATE_BEFORE_INIT,"112");
         mErrorCodes.put(APIErrorCodes.TERMINATE_AFTER_TERMINATE,"113");
         mErrorCodes.put(APIErrorCodes.GET_BEFORE_INIT,"122");
         mErrorCodes.put(APIErrorCodes.GET_AFTER_TERMINATE,"123");
         mErrorCodes.put(APIErrorCodes.SET_BEFORE_INIT,"132");
         mErrorCodes.put(APIErrorCodes.SET_AFTER_TERMINATE,"133");
         mErrorCodes.put(APIErrorCodes.COMMIT_BEFORE_INIT,"142");
         mErrorCodes.put(APIErrorCodes.COMMIT_AFTER_TERMINATE,"143");
         mErrorCodes.put(DMErrorCodes.GEN_ARGUMENT_ERROR,"201");
         mErrorCodes.put(DMErrorCodes.GEN_GET_FAILURE,"301");
         mErrorCodes.put(DMErrorCodes.GEN_SET_FAILURE,"351");
         mErrorCodes.put(APIErrorCodes.GENERAL_COMMIT_FAILURE,"391");
         mErrorCodes.put(DMErrorCodes.UNDEFINED_ELEMENT,"401");
         mErrorCodes.put(DMErrorCodes.NOT_IMPLEMENTED,"402");
         mErrorCodes.put(DMErrorCodes.NOT_INITIALIZED,"403");
         mErrorCodes.put(DMErrorCodes.READ_ONLY,"404");
         mErrorCodes.put(DMErrorCodes.WRITE_ONLY,"405");
         mErrorCodes.put(DMErrorCodes.TYPE_MISMATCH,"406");
         mErrorCodes.put(DMErrorCodes.VALUE_OUT_OF_RANGE,"407");
         mErrorCodes.put(DMErrorCodes.DEP_NOT_ESTABLISHED,"408");
         mErrorCodes.put(DMErrorCodes.DOES_NOT_HAVE_CHILDREN,"301");
         mErrorCodes.put(DMErrorCodes.DOES_NOT_HAVE_COUNT,"301");
         mErrorCodes.put(DMErrorCodes.DOES_NOT_HAVE_VERSION,"301");
         mErrorCodes.put(DMErrorCodes.SET_OUT_OF_ORDER,"351");
         mErrorCodes.put(DMErrorCodes.OUT_OF_RANGE,"301");
         mErrorCodes.put(DMErrorCodes.ELEMENT_NOT_SPECIFIED,"351");
         mErrorCodes.put(DMErrorCodes.NOT_UNIQUE,"351");
         mErrorCodes.put(DMErrorCodes.MAX_EXCEEDED,"351");
         mErrorCodes.put(DMErrorCodes.SET_KEYWORD,"404");
         mErrorCodes.put(DMErrorCodes.INVALID_REQUEST,"401");
         mErrorCodes.put(DMErrorCodes.INVALID_ARGUMENT,"301");
         mErrorCodes.put(DMErrorCodes.OVERWRITE_ID,"351");
...
//                         new String("351"));
         ...
         mErrorMessages.put(APIErrorCodes.NO_ERROR,"No Error");
         mErrorMessages.put(APIErrorCodes.GENERAL_EXCEPTION,"General Exception");
         mErrorMessages.put(APIErrorCodes.GENERAL_INIT_FAILURE,"General Initialization Error");
         mErrorMessages.put(APIErrorCodes.ALREADY_INITIALIZED,"Already Initialized");
         mErrorMessages.put(APIErrorCodes.CONTENT_INSTANCE_TERMINATED,"Content Instance Terminated");
         mErrorMessages.put(APIErrorCodes.GENERAL_TERMINATION_FAILURE,"General Termination Failure");
         mErrorMessages.put(APIErrorCodes.TERMINATE_BEFORE_INIT,"Termination Before Initialization");
         mErrorMessages.put(APIErrorCodes.TERMINATE_AFTER_TERMINATE,"Termination After Termination");
         mErrorMessages.put(APIErrorCodes.GET_BEFORE_INIT,"Retrieve Data Before Initialization");
         mErrorMessages.put(APIErrorCodes.GET_AFTER_TERMINATE,"Retrieve Data After Termination");
         mErrorMessages.put(APIErrorCodes.SET_BEFORE_INIT,"Store Data Before Initialization");
         mErrorMessages.put(APIErrorCodes.SET_AFTER_TERMINATE,"Store Data After Termination");
         mErrorMessages.put(APIErrorCodes.COMMIT_BEFORE_INIT,"Commit Before Initialization");
         mErrorMessages.put(APIErrorCodes.COMMIT_AFTER_TERMINATE,"Commit After Termination");
         mErrorMessages.put(DMErrorCodes.GEN_ARGUMENT_ERROR,"General Argument Error");
         mErrorMessages.put(DMErrorCodes.GEN_GET_FAILURE,"General Get Failure");
         mErrorMessages.put(DMErrorCodes.GEN_SET_FAILURE,"General Set Failure");
         mErrorMessages.put(APIErrorCodes.GENERAL_COMMIT_FAILURE,"General Commit Failure");
         mErrorMessages.put(DMErrorCodes.UNDEFINED_ELEMENT,"Undefined Data Model Element");
         mErrorMessages.put(DMErrorCodes.NOT_IMPLEMENTED,"Unimplemented Data Model Element");
         mErrorMessages.put(DMErrorCodes.NOT_INITIALIZED,"Data Model Element Value Not Initialized");
         mErrorMessages.put(DMErrorCodes.READ_ONLY,"Data Model Element Is Read Only");
...
//                         new Integer(SSP_DMErrorCodes.BUCKET_NOT_PACKED));
    ...
    */
   synchronized public void clearCurrentErrorCode()
   {
      mCurrentErrorCode = APIErrorCodes.NO_ERROR;
   }
