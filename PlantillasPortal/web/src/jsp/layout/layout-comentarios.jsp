							...
							<div id="cabecera" >	
								...
								<div class="destacado_patros" >
									...
									<ul id="patros">
											...
											<li id="pat_02_ind"><a href="http://www.mityc.es" target="_blank" title="<bean:message key="pie.ministeIndusTursComer"/>"><bean:message key="pie.ministeIndusTursComer"/></a>&nbsp;</li>
											<li id="pat_03_edu"><a href="http://www.mec.es" target="_blank" title="<bean:message key="pie.ministeEducionCiencia"/>"><bean:message key="pie.ministeEducionCiencia"/></a>&nbsp;</li>									
											<li id="pat_04_isftic"><a href="http://www.isftic.mepsyd.es"  target="_blank" title="<bean:message key="pie.isftic"/>"><bean:message key="pie.isfticCorto"/></a>&nbsp;</li>
