...
<nav id="menu">
	...
	<div id="nav_principal">
		<ul class="metanavegacion">
			...
			<li><a href="http://<agrega:agregaProperties property="host"/><agrega:agregaProperties property="subdominio"/>/visualizadorcontenidos2/BusquedaGoogleCU/BusquedaGoogleCU.do" id="activo"><bean:message key="menu.cabecera.buscador.externo"/></a></li>
