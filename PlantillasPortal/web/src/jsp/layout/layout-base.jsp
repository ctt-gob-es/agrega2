...
<html lang="en" class="no-js">
	...
	<head lang="es" dir="ltr">
		...
		<script type="text/javascript" src="<rewrite:rewrite url="static/Agrega2/js/jquery-1.7.2.min.js"/>"></script>
	...
	<body > <!--<![endif]-->
		...
		<div id="madre">
			...
			<div id="contenedor_ie">
				<div id="contenedor">
					...
					<!-- INICIO PRINCIPAL   -->
					<section id="principal" class="doble_columna">
						<article id="main" class="clearfix">
							<tiles:insert attribute="menu-nav-secundaria" flush="true"/>
		...
		<script type='text/javascript' src="<rewrite:rewrite url="static/js/codigo.js"/>"></script>
		<script type='text/javascript' src="<rewrite:rewrite url="static/js/plantilla.js"/>"></script>
		<script type='text/javascript' src="<rewrite:rewrite url="static/Agrega2/js/acceso.js"/>"></script>
		<script type='text/javascript' src="<rewrite:rewrite url="static/Agrega2/js/date.js"/>"></script>
		<script type='text/javascript' src="<rewrite:rewrite url="static/Agrega2/js/jquery.datePicker.js"/>"></script>
