...
//	        		Parseamos y lo incluimos en un hashmap
	...
	/**
	 * Traduce los términos con identificadores del l_id a ingles
    ...
    /**
	 * Traduce los términos con identificadores del l_id al idioma que le pasamos por parámetro
	 * @param l_id Lista de identificadores de los vocabularios
    ...
    {
//		buscamos si el fichero existe, en caso contrario lo comprobamos para el idioma de la plataforma o ya el propio español
		String ficheroProperties = "/fuentestaxonomicas.properties";
		InputStream is= null;
		is= this.getClass().getResourceAsStream(ficheroProperties);
		Properties fproperties = new Properties();
...
//		buscamos si el fichero existe, en caso contrario lo comprobamos para el idioma de la plataforma o ya el propio español
	...
	/**
	 * Obtiene los vocabularios de identificadores de la lista l_id en el idioma que le pasamos por parámetro
