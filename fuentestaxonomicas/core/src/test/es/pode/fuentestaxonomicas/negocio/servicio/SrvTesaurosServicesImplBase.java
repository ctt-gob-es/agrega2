 ...
 */
public class SrvTesaurosServicesImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvTesaurosServicesImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.fuentestaxonomicas.negocio.servicio.SrvTesaurosServices
    */
    
    protected es.pode.fuentestaxonomicas.negocio.servicio.SrvTesaurosServices servicio;
	public void setServicio(es.pode.fuentestaxonomicas.negocio.servicio.SrvTesaurosServices servicio) {
