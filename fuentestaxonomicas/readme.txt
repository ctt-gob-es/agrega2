	...
	Project Creator:            Indra
	Project Name:               fuentestaxonomicas
	Project Id:                 fuentestaxonomicas
	Project version:            1
	Base Project Package:       es.pode.fuentestaxonomicas.negocio
    ...
    The project located in this directory has been generated by Indra
    ...
    /fuentestaxonomicas J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\Indra\.maven\repository\fuentestaxonomicas\

        (*nix)
        /home/Indra/.maven/repository/fuentestaxonomicas/
