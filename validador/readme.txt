	...
	Project Name:               validador
	Project Id:                 validador
	Project version:            1
	Base Project Package:       es.pode.validador.negocio
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\Indra\.maven\repository\validador\

        (*nix)
        /home/Indra/.maven/repository/validador/
