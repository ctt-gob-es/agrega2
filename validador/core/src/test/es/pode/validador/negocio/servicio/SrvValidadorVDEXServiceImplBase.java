 ...
 */
public class SrvValidadorVDEXServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvValidadorVDEXServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.validador.negocio.servicio.SrvValidadorVDEXService
    */
    
    protected es.pode.validador.negocio.servicio.SrvValidadorVDEXService servicio;
	public void setServicio(es.pode.validador.negocio.servicio.SrvValidadorVDEXService servicio) {
