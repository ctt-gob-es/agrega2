 ...
 */
public class SrvAdminUsuariosServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvAdminUsuariosServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.adminusuarios.negocio.servicios.SrvAdminUsuariosService
    */
    
    protected es.pode.adminusuarios.negocio.servicios.SrvAdminUsuariosService servicio;
	public void setServicio(es.pode.adminusuarios.negocio.servicios.SrvAdminUsuariosService servicio) {
