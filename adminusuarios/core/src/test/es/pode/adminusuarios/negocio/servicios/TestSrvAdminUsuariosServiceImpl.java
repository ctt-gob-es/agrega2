...
//    		 DatabaseOperation.DELETE.execute(connection, dataSet);
     ...
     */
     ...
     public void testaltaGrupo() throws java.lang.Exception
     {
    	 ...
    	 String descripcion = "pppp";
    	 RolVO[] rols = new RolVO[1];
    	 RolVO rol = servicio.getRol(1l);
    	 rols[0]=rol;
...
*/
     ...
     */
     ...
     {
		GrupoVO grupo = servicio.descripcionGrupo(1l);
...
//    	 Boolean existe = Boolean.FALSE;
    	 String login = "pruebaLdapExterno";
    	...
    	Long resultado = this.servicio.altaUsuario(usuario);
    ...
    */
	...
	public void testdescripcionUsuario() throws Exception 
     ...
     { 
            ...
            UsuarioVO usuario = servicio.descripcionUsuario(1l);
	 ...
	 */
	 ...
	 {
		 UsuarioVO usuarioVO = servicio.descripcionUsuario(3l);
...
//	     calendar.set(2006, 11, 12);
	...
	public void testEstaActivo() throws Exception
	{
		String usuario = "pruebasoapui";
		Boolean resultado = servicio.estaActivo(usuario);
		System.out.println("resultado "+resultado);
		 assertTrue(resultado);
	
	}
	
	public void testObtenerUsuariosActivosPorNombre() throws Exception
	 {
		String usuario="";
	    UsuarioVO[] usuariosActivos = servicio.obtenerUsuariosActivosPorNombre(usuario);
	     for(int i=0;i<usuariosActivos.length;i++){
	    	 System.out.println("usuariosActivos[i].getNombre() "+usuariosActivos[i].getNombre()); 
	    	 System.out.println("usuariosActivos[i].getApellido1() "+usuariosActivos[i].getApellido1()); 
	    	 System.out.println("usuariosActivos[i].getApellido2() "+usuariosActivos[i].getApellido2()); 
	     }
	     assertEquals(usuariosActivos.length,1);
	 }
