 ...
 */
public class SrvPerfilPublicoImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvPerfilPublicoImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.adminusuarios.negocio.servicios.SrvPerfilPublico
    */
    
    protected es.pode.adminusuarios.negocio.servicios.SrvPerfilPublico servicio;
	public void setServicio(es.pode.adminusuarios.negocio.servicios.SrvPerfilPublico servicio) {
