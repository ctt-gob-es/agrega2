...
public class SrvBuscadorServiceSoapBindingStub extends org.apache.axis.client.Stub implements es.pode.indexador.negocio.servicios.busqueda.SrvBuscadorService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenerIdiomasBusqueda");
        oper.setReturnType(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "ArrayOfIdiomaVO"));
        oper.setReturnClass(es.pode.indexador.negocio.servicios.busqueda.IdiomaVO[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "obtenerIdiomasBusquedaReturn"));
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenerIdiomasLocalizados");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "idIdioma"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "ArrayOfLocalizacionIdiomaVO"));
        oper.setReturnClass(es.pode.indexador.negocio.servicios.busqueda.LocalizacionIdiomaVO[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "obtenerIdiomasLocalizadosReturn"));
        param = oper.getReturnParamDesc();
        param.setItemQName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "item"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
    ...
    public SrvBuscadorServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "ArrayOfIdiomaVO");
            cachedSerQNames.add(qName);
            cls = es.pode.indexador.negocio.servicios.busqueda.IdiomaVO[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "IdiomaVO");
            qName2 = new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "item");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "ArrayOfLocalizacionIdiomaVO");
            cachedSerQNames.add(qName);
            cls = es.pode.indexador.negocio.servicios.busqueda.LocalizacionIdiomaVO[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "LocalizacionIdiomaVO");
            qName2 = new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "item");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {paramBusq});
  ...
  throw axisFaultException;
    ...
    public es.pode.indexador.negocio.servicios.busqueda.IdiomaVO[] obtenerIdiomasBusqueda() throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("obtenerIdiomasBusqueda");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "obtenerIdiomasBusqueda"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (es.pode.indexador.negocio.servicios.busqueda.IdiomaVO[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.pode.indexador.negocio.servicios.busqueda.IdiomaVO[]) org.apache.axis.utils.JavaUtils.convert(_resp, es.pode.indexador.negocio.servicios.busqueda.IdiomaVO[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public es.pode.indexador.negocio.servicios.busqueda.LocalizacionIdiomaVO[] obtenerIdiomasLocalizados(java.lang.String idIdioma) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("obtenerIdiomasLocalizados");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "obtenerIdiomasLocalizados"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {idIdioma});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (es.pode.indexador.negocio.servicios.busqueda.LocalizacionIdiomaVO[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.pode.indexador.negocio.servicios.busqueda.LocalizacionIdiomaVO[]) org.apache.axis.utils.JavaUtils.convert(_resp, es.pode.indexador.negocio.servicios.busqueda.LocalizacionIdiomaVO[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
