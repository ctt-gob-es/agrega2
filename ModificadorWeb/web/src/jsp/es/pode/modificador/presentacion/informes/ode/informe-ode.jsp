	...
	<form action="<html:rewrite action="/InformeODE/InformeODEVolver"/>" id="popup" method="post" >
		...
		<div class="caja_de_tabla_invisible" >
			<table cellspacing="0" cellpadding="0"  border="0" width="100%"  summary="Nombre Tareas">
				...
				<logic:notEmpty name="form" property="pathInforme">
				<tr>
				<td class="nt" valign="top"> <html:link action="/InformeODE/InformeODEEntregar?pathInforme=${form.pathInforme}"> <bean:message key="informe.Informe" /> </html:link> </td>
				</tr>
				</logic:notEmpty>
			</table>
		</div>
