			 ...
			 <!-- -->
									<div class="fila_de_tabla">
										...
										<div class="contenedor_derecha">
											...
											<div class="text">
												<textarea name="valor" rows="10" cols="40" class="ta_minimo_ancho" onblur="this.style.backgroundColor='#e1e1e1'" id="terminoCambio"  title="<bean:message key="otroAddTermino.termnioLom.introducir"/>" >${form.valor}</textarea>
											</div>
										</div>
