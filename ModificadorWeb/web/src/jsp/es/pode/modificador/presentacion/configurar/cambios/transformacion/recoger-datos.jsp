...
<h2><bean:message key="transformacion.titulo"/></h2>
<form id="recogerDatosRecogerDatosSubmitForm" action="<html:rewrite action="/Transformation/RecogerDatosSubmit"/>"  method="post">
<p class="parrafo_comun" id="separacion2"><bean:message key="transformacion.esNecesarioRellenarCompletar"/>.</p>
...
<div class="globo_gris" >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div id="formulario" >
  				<div class="fila_de_tabla" >
  					<div class="contenedor_izquierda">
  						<div class="text"><label for="destino"><bean:message key="transformacion.destino"/></label></div>
 					</div>
					<div class="contenedor_derecha">
						<div class="text"><input name="pathDestino" value="${form.pathDestino}"  onblur="this.style.backgroundColor='#e1e1e1'" id="destino" type="text" title="<bean:message key="transformacion.introduzcaDestino"/>"  /></div>
					</div>
			...
			<div class="contenedor_izquierda">
  						<div class="text"><label for="tipoTransformacion"><bean:message key="transformacion.formato"/></label></div>
 					</div>
			 <div class="fila_de_tabla">
...
<input class="boton_125_de_2"  type="submit" name="action" value="<bean:message key="transformacion.aceptar"/>" />
<input class="boton_125_de_2_izq"  type="submit" name="action" value="<bean:message key="transformacion.volver"/>" />
<input class="boton_125"  type="submit" name="action" value="<bean:message key="transformacion.cancelar"/>" />
</fieldset>
<!-- Fin Botones  -->
<!-- Fin Botones  -->
