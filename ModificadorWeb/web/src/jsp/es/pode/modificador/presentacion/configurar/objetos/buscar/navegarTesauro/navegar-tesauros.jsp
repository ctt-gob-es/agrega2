...
<jsp:include page="/layout/messages.jsp" flush="true"/>
  <form method="post" id="navegarTesauroNavegarTesauroSeleccionarForm" action="<html:rewrite action="/NavegarTesauro/NavegarTesaurosSelectAction"/>">
...
<div class="globo_gris" >
	<div class="globo_gris_01">
		...
		<html:link styleClass="br_carpeta_abierta" action="/NavegarTesauro/NavegarTesaurosNavegar">
        ...
        <c:otherwise>
	        <html:link styleClass="br_carpeta_abierta" action="/NavegarTesauro/NavegarTesaurosNavegar?idTermino=${ruta.id}">
			${ruta.valorTax}<br/>
			</html:link>
        </c:otherwise>
        </c:choose>
...
<div class="caja_tabla limpiar_breadcrumb_00">
		...
		<input type="hidden" name="idTermino" value="${form.idTermino }"/>
		<display:table name="${form.taxonomia.hijos}" id="taxonesvoact" 
        		...
        		<display:setProperty name="basic.show.header" value="false"/>
  				<display:column style="valign:top" class="new" autolink="true">
  					<html:link styleClass="carpeta_cerrada" action="/NavegarTesauro/NavegarTesauro?idTermino=${taxonesvoact.id}">
