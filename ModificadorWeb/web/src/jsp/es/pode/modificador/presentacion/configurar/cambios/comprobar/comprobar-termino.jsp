			...
			<div id="formulario" >
  				<div class="fila_de_tabla" >
					...
					<div class="contenedor_derecha">
						<div class="text"><input name="valor" value="${form.valor}"  onblur="this.style.backgroundColor='#e1e1e1'" id="valor" type="text" title="<bean:message key="comprobarTermino.valor.introduzca"/>"  /></div>
					</div>
