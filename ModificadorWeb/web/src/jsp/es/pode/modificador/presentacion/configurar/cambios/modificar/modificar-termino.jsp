			...
			<div id="formulario" >
  				<div class="fila_de_tabla" >
					...
					<div class="contenedor_derecha">
						<div class="text"><input name="valorViejo"value="${form.valorViejo}"  onblur="this.style.backgroundColor='#e1e1e1'" id="valor" type="text" title="<bean:message key="comprobarTermino.valor.introduzca"/>"  /></div>
					</div>
				...
				<div class="fila_de_tabla" >
					...
					<c:if test="${form.formulario.esCombo == false}" >		
						<div class="text"><input name="valorNuevo" value="${form.valorNuevo}"  onblur="this.style.backgroundColor='#e1e1e1'" id="valorNuevo" type="text" title="<bean:message key="modificarTermino.nuevoValor.introduzca"/>"  /></div>
					</c:if>
				...
				<div class="fila_de_tabla">
					...
					<c:if test="${form.formulario.langString == true}" >	
						...
						<div class="text"><input name="idioma" value=""  onblur="this.style.backgroundColor='#e1e1e1'" id="Idioma" type="text" title="<bean:message key="comprobarTermino.idioma.introduzca"/>"  /></div>
					</c:if>
					
					<c:if test="${form.formulario.langString == false}" >	
						<div class="text"><input name="idioma" disabled="true" onfocus="limpiarTexto(this)" value=""  onblur="this.style.backgroundColor='#e1e1e1'" id="Idioma" type="text" title="<bean:message key="comprobarTermino.idioma.introduzca"/>"  /></div>
					</c:if>
					</div>
					<div class="linea_separadora"></div>
					<br class="oculto" />
