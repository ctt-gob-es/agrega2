		...
		<div class="globo_gris_01">
			<div class="globo_gris_02">
				...
				<!--  Inicio CAJA DE FORMULARIO   -->
					<div id="formulario">
<form method="post" action="<html:rewrite action="/ListarOdesCarga/MostrarOdesDeLaCargaAnadir" />">
				<html:link action="/ListarOdesCarga/MostrarOdesDeLaCargaEliminarTodos" styleClass="resultados_d" ><bean:message key="resultadosBusqueda.eliminarObjetos"/></html:link>
...
<display:table name="${form.seleccionados}" id="fila" export="false" class="generica_02 sin_clear" cellpadding="0" cellspacing="0" summary="Tabla de Objetos seleccionados" sort="list" pagesize="8">
	...
	<c:if test="${!empty fila.localizadorODE}">
		<display:column style="valign:top;" class="td_corta_sin" ><html:link action="/ListarOdesCarga/MostrarOdesDeLaCargaEliminar?path=${fila.localizadorODE}"><bean:message key="comun.eliminar"/></html:link></display:column>
	</c:if>
 </display:table>
...
<form method="post" action="<html:rewrite action="/ListarOdesCarga/MostrarOdesDeLaCargaSubmit" />">
<!--  INICIO GLOBO GRIS   -->
<!--  INICIO GLOBO GRIS   -->
