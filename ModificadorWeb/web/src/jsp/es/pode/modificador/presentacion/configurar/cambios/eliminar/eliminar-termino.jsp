			...
			<div id="formulario" >
  				<div class="fila_de_tabla" >
					...
					<div class="contenedor_derecha">
						<div class="text"><input name="valor" onfocus="limpiarTexto(this)" value="${form.valor}"  onblur="this.style.backgroundColor='#e1e1e1'" id="valor" type="text" title="<bean:message key="comprobarTermino.valor.introduzca"/>"  /></div>
					</div>
				...
				<div class="fila_de_tabla">
					...
					<div class="contenedor_derecha">
						<div class="text">
							...
							<input name="idioma" value=""  onblur="this.style.backgroundColor='#e1e1e1'" id="Idioma" type="text" title="<bean:message key="comprobarTermino.idioma.introduzca"/>"  />
							</c:if>
							<c:if test="${form.formularioModificar.langString == false}" >	
							<input name="idioma" disabled="true" onfocus="limpiarTexto(this)" value=""  onblur="this.style.backgroundColor='#e1e1e1'" id="Idioma" type="text" title="<bean:message key="comprobarTermino.idioma.introduzca"/>"  />
							</c:if>
						</div>
					</div>
					<div class="linea_separadora"></div>
