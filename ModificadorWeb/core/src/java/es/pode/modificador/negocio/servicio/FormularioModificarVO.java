...
public class FormularioModificarVO  implements java.io.Serializable {
    /* Termino LOM-ES identificador por el Ã­ndice (p.e. termino idioma
     * del general = 1.3) */
     ...
     * 
     * @return idTermino   * Termino LOM-ES identificador por el Ã­ndice (p.e. termino idioma
     * del general = 1.3)
     */
     ...
     * 
     * @param idTermino   * Termino LOM-ES identificador por el Ã­ndice (p.e. termino idioma
     * del general = 1.3)
     */
