...
public class SrvBuscadorServiceSoapBindingStub extends org.apache.axis.client.Stub implements es.pode.indexador.negocio.servicios.busqueda.SrvBuscadorService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(es.pode.indexador.negocio.servicios.busqueda.DocVO.class);
        ...
        param.setItemQName(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "item"));
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://busqueda.servicios.negocio.indexador.pode.es", "ArrayOfDocVO"));
        oper.setReturnClass(es.pode.indexador.negocio.servicios.busqueda.DocVO[].class);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {identificadorMEC, idiomaBusqueda});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (es.pode.indexador.negocio.servicios.busqueda.DocVO) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.pode.indexador.negocio.servicios.busqueda.DocVO) org.apache.axis.utils.JavaUtils.convert(_resp, es.pode.indexador.negocio.servicios.busqueda.DocVO.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {paramBusq});
  ...
  throw axisFaultException;
    ...
    public es.pode.indexador.negocio.servicios.busqueda.DocVO[] busquedaVariosMEC(es.pode.indexador.negocio.servicios.busqueda.ParamBuscarMecVO[] parametros) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {nivelAgregacion});
  ...
  throw axisFaultException;
    ...
    public es.pode.indexador.negocio.servicios.busqueda.DocVO obtenerODERandom() throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
