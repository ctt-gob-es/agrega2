...
<c:choose>
	<c:when test="${catalogadorAvSession.asistente==true}">
		<a href="<html:rewrite action="/CatalogadorAvanzado/CategoriasFormConsultar"/>" class="flotante_mensaje" style="font-size:11px !important;margin-top:6px;"><bean:message key="catalogadorAvanzado.Asistente.Enlace"/></a>
	</c:when>
</c:choose>
