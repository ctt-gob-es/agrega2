									...
									<div class="fila_de_tabla">
										...
										<div class="contenedor_derecha">
											<div class="text">												
												...
												<html:text property="titulo" value="${titulo}" styleId="Titulo" maxlength="200" titleKey="catalogadorBasico.IntroduzcaTitulo" />
...
<div id="botones_centrados" style="text-align:left !important;margin-top:10px;">
	<fieldset id="esp_cata">
		<input class="boton_125_de_2_izq" type="submit" name="accionSubmit" value="<bean:message key="catalogadorBasico.Validar"/>" />
		<input class="boton_125_de_2_izq" type="submit" name="accionSubmit" value="<bean:message key="catalogadorBasico.Cancelar"/>" />
		<c:choose>
			<c:when test="${empty catalogadorBSession.crearMetadato}">
				<input class="boton_125_de_2_izq" type="submit" name="accionSubmit" value="<bean:message key="catalogadorBasico.Aceptar"/>" />
			</c:when>
			<c:otherwise>
				<input class="boton_125_de_2_izq" type="submit" name="accionSubmit" id="desactivado" disabled="true" value="<bean:message key="catalogadorBasico.Aceptar"/>" />
			</c:otherwise>
		</c:choose>
	</fieldset> 
	<input class="boton_65_de_3_der  bot_mar_izq" style="margin-right:0;" type="submit" value="<bean:message key="catalogadorBasico.Ir"/>" />
	<label class="oculto" for="mas_acciones"><bean:message key="catalogadorBasico.MasAcciones"/></label>
	<select name="accionSubmitCombo" id="mas_acciones" title="<bean:message key="catalogadorBasico.MasAcciones"/>" >
		<option value="#" selected="selected"><bean:message key="catalogadorBasico.MasAcciones"/></option>
		<option value="<bean:message key="catalogadorBasico.Traducir"/>"><bean:message key="catalogadorBasico.Traducir"/></option>
		<option value="<bean:message key="catalogadorBasico.Exportar"/>" class="oscura"><bean:message key="catalogadorBasico.Exportar"/></option>
		<option value="<bean:message key="catalogadorBasico.Importar"/>"><bean:message key="catalogadorBasico.Importar"/></option>
	</select>
