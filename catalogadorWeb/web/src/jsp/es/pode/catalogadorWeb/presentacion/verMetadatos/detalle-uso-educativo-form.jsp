					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="Interactividad01" class="oculto" >Tipo:</label>
							<html:select disabled="true" styleClass="select_lrg3" name="form" title="Seleccione Interactividad" property="tipoInteractividad">
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp">
  						<div class="text"><label for="Tipo01" class="oculto" >Idioma:</label>
							<html:select disabled="true" styleClass="select_lrg inp_se_ie " name="form" title="Seleccione Tipo" property="TRecur${i}" value="${recurso.valor}" >
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="Interactividad02" class="oculto" >Interactividad:</label>
							<html:select disabled="true" styleClass="select_lrg3" name="form" title="Seleccione Nivel Interactividad" property="nivelInteractividad">
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="Densidad01" class="oculto" >Densidad:</label>
							<html:select disabled="true" styleClass="select_lrg3" name="form" title="Seleccione Densidad Semántica" property="densidadSemantica">
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp">
  						<div class="text"><label for="Rol01" class="oculto" >Rol usuario:</label>
							<html:select disabled="true" styleClass="select_lrg inp_se_ie" name="form" title="Seleccione Rol Usuario Final" property="Rol${i}" value="${rol.valor}" >
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp">
  						<div class="text"><label for="Contexto01" class="oculto" >Contexto:</label>
							<html:select disabled="true" styleClass="select_lrg inp_se_ie" name="form" title="Seleccione Contexto" property="Contxt${i}" value="${context.valor}" >
											...
											<c:set var="indice" value="${j + longEdadAnterior}"/>
													<div class="fila_de_tabla_especial_03">
														<div class="contenedor_izquierda_esp">
															...
															<html:text readonly="true" styleClass="input_largo_03 input_mder" property="Edad${i}_Tex${j}" value="${contenido.texto}" styleId="Edad${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleEdu.SoloEdadTipica"/>
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="Dificultad01" class="oculto" >Tipo:</label>
							<html:select disabled="true" styleClass="select_lrg3" name="form" title="Seleccione Dificultad" property="dificultad">
				...
				<div class="globo_blanco_01">
					...
					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="DiaDur" class="rdr" ><bean:message key="catalogadorAvanzado.DetalleEdu.Dias"/>:</label>
							<html:text readonly="true"  styleClass="in_peq input_mder acentrado" property="Dias" value="${dia}" styleId="Anyos" onfocus="limpiarTexto(this)" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleEdu.Dias"/>
						</div>
					</div>
					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="HoraDur" class="rdr" ><bean:message key="catalogadorAvanzado.DetalleEdu.Horas"/>:</label>
							<html:text readonly="true"  styleClass="in_peq input_mder acentrado" property="Horas" value="${hora}" styleId="Horas" onfocus="limpiarTexto(this)" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleEdu.Horas"/>
						</div>
					</div>
					<div class="contenedor_izquierda_esp" >
					...
					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="SegundosDur2" class="oculto" ><bean:message key="catalogadorAvanzado.DetalleEdu.Segundos"/>:</label>
							<html:text readonly="true"  styleClass="in_peq  acentrado" property="SegundosP2" value="${segundosP2}" styleId="SegundosP2" onfocus="limpiarTexto(this)" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleEdu.Segundos"/>
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
				...
				<logic:iterate id="taDesc" property="tiempoApDescripcion" name="form" indexId="i">	
					...
					<div class="fila_de_tabla_especial" style="padding-left:0 !important">
  					...
  					<div class="contenedor_izquierda_esp" >
  						...
  						<html:textarea  readonly="true" styleClass="input_largo_06 input_mder" property="TADesTex${j}" value="${texto.texto}" styleId="TADes${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleEdu.SoloDescripcion" cols="5" rows="4"/>
  						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
											...
											<c:set var="indice" value="${j + longDescripcionAnterior}"/>
													<div class="fila_de_tabla_especial_03">
														<div class="contenedor_izquierda_esp">
															...
															<html:textarea  readonly="true" styleClass="input_largo_lar input_mder" property="Des${i}_Tex${j}" value="${contenido.texto}" styleId="Des${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleEdu.SoloDescripcion" cols="5" rows="4"  />
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
					...
					<div class="fila_de_tabla_especial_03" >
  					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="Idioma_tipo01" class="oculto" ><bean:message key="catalogadorAvanzado.DetalleEdu.SoloIdioma"/>:</label>
							<html:select disabled="true" styleClass="select_lrg" name="form" title="Seleccione Idioma" property="Idio${i}" value="${idioma.texto}" >
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="Proceso_cognitivo01" class="oculto" ><bean:message key="catalogadorAvanzado.DetalleEdu.SoloProcesoCognitivo"/>:</label>
							<html:select disabled="true" styleClass="select_lrg" name="form" title="Seleccione Proceso cognitivo" property="PCog${i}" value="${proceso.valor}" >
