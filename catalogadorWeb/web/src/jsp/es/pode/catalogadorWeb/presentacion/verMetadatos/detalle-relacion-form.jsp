			...
			<div class="globo_blanco" >
				...
				<div class="fila_de_tabla">
  					<div class="contenedor_izquierda_esp">
						...
						<html:select disabled="true" styleClass="select_lrg3" name="form" title="Seleccione Tipo" property="tipo">
													...
													<div class="fila_de_tabla_especial">
														...
														<div class="contenedor_izquierda_esp">
															<div class="text"><label for="form" class="oculto" ><bean:message key="catalogadorAvanzado.DetalleRel.SoloCatalogo"/>:</label>
  																<html:text readonly="true" styleClass="input_medio_largo" property="Cat" value="${catalogo}" styleId="Cat" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleRel.Catalogo" />
															</div>
														...
														<div class="contenedor_izquierda_esp">
															<div class="text"><label for="form" class="oculto" ><bean:message key="catalogadorAvanzado.DetalleRel.SoloEntrada"/>:</label>
  																<html:text readonly="true" styleClass="input_medio_largo" property="Ent" value="${entrada}" styleId="Ent" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleRel.Entrada" />
															</div>
														</div>
														<div class="limpiar">
														</div><br class="oculto"/>
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
  							<label for="Des${i}" class="oculto" ><bean:message key="catalogadorAvanzado.DetalleRel.SoloDescripcion"/>:</label>
								<html:textarea readonly="true" styleClass="input_largo_02 input_mder" property="Des${i}_Tex${j}" value="${contenido.texto}" styleId="Des${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleRel.SoloDescripcion" cols="5" rows="4"  />
						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
