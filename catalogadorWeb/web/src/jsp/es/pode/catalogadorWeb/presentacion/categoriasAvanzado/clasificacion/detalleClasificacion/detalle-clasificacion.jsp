...
<div class="globo_gris_03">
	...
	<!-- ayuda contextual -->
	<a href="#" class="title_h3" title="${clasificacionSession.ayudaProposito}"><bean:message key="detalleclasi.Razon"/></a>
	<!--  INICIO GLOBO Blanco   -->
	...
	<div class="globo_blanco_03">
		...
		<div class="fila_de_tabla_especial_03" >
  		...
  		<div class="text">
			...
			<cat:select name="form" property="razon" value="${form.razon}" backingList="${form.razonBackingList}" estiloSelect="select_lrg3" estiloOscuro="oscura" title="${propo}"/>
...
<div class="globo_gris_03">
	...
	<!-- ayuda contextual -->
	<a href="#" class="title_h3" title="${clasificacionSession.ayudaRutaTax}"><bean:message key="detalleclasi.RutaTaxonomica"/></a>
	...
	<!--  INICIO GLOBO GRIS   -->
				...
				<div class="text">
					...
					<c:choose>	
						...
						<c:when test="${comboTexto==1}">
							...
							<html:text readonly="true" styleClass="input_largo_04 inp_se_ie input_mder" name="form" property="rutaTax${i }_source" value="${taxRutaSI.texto}"  onblur="this.style.backgroundColor='#e1e1e1'" title="${fuent }"/>
						</c:when>	
					</c:choose>
				</div> 
			</div>
		...
		<logic:iterate name="taxRuta" id="taxon" indexId="t">
		 	...
		 	<c:set var="idTax" value="${taxon.id}"/>
			  ...
			  <div class="globo_blanco globito9 flotder pos_relative" >
			  <div class="globo_blanco_01">
			  <div class="globo_blanco_02">
			  <div class="globo_blanco_03">
			  <logic:iterate name="entryTex" id="unEntryTex" indexId="u">
				...
				<div class="fila_de_tabla_especial_03" style="padding-left:6px !important">
	 			...
	 			<div class="contenedor_izquierda_esp" >
					<div class="text2">
						<html:text readonly="true" styleClass="in_peq_02 input_mder2" property="rutaTax${i}_taxon${t}_Id${u }" styleId="rutaTax${i}_taxon${t}_Id${u }" value="${idTax.texto}"  onblur="this.style.backgroundColor='#e1e1e1'" titleKey="detalleclasi.taxonid" />
					</div>
				</div>
				<div class="contenedor_izquierda_esp">
				...
				<div class="contenedor_izquierda_esp" >
					<div class="text2">
					<html:text readonly="true" styleClass="in_peq_02 input_mder2" property="rutaTax${i}_taxon${t}_EntryTex${u}" styleId="rutaTax${i}_taxon${t}_EntryTex${u}" value="${unEntryTex.texto}"  onblur="this.style.backgroundColor='#e1e1e1'" titleKey="detalleclasi.enty" />
					</div>
				</div>
				<div class="contenedor_izquierda_esp" >
...
<div class="globo_gris_03">
	...
	<div id="formulario" >
		...
		<!-- ayuda contextual -->
		<a href="#" class="title_h3" title="${clasificacionSession.ayudaDescClasi}"><bean:message key="detalleclasi.Descripcion"/></a>
		...
		<!--anclas-->
			...
			<div class="contenedor_izquierda_esp" >
				<div class="text">
					...
					<html:textarea styleClass="input_largo_05 input_mder" property="DesTex${i}" styleId="DesTex${i }" value="${desc.texto}" onblur="this.style.backgroundColor='#e1e1e1'" cols="5" rows="4" titleKey="catalogadorAvanzado.IntroduzcaDescripcion"/>	
				</div>
			</div>
			<div class="contenedor_izquierda_esp" >
			<div class="text">
...
<div class="globo_gris_03">	<!--  INICIO CAJA DE FORMULARIO   -->
	...
	<!-- ayuda contextual -->
	<a href="#" class="title_h3 h3flotante" title="${clasificacionSession.ayudaPalClave}"><bean:message key="detalleclasi.PalabraClave"/></a>
