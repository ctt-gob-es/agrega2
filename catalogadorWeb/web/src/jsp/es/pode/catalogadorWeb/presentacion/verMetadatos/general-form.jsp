		...
		<div class="globo_gris_02">
			...
			<div class="globo_blanco globito flotder" >
				...
				<div class="fila_de_tabla_especial_03" style="padding-left:0 !important">
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
						<html:text readonly="true" styleClass="input_medio_largo" property="IdCat${estado.index}" value="${identificador.catalogo}" styleId="Cat${estado.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.General.Catalogo" />
						</div>
					</div>
					<div class="contenedor_izquierda_esp">
					...
					<div class="contenedor_izquierda_esp">
						<div class="text">
						<html:text readonly="true" styleClass="input_medio_largo" property="IdEnt${estado.index}" value="${identificador.entrada}" styleId="Ent${estado.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.General.Entrada" />
						</div>
					</div>
					<div class="limpiar">
					</div><br class="oculto"/>					
				...
				<c:set var="textos" value="${titulo.textos }"/>
					...
					<div class="fila_de_tabla_especial_03" >
  					<div class="contenedor_izquierda_esp" >
  						...
  						<html:text readonly="true" styleClass="input_largo_lar" property="TitTex${j}" value="${texto.texto}" styleId="Tit${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.General.SoloTitulo" />
  						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
							...
							<!--  INICIO Fila de Campos   -->
								<div class="fila_de_tabla_especial_03" >
		  							...
		  							<div class="text">
										...
										<html:select disabled="true" styleClass="select_lrg inp_se_ie " name="form" property="Idio${i}" value="${idioma.texto}" >
											...
											<c:set var="indice" value="${j + longDescripcionAnterior}"/>
													<div class="fila_de_tabla_especial_03">
														<div class="contenedor_izquierda_esp">
															...
															<html:textarea readonly="true" styleClass="input_largo_lar input_mder" property="Des${i}_Tex${j}" value="${contenido.texto}" styleId="Des${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.General.SoloDescripcion" cols="5" rows="4"  />
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
										...
										<logic:iterate id="contenido" name="textos" indexId="j">
											<c:set var="indice" value="${j + longPalabrasAnterior}"/>
													<div class="fila_de_tabla_especial_03">
														...
														<html:text readonly="true" styleClass="input_largo_03 input_mder" property="Pcla${i}_Tex${j}" value="${contenido.texto}" styleId="PalClave${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.General.SoloPalabraClave" />
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
														...
														<div class="contenedor_izquierda_esp">
															<div class="text">
																<label for="Ambito01" class="oculto" ><bean:message key="catalogadorAvanzado.General.SoloAmbito"/>:</label>
	  															<html:text readonly="true" styleClass="input_largo_03 input_mder" property="Amb${i}_Tex${j}" value="${contenido.texto}" styleId="Ambito${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.General.SoloAmbito" />
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
...
<div class="globo_gris_03">
	...
	<div class="fila_de_tabla_especial_03" >
  	<div class="contenedor_izquierda_esp" >
		...
		<html:select disabled="true" styleClass="select_lrg3" name="form" property="estructura">
...
<div class="globo_gris_03">
	...
	<div class="fila_de_tabla_especial_03" >
  	...
  	<div class="text">
  		...
  		<html:select disabled="true" styleClass="select_lrg3" name="form" property="nivelAgregacion">
