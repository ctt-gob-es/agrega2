...
<div class="globo_gris" >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<!-- ayuda contextual -->
			<a href="#" class="title_h3" title="${relacionSession.ayudaTipo}"><bean:message key="catalogadorAvanzado.DetalleRel.Tipo"/></a>
			<!--  INICIO GLOBO Blanco   -->
			<!--  INICIO GLOBO Blanco   -->
				...
				<div class="fila_de_tabla">
  					<div class="contenedor_izquierda_esp">
  						<div class="text">
							...
							<cat:select name="form" property="tipo" value="${form.tipo}" backingList="${form.tipoBackingList}" estiloSelect="select_lrg3"  title="${tipo}"  estiloOscuro="oscura"/>
						</div>
					</div>
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div id="formulario_02" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3 pos_relative" title="${relacionSession.ayudaRecurso}"><bean:message key="catalogadorAvanzado.DetalleRel.Recurso"/></a>
			<!--  INICIO GLOBO Blanco   -->
			<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco" >
				<div class="globo_blanco_01">
					<div class="globo_blanco_02">
						<div class="globo_blanco_03">
							...
							<a href="#" class="title_h3_b title_h3_sin pos_relative" title="${relacionSession.ayudaIdentificador}"><bean:message key="catalogadorAvanzado.DetalleRel.Identificador"/></a>
					...
					<!--  INICIO Fila de Campos   -->
					<!--  INICIO Fila de Campos   -->
													<div class="fila_de_tabla_especial">
														<div class="contenedor_izquierda_esp">
														...
														<div class="contenedor_izquierda_esp">
															<div class="text"><label for="form" class="oculto" ><bean:message key="catalogadorAvanzado.DetalleRel.SoloCatalogo"/>:</label>
  																<html:text styleClass="input_medio_largo" property="Cat" value="${catalogo}" styleId="Cat" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaCatalogo" />
															</div>
														...
														<div class="contenedor_izquierda_esp">
															<div class="text"><label for="form" class="oculto" ><bean:message key="catalogadorAvanzado.DetalleRel.SoloEntrada"/>:</label>
  																<html:text styleClass="input_medio_largo" property="Ent" value="${entrada}" styleId="Ent" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaEntrada" />
															</div>
														</div>
														<div class="limpiar">
														</div><br class="oculto"/>
				...
				<div class="globo_blanco_01">
					<div class="globo_blanco_02">
						<div class="globo_blanco_03">
							...
							<!-- ayuda contextual -->
							<a href="#" class="title_h3_b title_h3_sin h3flotante" title="${relacionSession.ayudaDescripcion}"><bean:message key="catalogadorAvanzado.DetalleRel.Descripcion"/></a>
...
<logic:iterate id="descrip" name="descripcion" indexId="i">	
					<!--anclas-->
							...
							<!--  INICIO GLOBO GRIS   -->
							<!--  INICIO GLOBO GRIS   -->
									<div class="globo_gris globito flotder" style="width:796px !important">
										<div class="globo_gris_01">
											<div class="globo_gris_02">
												<div class="globo_gris_03">
							<!--  INICIO Fila de Campos   -->
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
  							<label for="Des${i}" class="oculto" ><bean:message key="catalogadorAvanzado.DetalleRel.SoloDescripcion"/>:</label>
								<html:textarea styleClass="input_largo_02 input_mder" property="Des${i}_Tex${j}" value="${contenido.texto}" styleId="Des${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaDescripcion" cols="5" rows="4"  />
						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
						<div class="text">
