...
<div class="globo_gris_03">
	...
	<div class="formu" >
		...
		<!--  INICIO Fila de Campos   -->
			...
			<div class="text">
				<html:text readonly="true" styleClass="input_largo_05"  property="Nombre" styleId="Nombre" value="${nombre }"  onblur="this.style.backgroundColor='#e1e1e1'"  titleKey="catalogadorAvanzado.detalleAnotacion.Nombre"  />
			</div>
			</div>
			...
			<div class="contenedor_izquierda_esp" >
			<div class="text">
				<html:text readonly="true" styleClass="input_largo_05"  property="Organizacion" styleId="Organizacion" value="${organizacion}"  onblur="this.style.backgroundColor='#e1e1e1'"  titleKey="catalogadorAvanzado.detalleAnotacion.Organizacion"  />
			</div>
			</div>
			<div class="limpiar"></div>
			<br class="oculto" />
			...
			<div class="contenedor_izquierda_esp" >
			<div class="text">
				<html:text readonly="true" styleClass="input_largo_05"  property="Email" styleId="Email01" value="${email}" onblur="this.style.backgroundColor='#e1e1e1'"  titleKey="catalogadorAvanzado.detalleAnotacion.correoelectronico"  />
			</div>
			</div>
			<div class="limpiar"></div>
			<br class="oculto" />
	...
	<div id="formulario_02" >
		...
		<logic:iterate name="descripcionFecha" id="descFecha" indexId="i">
			<div class="fila_de_tabla_especial_02" >
 			...
 			<div class="contenedor_izquierda_esp" >
			<div class="text">
				<html:textarea readonly="true" styleClass="input_largo_07 input_mder"  property="DesFecTex${i}" styleId="DesFec${i}" value="${descFecha.texto}" onblur="this.style.backgroundColor='#e1e1e1'" cols="5" rows="4" title="${descFecha.texto}" />
			</div>
			</div>
			<div class="contenedor_izquierda_esp" >
		...
		<!--  INICIO Fila de Campos   -->
			<logic:iterate name="descripcion" id="unaDesc" indexId="di">
				...
				<div class="text"><label for="Des01" class="oculto" ><bean:message key="catalogadorAvanzado.detalleAnotacion.SoloDescripcion"/></label>
					<html:textarea readonly="true" styleClass="input_largo_05 input_mder" property="DesTex${di}" styleId="DesTex${di }" value="${unaDesc.texto}" onblur="this.style.backgroundColor='#e1e1e1'" cols="5" rows="4" title="${unaDesc.texto}"/>	
				</div>
				</div>
				<div class="contenedor_izquierda_esp" >
