	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3" title="${usoEducativoSession.ayudaTipoInteractividad}"><bean:message key="catalogadorAvanzado.DetalleEdu.TipoInteractividad"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
							...
							<cat:select name="form" property="tipoInteractividad" value="${form.tipoInteractividad}" backingList="${form.tipoInteractividadBackingList}" estiloSelect="select_lrg3"  estiloOscuro="oscura" title="${tipe}"/>
						</div>
					</div>
...
<div class="globo_gris conmargen"  >
	<div class="globo_gris_01">
		...
		<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3 h3flotante" title="${usoEducativoSession.ayudaTipoRecEducativo}"><bean:message key="catalogadorAvanzado.DetalleEdu.TipoRecurso"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp">
  						<div class="text">
							...
							<cat:select name="form" property="TRecur${i}" value="${recurso.valor}" backingList="${form.tipoRecursoBackingList}" estiloSelect="select_lrg inp_se_ie" title="${tipoR}"  estiloOscuro="oscura"/>
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3" title="${usoEducativoSession.ayudaNivelInteractividad}"><bean:message key="catalogadorAvanzado.DetalleEdu.NivelInteractividad"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative" >
				<div class="globo_blanco_01">
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
							...
							<cat:select name="form" property="nivelInteractividad" value="${form.nivelInteractividad}" backingList="${form.nivelInteractividadBackingList}" estiloSelect="select_lrg3"  title="${nivel}" estiloOscuro="oscura"/>
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3" title="${usoEducativoSession.ayudaDensidadSem}"><bean:message key="catalogadorAvanzado.DetalleEdu.DensidadSemantica"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative" >
				<div class="globo_blanco_01">
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
							...
							<cat:select name="form" property="densidadSemantica" value="${form.densidadSemantica}" backingList="${form.densidadSemanticaBackingList}" estiloSelect="select_lrg3"  title="${densidad}" estiloOscuro="oscura"/>
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3 h3flotante" title="${usoEducativoSession.ayudaDest}"><bean:message key="catalogadorAvanzado.DetalleEdu.RolUsuario"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp">
  						<div class="text">
							...
							<cat:select name="form" property="Rol${i}" value="${rol.valor}" backingList="${form.rolUsuarioBackingList}" estiloSelect="select_lrg inp_se_ie"  title="${rols}" estiloOscuro="oscura"/>
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3 h3flotante" title="${usoEducativoSession.ayudaContexto}"><bean:message key="catalogadorAvanzado.DetalleEdu.Contexto"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp">
  						<div class="text">
							...
							<cat:select name="form" property="Contxt${i}" value="${context.valor}" backingList="${form.comboContextoBackingList}" estiloSelect="select_lrg inp_se_ie" title="${contex}" estiloOscuro="oscura"/>
						...
						<div class="globo_gris_02">
							<div class="globo_gris_03">	<!--  INICIO CAJA DE FORMULARIO   -->
								<div class="formu">
									...
									<!-- ayuda contextual -->
									<a href="#" class="title_h3" title="${usoEducativoSession.ayudaEdadDest}"><bean:message key="catalogadorAvanzado.DetalleEdu.EdadTipica"/></a>
											...
											<c:set var="indice" value="${j + longEdadAnterior}"/>
													<div class="fila_de_tabla_especial_03">
														<div class="contenedor_izquierda_esp">
															...
															<html:text styleClass="input_largo_03 input_mder" property="Edad${i}_Tex${j}" value="${contenido.texto}" styleId="Edad${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaEdadTipica"/>
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3" title="${usoEducativoSession.ayudaDificultad}"><bean:message key="catalogadorAvanzado.DetalleEdu.Dificultad"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative" >
				<div class="globo_blanco_01">
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
							...
							<cat:select name="form" property="dificultad" value="${form.dificultad}" backingList="${form.dificultadBackingList}" estiloSelect="select_lrg3" title="${dificult}" estiloOscuro="oscura"/>
...
<div class="globo_gris conmargen" >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<!-- ayuda contextual -->
					<a href="#" class="title_h3" title="${usoEducativoSession.ayudaTiempoAprendizaje}"><bean:message key="catalogadorAvanzado.DetalleEdu.TiempoAprendizaje"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative" >
				<div class="globo_blanco_01">
				...
				<logic:iterate id="taDesc" name="tiempoApDescripcion" indexId="i">	
					...
					<div class="fila_de_tabla_especial" style="padding-left:0 !important">
  					...
  					<div class="contenedor_izquierda_esp" >
  						...
  						<html:textarea styleClass="input_largo_06 input_mder" property="TADesTex${j}" value="${texto.texto}" styleId="TADes${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaDescripcion" cols="5" rows="4"/>
  						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
						<div class="text">
...
<!--  FIN GLOBO GRIS   -->
	...
	<!--  INICIO GLOBO GRIS Descripción  -->
						...
						<div class="globo_gris_02">
							<div class="globo_gris_03">	<!--  INICIO CAJA DE FORMULARIO   -->
								<div class="formu">
									...
									<!-- ayuda contextual -->
									<a href="#" class="title_h3" title="${usoEducativoSession.ayudaOrientaciones}"><bean:message key="catalogadorAvanzado.DetalleEdu.Descripcion"/></a>
		...
		<c:if test="${caracteristica.seleccionado!=0 }">		
								  					<input type="radio"  class="boton_radio" name="Des${i}_Sel${j}" value="0" onclick="javascript:habilitarDescripcion(${i},${j},0);" style="display:none;">
														...
														<div class="contenedor_izquierda_esp">
															...
															<html:textarea styleClass="input_largo_lar input_mder" property="Des${i}_Tex${j}" value="${contenido.texto}" styleId="Des${i}_Tex${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaUtilizar" cols="5" rows="4" />
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
		...
		<c:if test="${caracteristica.seleccionado!=1 }">		
								  				...
								  				<br class="limpiar" />
					  							<label class="oculto" for="Conocimiento previo" ><bean:message key="catalogadorAvanzado.DetalleEdu.Descripciones.ConocimientoPrevio.label"/></label>
					  							<html:textarea styleClass="input_largo_lar input_mder lr" property="Des${i}_CPre${j}" value="${caracteristica.conocimientoPrevio}" styleId="Des${i}_CPre${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleEdu.Descripciones.ConocimientoPrevio.title"  cols="5" rows="4"  />
												<br class="limpiar" />
 			...
 			<c:if test="${caracteristica.seleccionado==2 }">
  			...
  			<c:if test="${caracteristica.seleccionado!=2 }">		
					  							...
					  							<label class="oculto"  for="Objetos Didacticos" ><bean:message key="catalogadorAvanzado.DetalleEdu.Descripciones.ObjetivosDidacticos.label"/></label>
						 					    <html:textarea styleClass="input_largo_lar input_mder lr" property="Des${i}_ODid${j}" value="${caracteristica.objetivosDidacticos}" styleId="Des${i}_ODid${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.DetalleEdu.Descripciones.ObjetivosDidacticos.title"  cols="5" rows="4"  />
												<br class="limpiar" />
  			...
  			<c:if test="${caracteristica.seleccionado!=3 }">		
										...
										<span class="vert">Tipo de Conocimiento</span>
						  				...
						  				<div class="caja_de_tabla_invisible" id="sd_bor4">
												<table cellspacing="0" cellpadding="0" border="0" width="100%"  summary="opciones">
...
<div class="globo_gris conmargen"  >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					<!-- ayuda contextual -->
					<a href="#" class="title_h3 h3flotante" title="${usoEducativoSession.ayudaIdiomaDest}"><bean:message key="catalogadorAvanzado.DetalleEdu.Idioma"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
					...
					<div class="fila_de_tabla_especial_03" >
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
							...
							<cat:select name="form" property="Idio${i}" value="${idioma.texto}" backingList="${form.idiomasBackingList}" estiloSelect="select_lrg inp_se_ie" estiloOscuro="oscura" title="${idiom}"/>
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3 h3flotante" title="${usoEducativoSession.ayudaProcesoCognitivo}"><bean:message key="catalogadorAvanzado.DetalleEdu.ProcesoCognitivo"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
							...
							<cat:select name="form" property="PCog${i}" value="${proceso.valor}" backingList="${form.comboProcesoBackingList}" estiloSelect="select_lrg" estiloOscuro="oscura" title="${proces}"/>
