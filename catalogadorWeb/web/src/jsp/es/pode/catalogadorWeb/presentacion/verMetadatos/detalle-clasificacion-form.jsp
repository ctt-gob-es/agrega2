	...
	<div class="globo_blanco_03">
		...
		<div class="fila_de_tabla_especial_03" >
  		...
  		<div class="text">
			...
			<html:select  disabled="true" name="form" property="proposito" styleClass="select_lrg3">
		...
		<logic:iterate name="taxRuta" id="taxon" indexId="t">
		 	...
		 	<c:set var="idTax" value="${taxon.id}"/>
			  ...
			  <logic:iterate name="entryTex" id="unEntryTex" indexId="u">
				...
				<div class="contenedor_izquierda_esp" >
					<div class="text2">
					<html:text readonly="true" styleClass="in_peq_02 input_mder2" property="rutaTax${i}_taxon${t}_EntryTex${u}" styleId="rutaTax${i}_taxon${t}_EntryTex${u}" value="${unEntryTex.texto}"  onblur="this.style.backgroundColor='#e1e1e1'"  titleKey="detalleclasi.taxonid"/>
					</div>
				</div>
				<div class="contenedor_izquierda_esp" >
		...
		<logic:iterate name="descripciones" id="desc" indexId="i">
			...
			<div class="contenedor_izquierda_esp" >
				<div class="text">
					...
					<html:textarea readonly="true" styleClass="input_largo_05 input_mder" property="DesTex${i}" styleId="DesTex${i }" value="${desc.texto}" onblur="this.style.backgroundColor='#e1e1e1'" cols="5" rows="4" title="${desc.texto}"/>	
				</div>
			</div>
			<div class="contenedor_izquierda_esp" >
			<div class="text">
