												...
												<div class="fila_de_tabla_especial_03" >
		  											<div class="contenedor_izquierda_esp" >
						  								<div class="text">
						  									...
						  									<html:select disabled="true" styleClass="select_lrg " name="form" property="Form${i}" value="${formato.texto}" >
											...
											<div class="fila_de_tabla_especial_03" >
			  									<div class="contenedor_izquierda_esp" >
			  										<div class="text"><label for="form" class="oculto" ><bean:message key="catalogadorAvanzado.Tecnica.SoloTamaño"/>:</label>
			  											<html:text readonly="true" styleClass="select_lrg3 input_mder" property="Tam" value="${tamanio}" styleId="Tam" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.Tamaño" />
													</div>			
												</div>
												<div class="limpiar"></div>
												<br class="oculto" />
											...
											<div class="fila_de_tabla_especial_03" >
			  									<div class="contenedor_izquierda_esp" >
			  										<div class="text">
			  											...
			  											<html:text readonly="true" styleClass="select_lrg inp_se_ie" property="Loc${j }" value="${localiza.texto}" styleId="Loc${j }" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.Localizacion" />
			  										</div>
							...
							<div class="contenedor_izquierda_esp" >
								<div class="text">
									<c:set var="tipo" value="${agregador.tipo }"/>
							  		<html:select disabled="true" styleClass="input_largo_04" name="form" property="Tipo${k }_${status.index}" value="${tipo.valor}">
							...
							<div class="contenedor_izquierda_esp" >
								<div class="text">
									<c:set var="nombre" value="${agregador.nombre }"/>
							  		<html:select disabled="true" styleClass="input_largo_04" name="form" property="Nom${k }_${status.index}" value="${nombre.valor}">
						...
						<!--  INICIO Fila de Campos   -->
							...
							<div class="contenedor_izquierda_esp" >
								<div class="text">
									...
									<html:text readonly="true" styleClass="input_largo_04" property="Mini${k }_${status.index}" value="${minimo.texto}" styleId="Mini${k }_${status.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.VersionMinima" />
								</div>
							</div>
						...
						<!--  INICIO Fila de Campos   -->
							...
							<div class="contenedor_izquierda_esp" >
								<div class="text">
									...
									<html:text readonly="true" styleClass="input_largo_04" property="Max${k }_${status.index}" value="${maximo.texto}" styleId="Max${k }_${status.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.VersionMaxima" />
								</div>
							</div>
							<div class="limpiar"></div>
							<br class="oculto" />
								...
								<div class="fila_de_tabla_especial" style="padding-left:0 !important">
									...
									<div class="contenedor_izquierda_esp" >
										<div class="text"><label for="Desc${m} }" class="oculto" ><bean:message key="catalogadorAvanzado.Tecnica.SoloNotasDeInstalacion"/>:</label>
		  									<html:textarea readonly="true" styleClass="input_largo_06 input_mder" property="InsTex${m}" value="${texto.texto}" styleId="InsTex${m}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.SoloNotasDeInstalacion" cols="5" rows="4" />
		  								</div>
									</div>
							<div class="contenedor_izquierda_esp" >
								<div class="text"><label for="Idio01" class="oculto" ><bean:message key="catalogadorAvanzado.Tecnica.SoloIdioma"/>:</label>
									<html:select disabled="true" styleClass="select_peq inp_se_ie" name="form" property="InsIdio${m}" value="${texto.idioma}" >
															...
															<div class="fila_de_tabla_especial" style="padding-left:0 !important">		
																...
																<div class="contenedor_izquierda_esp" >
																	<div class="text">
																		...
																		<html:textarea readonly="true" styleClass="input_largo_06 input_mder"  cols="5" rows="4" property="MasReqTex${p}" value="${texto.texto}" styleId="MasReqTex${p}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.SoloNotasDeInstalacion" />
																	</div>
																</div>
																...
																<div class="contenedor_izquierda_esp" >
																	<div class="text">
																		...
																		<html:select disabled="true" styleClass="select_peq inp_se_ie" name="form" property="MasReqIdio${p}" value="${texto.idioma}" >
																			<c:forEach  items="${form.comboIdiomaBackingList}" var="idiomaValor">
				                        	 									<html:option value="${ idiomaValor.value}">${idiomaValor.label}</html:option>
				    		            									</c:forEach>
																		</html:select>		
					...
					<div class="globo_blanco pos_relative" >
						<div class="globo_blanco_01">
							...
							<div class="contenedor_izquierda_esp" >
								...
								<html:text readonly="true" styleClass="in_peq input_mder acentrado" property="Dias" value="${dia}" styleId="Dias" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.Dia"/>
								</div>
		
							</div>
							<div class="contenedor_izquierda_esp" >
		  						<div class="text"><label for="HoraDur" class="rdr" ><bean:message key="catalogadorAvanzado.Tecnica.Hora"/>:</label>
								<html:text readonly="true" styleClass="in_peq input_mder acentrado" property="Horas" value="${hora}" styleId="Horas"  onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.Hora"/>
								</div>
							</div>
							<div class="contenedor_izquierda_esp" >
							...
							<div class="contenedor_izquierda_esp" >
								...
								<html:text readonly="true" styleClass="in_peq  acentrado" property="SegundosP2" value="${segundosP2}" styleId="SegundosP2"  onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.Segundos"/>
								</div>
							</div>
					...
					<div class="globo_blanco" >
						...
						<div class="fila_de_tabla_especial" style="padding-left:0 !important">
							...
							<div class="text"><label for="DesDu${j} }" class="oculto" ><bean:message key="catalogadorAvanzado.Tecnica.SoloDescripcion"/>:</label>
		  						<html:textarea readonly="true" styleClass="input_largo_06 input_mder" property="DesDurTex${j}" value="${texto.texto}" styleId="descDur${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Tecnica.SoloDescripcion" cols="5" rows="4"/>
		  						</div>
							</div>
							<div class="contenedor_izquierda_esp" >
