...
<div class="globo_gris_03">
	...
	<div class="fila_de_tabla_especial_03" >
  	...
  	<div class="text">
  		...
  		<html:select disabled="true" styleClass="select_lrg3" name="form" property="coste">
...
<div class="globo_gris_03">
	...
	<div class="fila_de_tabla_especial_03" >
  	...
  	<div class="text">
  		...
  		<html:select disabled="true" styleClass="select_lrg3" name="form" property="copyRestricciones">
				...
				<c:set var="textos" value="${descripcion.textos }"/>
					...
					<div class="fila_de_tabla_especial_03" >
  					<div class="contenedor_izquierda_esp" >
  						...
  						<html:textarea readonly="true" styleClass="input_largo_05 input_mder" property="DesTex${j}" value="${texto.texto}" styleId="Des${j}" onblur="this.style.backgroundColor='#e1e1e1'" title="${texto.texto}" cols="5" rows="4"/>
  						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
		...
		<div class="globo_gris_02">
			...
			<div class="globo_blanco pos_relative" >
				...
				<div class="fila_de_tabla_especial" style="padding-left:0 !important">
					...
					<div class="contenedor_izquierda_esp" >
						<html:select disabled="true" styleClass="select_lrg3 inp_se_ie" name="form" property="tipoAcceso">
...
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative conmargen" >
				...
				<div class="fila_de_tabla_especial" style="padding-left:0 !important">
					...
					<div class="contenedor_izquierda_esp pos_relative" >
						<div class="text">
