...
<div class="globo_gris"  >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<!-- ayuda contextual -->
			<a href="#" class="title_h3 h3flotante" title="${metametadatoSession.ayudaIdMeta}"><bean:message key="catalogadorAvanzado.Meta.Identificador"/></a>
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div id="formulario_02" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3 h3flotante" title="${metametadatoSession.ayudaContribucion}"><bean:message key="catalogadorAvanzado.Meta.Contribucion"/></a>
...
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative conmargen" id="rail2">
				<div class="globo_blanco_01" >
					<div class="globo_blanco_02">
									...
									<div class="globo_gris globito2 pos_relative" >
										<div class="globo_gris_01">
											<div class="globo_gris_02">
												...
												<a href="#" class="title_h3_b" title="${metametadatoSession.ayudaTipo}"><bean:message key="catalogadorAvanzado.Meta.Rol"/></a>
							<!--  INICIO Fila de Campos   -->
  					...
  					<div class="contenedor_izquierda_esp">
  						...
  						<cat:select name="form" property="Cont${i}_Rol" value="${rol.valor}" backingList="${form.crolBackingList}" estiloSelect="input_largo_lar" estiloOscuro="oscura" title="${tipo}" />
						</div>
					</div>
									...
									<div class="globo_gris conmargen" >
										<div class="globo_gris_01">
											<div class="globo_gris_02">
												...
												<a href="#" class="title_h3_b" title="${metametadatoSession.ayudaEntidad}"><bean:message key="catalogadorAvanzado.Meta.Identidad"/></a>
				...
				<!--  INICIO Fila de Campos   -->
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
							<html:text styleClass="input_largo_04" property="Cont${i}_Ent${j}_Nom" value="${entidad.nombre}" styleId="Cont${i}_Ent${j}_Nom" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaNombre" />
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
				...
				<!--  INICIO Fila de Campos   -->
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
						<html:text styleClass="input_largo_04" property="Cont${i}_Ent${j}_Org" value="${entidad.organizacion}" styleId="Cont${i}_Ent${j}_Org" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaOrganizacion" />
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
				...
				<!--  INICIO Fila de Campos   -->
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
						<html:text styleClass="input_largo_04" property="Cont${i}_Ent${j}_Cor" value="${entidad.correo}" styleId="Cont${i}_Ent${j}_Cor" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaCorreo" />
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
									...
									<div class="globo_gris globito2 pos_relative conmargen" id="ficha">
										<div class="globo_gris_01">
											<div class="globo_gris_02">
												...
												<a href="#" class="title_h3_b title_h3_sin" title="${metametadatoSession.ayudaFecha}"><bean:message key="catalogadorAvanzado.Meta.Fecha"/></a>
...
<div class="globo_blanco globito2" >
			...
			<c:set var="textos" value="${descripciones[i].textos}"/>
				...
				<div class="fila_de_tabla_especial" style="padding-left:0 !important">
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
							<html:textarea styleClass="input_largo_08 input_mder"  property="Cont${i}_DesFecTex${k}" styleId="Cont${i}_DesFec${k}" value="${texto.texto}" onblur="this.style.backgroundColor='#e1e1e1'" cols="5" rows="4" titleKey="catalogadorAvanzado.IntroduzcaDescripcion" />
						</div>
					</div>
					<div class="contenedor_izquierda_esp" >
						<div class="text">
...
<div class="globo_gris conmargen"  >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<!-- ayuda contextual -->
			<a href="#" class="title_h3 h3flotante" title="${metametadatoSession.ayudaEsqMeta}"><bean:message key="catalogadorAvanzado.Meta.Esquema"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
	 						<label for="Metadatos01" class="oculto" ><bean:message key="catalogadorAvanzado.Meta.Metadatos"/>:</label>
  							<html:text styleClass="select_lrg" property="Esq${estado.index}" value="${esquema.texto}" styleId="Esq${estado.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaEsquema" />
  						</div>
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3 h3flotante" title="${metametadatoSession.ayudaIdiomaCat}"><bean:message key="catalogadorAvanzado.Meta.Idioma"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
							...
							<div class="fila_de_tabla_especial_03" >
  								<div class="contenedor_izquierda_esp" >
  									<div class="text">
					  					...
					  					<cat:select name="form" property="comboIdiomaMeta" value="${form.comboIdiomaMeta}" backingList="${form.comboIdiomaMetaBackingList}" estiloSelect="select_lrg3" estiloOscuro="oscura" title="${idiom}"/>
									</div>
								</div>
								<div class="limpiar"></div>
								<br class="oculto" />
