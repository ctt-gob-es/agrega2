...
<div class="globo_blanco globito flotder">
					...
					<!--  INICIO Fila de Campos   -->
						...
						<div class="fila_de_tabla_especial_03" style="padding-left:0 !important">
							...
							<div class="contenedor_izquierda_esp">
								<div class="text">
									<html:text readonly="true" styleClass="input_medio_largo" property="IdCat${estado.index}" value="${identificador.catalogo}" styleId="Cat${estado.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Meta.Catalogo" />
								</div>
							</div>
							<div class="contenedor_izquierda_esp">
								<div class="text">
							...
							<div class="contenedor_izquierda_esp">
								<div class="text">
									<html:text readonly="true" styleClass="input_medio_largo" property="IdEnt${estado.index}" value="${identificador.entrada}" styleId="Ent${estado.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Meta.Entrada" />
								</div>
							</div>
							<div class="limpiar">
							</div><br class="oculto"/>
...
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative conmargen" id="rail">
				<div class="globo_blanco_01" >
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp">
						...
						<html:select disabled="true" styleClass="input_largo_lar" style="width:740px !important;" title="Seleccion Rol" property="Cont${i}_Rol" value="${rol.valor}">
				...
				<!--  INICIO Fila de Campos   -->
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
							<html:text readonly="true" styleClass="input_largo_04" property="Cont${i}_Ent${j}_Nom" value="${entidad.nombre}" styleId="Cont${i}_Ent${j}_Nom" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Meta.Nombre" />
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
				...
				<!--  INICIO Fila de Campos   -->
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
						<html:text readonly="true" styleClass="input_largo_04" property="Cont${i}_Ent${j}_Org" value="${entidad.organizacion}" styleId="Cont${i}_Ent${j}_Org" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Meta.Organizacion" />
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
				...
				<!--  INICIO Fila de Campos   -->
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
						<html:text readonly="true" styleClass="input_largo_04" property="Cont${i}_Ent${j}_Cor" value="${entidad.correo}" styleId="Cont${i}_Ent${j}_Cor" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Meta.Correo" />
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
...
<div class="globo_blanco globito2" >
			...
			<c:set var="textos" value="${descripciones[i].textos}"/>
				...
				<div class="fila_de_tabla_especial" style="padding-left:0 !important">
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
							<html:textarea readonly="true" styleClass="input_largo_08 input_mder"  property="Cont${i}_DesFecTex${k}" styleId="Cont${i}_DesFec${k}" value="${texto.texto}" onblur="this.style.backgroundColor='#e1e1e1'" cols="5" rows="4" titleKey="catalogadorAvanzado.Meta.Descripcion" />
						</div>
					</div>
					<div class="contenedor_izquierda_esp" >
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text">
	 						<label for="Metadatos01" class="oculto" ><bean:message key="catalogadorAvanzado.Meta.Metadatos"/>:</label>
  							<html:text readonly="true" styleClass="select_lrg" property="Esq${estado.index}" value="${esquema.texto}" styleId="Esq${estado.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Meta.Metadatos" />
  						</div>
 					</div>
			  		<div class="limpiar"></div>
					<br class="oculto" />
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="Idioma01" class="oculto" ><bean:message key="catalogadorAvanzado.Meta.SoloIdioma"/>:</label>
					  		<html:select disabled="true" styleClass="select_lrg3" name="form" property="comboIdiomaMeta">
