...
<form method="post" enctype="multipart/form-data" action="<html:rewrite action="/Relacion/ConfirmacionEliminarDatosASesion"/>" >
		...
		<div class="globo_gris_02">
			...
			<!--		INICIO CAJA TABLA		-->
				<div class="caja_tabla" >
					<display:table name="${form.tituloRelacionRowSelection}" uid="fila" requestURI="${pageContext.request.requestURL}"
		        	export="false" pagesize="8" sort="list" style="border:1;width:100%;" class="administracion_tareas"
					cellpadding="0" cellspacing="0" >
			<!--		COLUMNA DE USUARIOS		-->
					<display:column>
		            	<bean:message key="relaciones.Relacion"/> ${fila}
		        	</display:column>
...
<form method="post" enctype="multipart/form-data" action="<html:rewrite action="/Relacion/ConfirmacionEliminarCancelarEliminar"/>">
