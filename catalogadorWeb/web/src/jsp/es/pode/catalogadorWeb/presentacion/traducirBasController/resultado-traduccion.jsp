...
<form method="post" action="<html:rewrite action="/TraducirLomesBas/ResultadoTraduccionInicio" />" >
<!--  INICIO GLOBO GRIS   -->
<!--  INICIO GLOBO GRIS   -->
...
<fieldset class="tipo ft_centrada">
	<input type="submit" class="boton_125" value="<bean:message key="catalogadorBasico.Volver"/>"/>
</fieldset>
<!-- Fin Botones  -->
<br/>
<br/>
