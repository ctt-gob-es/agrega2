...
<div class="globo_gris_03">
	...
	<div class="formu" >
			...
			<!-- ayuda contextual -->
			<a href="#" class="title_h3" title="${anotacionSession.ayudaEntidad}"><bean:message key="catalogadorAvanzado.detalleAnotacion.Recurso"/></a>
		<!--  INICIO GLOBO Blanco   -->
		...
		<!--  INICIO Fila de Campos   -->
			...
			<div class="text">
				<html:text styleClass="input_largo_05"  property="Nombre" styleId="Nombre" value="${nombre }"  onblur="this.style.backgroundColor='#e1e1e1'"  titleKey="catalogadorAvanzado.IntroduzcaNombre"  />
			</div>
			</div>
			...
			<div class="contenedor_izquierda_esp" >
			<div class="text">
				<html:text styleClass="input_largo_05"  property="Organizacion" styleId="Organizacion" value="${organizacion}"  onblur="this.style.backgroundColor='#e1e1e1'"  titleKey="catalogadorAvanzado.IntroduzcaOrganizacion"  />
			</div>
			</div>
			<div class="limpiar"></div>
			<br class="oculto" />
			...
			<div class="contenedor_izquierda_esp" >
			<div class="text">
				<html:text styleClass="input_largo_05"  property="Email" styleId="Email01" value="${email}" onblur="this.style.backgroundColor='#e1e1e1'"  titleKey="catalogadorAvanzado.IntroduzcaCorreo"  />
			</div>
			</div>
			<div class="limpiar"></div>
			<br class="oculto" />
...
<div class="globo_gris_03">
	...
	<div id="formulario_02" >
		...
		<!-- ayuda contextual -->
			<a href="#" class="title_h3" title="${anotacionSession.ayudaFecha}"><bean:message key="catalogadorAvanzado.detalleAnotacion.Fecha"/></a>
		<!--  INICIO GLOBO Blanco   -->
		<div class="globo_blanco pos_relative">
		<div class="globo_blanco_01" >
		<div class="globo_blanco_02">
		...
		<!--  INICIO Descripción   -->
		<div class="globo_gris globito2 conmargen00" style="margin-left:0 !important;">
		<div class="globo_gris_01">
		<div class="globo_gris_02">
		<div class="globo_gris_03">
		<!--  INICIO Fila de Campos   -->
		...
		<!--anclas-->
			...
			<div class="fila_de_tabla_especial_02" >
 			...
 			<div class="contenedor_izquierda_esp" >
			<div class="text">
				<html:textarea styleClass="input_largo_07 input_mder"  property="DesFecTex${i}" styleId="DesFec${i}" value="${descFecha.texto}" onblur="this.style.backgroundColor='#e1e1e1'" cols="5" rows="4" titleKey="catalogadorAvanzado.IntroduzcaDescripcion" />
			</div>
			</div>
			<div class="contenedor_izquierda_esp" >
...
<div class="globo_gris_03">
	...
	<div id="formulario" >
			...
			<!-- ayuda contextual -->
			<a href="#" class="title_h3" title="${anotacionSession.ayudaDescripcion}"><bean:message key="catalogadorAvanzado.detalleAnotacion.Descripcion"/></a>
		<!--  INICIO GLOBO Blanco   -->
		...
		<!--  INICIO Fila de Campos   -->
			<logic:iterate name="descripcion" id="unaDesc" indexId="di"><!--anclas-->
				...
				<div class="text"><label for="Des01" class="oculto" ><bean:message key="catalogadorAvanzado.detalleAnotacion.SoloDescripcion"/></label>
					<html:textarea styleClass="input_largo_05 input_mder" property="DesTex${di}" styleId="DesTex${di }" value="${unaDesc.texto}" onblur="this.style.backgroundColor='#e1e1e1'" cols="5" rows="4" titleKey="catalogadorAvanzado.IntroduzcaDescripcion"/>	
				</div>
				</div>
				<div class="contenedor_izquierda_esp" >
