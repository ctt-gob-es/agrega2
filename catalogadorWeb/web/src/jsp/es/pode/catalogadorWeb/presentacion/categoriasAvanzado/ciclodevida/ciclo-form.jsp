...
<div class="globo_gris conmargen"  >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<!-- ayuda contextual -->
			<a href="#" class="title_h3" title="${cicloVidaSession.ayudaVersion}"><bean:message key="catalogadorAvanzado.Ciclo.Version"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
				...
				<c:set var="textos" value="${version.textos }"/>
					<logic:iterate id="texto" name="textos" indexId="j">
  					...
  					<div class="contenedor_izquierda_esp" >
  						...
  						<html:text styleClass="input_largo_lar input_mder" property="VerTex${j}" value="${texto.texto}" styleId="Ver${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaVersion" />
  						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
					...
					<div class="float_izquierda_n">
						<c:choose>
	                   		<c:when test="${j==0}">   
		                        ...
		                        <input class="boton_anadir cms_ie" type="submit" name="accion_Añadir Version" value="" title="<bean:message key="catalogadorAvanzado.Anadir"/>"/> 
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3" title="${cicloVidaSession.ayudaEstado}"><bean:message key="catalogadorAvanzado.Ciclo.Estatus"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative" >
				<div class="globo_blanco_01">
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="Status01" class="oculto" ><bean:message key="catalogadorAvanzado.Ciclo.SoloEstatus"/>:</label>
						  	...
						  	<cat:select name="form" property="estatus" value="${form.estatus}" backingList="${form.estatusBackingList}" estiloSelect="select_lrg3" estiloOscuro="oscura" title="${estat}"/>
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div id="formulario_02" >
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3 h3flotante" title="${cicloVidaSession.ayudaContribucion}"><bean:message key="catalogadorAvanzado.Ciclo.Contribucion"/></a> 
									...
									<div class="globo_gris globito2 pos_relative" >
										<div class="globo_gris_01">
											<div class="globo_gris_02">
												...
												<a href="#" class="title_h3_b" title="${cicloVidaSession.ayudaTipo}"><bean:message key="catalogadorAvanzado.Ciclo.Rol"/></a>
							<!--  INICIO Fila de Campos   -->
									...
									<div class="globo_gris conmargen" >
										<div class="globo_gris_01">
											<div class="globo_gris_02">
												...
												<a href="#" class="title_h3_b" title="${cicloVidaSession.ayudaEntidad}"><bean:message key="catalogadorAvanzado.Ciclo.Identidad"/></a>
...
<div class="globo_gris globito2 conmargen" id="ficha">
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			<div class="globo_gris_03"  style="padding:15px 15px 5px 15px">
			<!--  INICIO Fila de Campos   -->
			<!-- ayuda contextual-->
			<a href="#" class="title_h3_b title_h3_sin" title="${cicloVidaSession.ayudaFecha}"><bean:message key="catalogadorAvanzado.Ciclo.Fecha"/></a>
  						...
  						<div class="text">
							...
							//<![CDATA[
								...
								{ 
									...
									{ direction: 0,tweak: {x: 6, y: 0},offset: <bean:message key="catalogadorAvanzado.offset"/>,months: arrayMeses ,days: arrayDias }); 
								} ); //]]>
							</script>
  						</div>
					</div>
