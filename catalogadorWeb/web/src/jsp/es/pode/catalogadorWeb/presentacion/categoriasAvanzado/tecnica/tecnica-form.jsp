			...
			<div class="globo_gris_01">
				<div class="globo_gris_02">
					...
					<!--  INICIO CAJA DE FORMULARIO   -->
						...
						<!-- ayuda contextual -->
						<a href="#" class="title_h3 h3flotante" title="${tecnicaSession.ayudaFormato}"><bean:message key="catalogadorAvanzado.Tecnica.Formato"/></a>
		<!--  INICIO GLOBO Blanco   -->
		<!--  INICIO GLOBO Blanco   -->
<logic:iterate id="formato" name="formatos" indexId="i">
					...
					<div class="fila_de_tabla_especial_03" >
		  				<div class="contenedor_izquierda_esp" >
						  	<div class="text">
						  		...
						  		<cat:select name="form" property="Form${i}" value="${formato.texto}" backingList="${form.formatosBackingList}" estiloSelect="select_lrg" estiloOscuro="oscura" title="${format}"/>
						  	</div>
		 				</div>
		 			</div>
	...
	<div class="limpiar"></div>	
			...
			<div class="globo_gris_01">
				<div class="globo_gris_02">
					...
					<div class="formu" >
						...
						<!-- ayuda contextual -->
						<a href="#" class="title_h3" title="${tecnicaSession.ayudaTam}"><bean:message key="catalogadorAvanzado.Tecnica.Tamaño"/></a>
		<!--  INICIO GLOBO Blanco   -->
		<!--  INICIO GLOBO Blanco   -->
						...
						<div class="globo_blanco_01">
							<div class="globo_blanco_02">
		  					...
		  					<div class="contenedor_izquierda_esp" >
		  						...
		  						<html:text styleClass="select_lrg3 input_mder" property="Tam" value="${tamanio}" styleId="Tam" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaTamano" />
								</div>
			...
			<div class="globo_gris_01">
				<div class="globo_gris_02">
					...
					<div class="formu" >
						...
						<!-- ayuda contextual -->
						<a href="#" class="title_h3 h3flotante" title="${tecnicaSession.ayudaLoc}"><bean:message key="catalogadorAvanzado.Tecnica.Localizacion"/></a>
					...
					<div class="fila_de_tabla_especial_03" >
		  					<div class="contenedor_izquierda_esp" >
		  						<div class="text">
		  							...
		  							<html:text styleClass="select_lrg inp_se_ie" property="Loc${j }" value="${localiza.texto}" styleId="Loc${j }" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaLocalizacion" />
		  						</div>
			...
			<div class="globo_gris_01">
				<div class="globo_gris_02">
					...
					<div id="formulario_02" >
							...
							<!-- ayuda contextual -->
						<a href="#" class="title_h3 h3flotante" title="${tecnicaSession.ayudaRequisitos}"><bean:message key="catalogadorAvanzado.Tecnica.Requerimientos"/></a>
		...
		<!--  INICIO GLOBO Blanco   -->
		<!--  INICIO GLOBO Blanco   -->
					<div class="globo_blanco conmargen" id="rail">
						<div class="globo_blanco_01" >
							<div class="globo_blanco_02">
								<div class="globo_blanco_03">
									
									<a href="#" class="title_h3_b title_h3_sin" title="${tecnicaSession.ayudaAgregadoror }"><bean:message key="catalogadorAvanzado.Tecnica.AgregadorOR"/></a>
									<!-- ponemos display:none en lugar de visibility:hidden; para que no lo muestre y no ocupe espacio -->
									<c:forEach items="${requerimientos.agregadoresOR }" var="agregador" varStatus="status">
										<cat:select name="form" estilo="display:none;" property="HNom${k }_${status.index}" value="${nombre.valor}" backingList="${form.comboNombreBackingList}" estiloSelect="input_largo_04" estiloOscuro="oscura" title=""/>								
										<!--anclas-->
										<c:choose>
									...
									<!--  INICIO GLOBO GRIS   -->
									<!--  INICIO GLOBO GRIS   -->
											<div class="globo_gris globito5 flotder conmargen pos_relative"  >
												<div class="globo_gris_01">
													<div class="globo_gris_02">
														<div class="globo_gris_03">
									<!--  INICIO Fila de Campos   -->
							...
							<div class="contenedor_izquierda_esp" >
								<div class="text">
									...
									<cat:select name="form" onchange="nombreRequisitos('Nom${k }_${status.index}','Tipo${k }_${status.index}')" property="Tipo${k }_${status.index}" value="${tipo.valor}" backingList="${form.comboTipoBackingList}" estiloSelect="input_largo_04" estiloOscuro="oscura" title="${tipe}"/>								
						...
						<!--  INICIO Fila de Campos   -->
							...
							<div class="contenedor_izquierda_esp" >
								<div class="text">
									...
									<cat:select name="form" property="Nom${k }_${status.index}" value="${nombre.valor}" backingList="${form.comboNombreBackingList}" estiloSelect="input_largo_04" estiloOscuro="oscura" title="${nombr}"/>
						...
						<!--  INICIO Fila de Campos   -->
							...
							<div class="contenedor_izquierda_esp" >
								<div class="text">
									...
									<html:text styleClass="input_largo_04" property="Mini${k }_${status.index}" value="${minimo.texto}" styleId="Mini${k }_${status.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaMinima" />
								</div>
							</div>
						...
						<!--  INICIO Fila de Campos   -->
							...
							<div class="contenedor_izquierda_esp" >
								<div class="text">
									...
									<html:text styleClass="input_largo_04" property="Max${k }_${status.index}" value="${maximo.texto}" styleId="Max${k }_${status.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaMaxima" />
								</div>
							</div>
							<div class="limpiar"></div>
							<br class="oculto" />
		...
		<div class="globo_gris conmargen" >
			<div class="globo_gris_01">
				<div class="globo_gris_02">
					...
					<!-- ayuda contextual -->
					<a href="#" class="title_h3" title="${tecnicaSession.ayudaPautasInst}"><bean:message key="catalogadorAvanzado.Tecnica.NotasDeInstalacion"/></a>                     				
								...
								<div class="fila_de_tabla_especial" style="padding-left:0 !important">
									...
									<div class="contenedor_izquierda_esp" >
										<div class="text"><label for="Desc${m} }" class="oculto" ><bean:message key="catalogadorAvanzado.Tecnica.SoloNotasDeInstalacion"/>:</label>
		  									<html:textarea styleClass="input_largo_06 input_mder" property="InsTex${m}" value="${texto.texto}" styleId="InsTex${m}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaDescripcion" cols="5" rows="4"/>
		  								</div>
									</div>
							<div class="contenedor_izquierda_esp" >
								<div class="text">
				...
				<div class="globo_gris_02">
					...
					<!--  INICIO CAJA DE FORMULARIO   -->
						<div id="formulario" >
							...
							<!-- ayuda contextual -->
							<a href="#" class="title_h3" title="${tecnicaSession.ayudaOtrosReq}"><bean:message key="catalogadorAvanzado.Tecnica.MasRequerimientos"/></a>                     				
								<!--  INICIO GLOBO Blanco   -->
								<!--  INICIO GLOBO Blanco   -->
									<div class="globo_blanco" >
										<div class="globo_blanco_01">
															...
															<div class="fila_de_tabla_especial" style="padding-left:0 !important">		
																...
																<div class="contenedor_izquierda_esp" >
																	<div class="text">
																		...
																		<html:textarea styleClass="input_largo_06 input_mder" property="MasReqTex${p}" value="${texto.texto}" styleId="MasReqTex${p}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaDescripcion" cols="5" rows="4"/>
																	</div>
																</div>
		...
		<!--  INICIO GLOBO GRIS  DURACION  -->
		<div class="globo_gris conmargen" id="ficha">
			<div class="globo_gris_01">
				<div class="globo_gris_02">
					<div class="globo_gris_03">
					<!--  INICIO CAJA DE FORMULARIO   -->
					...
					<!-- ayuda contextual -->
						<a href="#" class="title_h3" title="${tecnicaSession.ayudaDuracion}"><bean:message key="catalogadorAvanzado.Tecnica.Duracion"/></a>                     				
					...
					<div class="globo_blanco" >
						...
						<div class="fila_de_tabla_especial" style="padding-left:0 !important">
							...
							<div class="text"><label for="DesDu${j} }" class="oculto" ><bean:message key="catalogadorAvanzado.Tecnica.SoloDescripcion"/>:</label>
		  						<html:textarea styleClass="input_largo_06 input_mder" property="DesDurTex${j}" value="${texto.texto}" styleId="descDur${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaDescripcion" cols="5" rows="4"/>
		  						</div>
							</div>
							<div class="contenedor_izquierda_esp" >
