...
<form method="post" action="<html:rewrite action="/CatalogadorBasico/ImportarLomesSubmit"/>?progressMonitor=myProgressMonitor" enctype="multipart/form-data" onsubmit="startLoading()">
