				...
				<c:set var="textos" value="${version.textos }"/>
					<logic:iterate id="texto" name="textos" indexId="j">
  					...
  					<div class="contenedor_izquierda_esp" >
  						...
  						<html:text readonly="true" styleClass="input_largo_lar input_mder" property="VerTex${j}" value="${texto.texto}" styleId="Ver${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Ciclo.SoloVersion" />
  						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
					...
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp" >
  						<div class="text"><label for="Status01" class="oculto" ><bean:message key="catalogadorAvanzado.Ciclo.SoloEstatus"/>:</label>
						  	<html:select disabled="true" styleClass="select_lrg3" name="form" property="estatus">
...
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative conmargen" id="rail2">
				<div class="globo_blanco_01" >
					<div class="globo_blanco_02">
  					...
  					<div class="contenedor_izquierda_esp">
						...
						<html:select disabled="true" styleClass="input_largo_lar" style="width:760px !important;" title="Seleccion Rol" property="Cont${i}_Rol" value="${rol.valor}">
				...
				<!--  INICIO Fila de Campos   -->
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
							<html:text readonly="true" styleClass="input_largo_04" property="Cont${i}_Ent${j}_Nom" value="${entidad.nombre}" styleId="Cont${i}_Ent${j}_Nom" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Ciclo.Nombre" />
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
				...
				<!--  INICIO Fila de Campos   -->
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
						<html:text readonly="true" styleClass="input_largo_04" property="Cont${i}_Ent${j}_Org" value="${entidad.organizacion}" styleId="Cont${i}_Ent${j}_Org" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Ciclo.Organizacion" />
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
				...
				<!--  INICIO Fila de Campos   -->
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
						<html:text readonly="true" styleClass="input_largo_04" property="Cont${i}_Ent${j}_Cor" value="${entidad.correo}" styleId="Cont${i}_Ent${j}_Cor" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.Ciclo.Correo" />
						</div>
					</div>
					<div class="limpiar"></div>
					<br class="oculto" />
...
<div class="globo_blanco globito2" >
			...
			<c:set var="textos" value="${descripciones[i].textos}"/>
				...
				<div class="fila_de_tabla_especial" style="padding-left:0 !important">
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
							<html:textarea readonly="true" styleClass="input_largo_08 input_mder"  property="Cont${i}_DesFecTex${k}" styleId="Cont${i}_DesFec${k}" value="${texto.texto}" onblur="this.style.backgroundColor='#e1e1e1'" cols="5" rows="4" titleKey="catalogadorAvanzado.Ciclo.Descripcion" />
						</div>
					</div>
					<div class="contenedor_izquierda_esp" >
