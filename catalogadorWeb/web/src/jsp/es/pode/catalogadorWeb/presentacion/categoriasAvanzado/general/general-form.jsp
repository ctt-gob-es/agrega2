...
<form method="post" action="<html:rewrite action="/General/GeneralFormSubmit"/>" >
...
<div class="globo_gris" >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div id="formulario" >
			<!-- ayuda contextual -->
			<a href="#" class="title_h3 h3flotante" title="${generalSession.ayudaIdentificador}"><bean:message key="catalogadorAvanzado.General.Identificador"/></a>
			...
			<div class="globo_blanco globito flotder" >
				...
				<div class="fila_de_tabla_especial_03" style="padding-left:0 !important">
					...
					<div class="contenedor_izquierda_esp" >
						<div class="text">
						<html:text styleClass="input_medio_largo" property="IdCat${estado.index}" value="${identificador.catalogo}" styleId="Cat${estado.index}" onblur="this.style.backgroundColor='#e1e1e1'"  titleKey="catalogadorAvanzado.IntroduzcaCatalogo" />
						</div>
					</div>
					<div class="contenedor_izquierda_esp">
					...
					<div class="contenedor_izquierda_esp">
						<div class="text">
						<html:text styleClass="input_medio_largo" property="IdEnt${estado.index}" value="${identificador.entrada}" styleId="Ent${estado.index}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaEntrada" />
						</div>
					</div>
					<div class="limpiar">
					</div><br class="oculto"/>
					...
					<c:choose>
                        <c:when test="${estado.index==0}">   
	                        ...
	                        <span class="flotder enlace_anadir_02">
	                        	<input class="boton_anadir flotder" type="submit" name="accion_Añadir Identificador" value="aa" title="<bean:message key="catalogadorAvanzado.Anadir"/>"/> 
	                        </span>
                        </c:when>
                        <c:otherwise>
                        	<span class="oculto">-</span> 
					...
					<c:choose>
                        <c:when test="${longitud>1}">   
	                        ...
	                        <input class="boton_eliminar flotder" type="submit" name="accion_Eliminar Identificador-${estado.index}" value="aa" title="<bean:message key="catalogadorAvanzado.Eliminar"/>"/> 
	                        </span>
                        </c:when>
                        <c:otherwise>
                        <span class="oculto">-</span> 
...
<div class="globo_gris conmargen"  >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="formu" >			
			<!-- ayuda contextual -->
			<a href="#" class="title_h3" title="${generalSession.ayudaTitulo}"><bean:message key="catalogadorAvanzado.General.Titulo"/></a>
<!--  INICIO GLOBO Blanco   -->
<!--  INICIO GLOBO Blanco   -->
				...
				<c:set var="textos" value="${titulo.textos }"/>
					...
					<div class="fila_de_tabla_especial_03" >
  					<div class="contenedor_izquierda_esp" >
  						...
  						<html:text styleClass="input_largo_lar" property="TitTex${j}" value="${texto.texto}" styleId="Tit${j}" onblur="this.style.backgroundColor='#e1e1e1'" maxlength="200" titleKey="catalogadorAvanzado.IntroduzcaTitulo" />
  						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
...
<div class="globo_gris conmargen"  >
	...
	<div class="formu" >
			...
			<!-- ayuda contextual -->
			<a href="#" class="title_h3 h3flotante" title="${generalSession.ayudaIdioma}"><bean:message key="catalogadorAvanzado.General.Idioma"/></a>
		  							...
		  							<div class="contenedor_izquierda_esp">
			  							<div class="text">
			  								<label for="form" class="oculto" ><bean:message key="catalogadorAvanzado.General.SoloIdioma"/>:</label>
												...
												<cat:select name="form" property="Idio${i}" value="${idioma.texto}" title="${idio}" backingList="${form.idiomasBackingList}" estiloSelect="select_lrg inp_se_ie " estiloOscuro="oscura"/>
										</div>
									</div>
									<div class="limpiar">
									</div><br class="oculto"/>
						...
						<div class="globo_gris_02">
							<div class="globo_gris_03">	<!--  INICIO CAJA DE FORMULARIO   -->
								<div class="formu">
									...
									<!-- ayuda contextual -->
									<a href="#" class="title_h3 h3flotante" title="${generalSession.ayudaDescCont}"><bean:message key="catalogadorAvanzado.General.Descripcion"/></a>
											...
											<c:set var="indice" value="${j + longDescripcionAnterior}"/>
													<div class="fila_de_tabla_especial_03">
														<div class="contenedor_izquierda_esp">
															...
															<html:textarea readonly="${caracteristica!=null && !caracteristica.vacio }" styleClass="input_largo_lar input_mder" property="Des${i}_Tex${j}" value="${contenido.texto}" styleId="Des${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaDescripcion"  cols="5" rows="4"  />
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
...
<!--  INICIO Fila de Campos - Resolución  -->
		<div class="contenedor_izquierda_esp" style="width:170px;margin-top:5px">
			<div class="text">
...
<!--  INICIO Fila de Campos - dimension  -->
		<div class="contenedor_izquierda_esp" style="width:170px;">
			<div class="text">
					...
					<div class="globo_gris_01">
						<div class="globo_gris_02">
							<div class="globo_gris_03">	<!--  INICIO CAJA DE FORMULARIO   -->
								<div class="formu">
										<!-- ayuda contextual -->
										<a href="#" class="title_h3 h3flotante" title="${generalSession.ayudaPalClave}"><bean:message key="catalogadorAvanzado.General.PalabraClave"/></a>
										...
										<logic:iterate id="contenido" name="textos" indexId="j">
											...
											<c:set var="indice" value="${j + longPalabrasAnterior}"/>
													<div class="fila_de_tabla_especial_03">
														...
														<html:text styleClass="input_largo_03 input_mder" property="Pcla${i}_Tex${j}" value="${contenido.texto}" styleId="PalClave${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaPalabraClave" />
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
						...
						<div class="globo_gris_02">
							<div class="globo_gris_03">	<!--  INICIO CAJA DE FORMULARIO   -->
								<div class="formu">
										...
										<!-- ayuda contextual -->
										<a href="#" class="title_h3 h3flotante" title="${generalSession.ayudaAmbito}"><bean:message key="catalogadorAvanzado.General.Ambito"/></a>
								...
								<!--  INICIO Fila de Campos   -->
														...
														<div class="contenedor_izquierda_esp">
															<div class="text">
																<label for="Ambito01" class="oculto" ><bean:message key="catalogadorAvanzado.General.SoloAmbito"/>:</label>
	  															<html:text styleClass="input_largo_03 input_mder" property="Amb${i}_Tex${j}" value="${contenido.texto}" styleId="Ambito${i}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaAmbito" />
															</div>
														</div>
														<div class="contenedor_izquierda_esp">
															<div class="text">
										...
										<c:set var="longAmbitoAnterior" value="${ longAmbito + longAmbitoAnterior }"/>
				    <!--  Fin Fila de Campos   -->
					<!--  Fin Fila de Campos   -->
												</div>
											</div>
...
<div class="globo_gris_03">
	...
	<div class="formu" >
		...
		<!-- ayuda contextual -->
		<a href="#" class="title_h3" title="${generalSession.ayudaEstructura}"><bean:message key="catalogadorAvanzado.General.Estructura"/></a>
	<!--  INICIO GLOBO Blanco   -->
	<div class="globo_blanco pos_relative" >
	<div class="globo_blanco_01">
	<div class="globo_blanco_02">
	...
	<div class="fila_de_tabla_especial_03" >
  	<div class="contenedor_izquierda_esp" >
  		<div class="text">
			...
			<cat:select name="form" property="estructura" value="${form.estructura}" backingList="${form.estructuraBackingList}" estiloSelect="select_lrg3" estiloOscuro="oscura" title="${estruc}"/>
...
<div class="globo_gris_03">
	...
	<div class="formu" >
		...
		<!-- ayuda contextual -->
		<a href="#" class="title_h3" title="${generalSession.ayudaNivelAgregacion}"><bean:message key="catalogadorAvanzado.General.NivelAgregacion"/></a>
	<!--  INICIO GLOBO Blanco   -->
	<div class="globo_blanco pos_relative " >
	<div class="globo_blanco_01">
	<div class="globo_blanco_02">
	...
	<div class="fila_de_tabla_especial_03" >
  	...
  	<div class="text">
  		...
  		<cat:select name="form" property="nivelAgregacion" value="${form.nivelAgregacion}" backingList="${form.nivelAgregacionBackingList}" estiloSelect="select_lrg3" estiloOscuro="oscura" title="${nivel}"/>
	</div>
	</div>
	<div class="limpiar"></div>
	<br class="oculto" />
...
<fieldset class="tipo ft_centrada"> 
	...
	<input class="boton_125" id="reset_but" type="submit" name="accion" value="<bean:message key="general.Reset"/>" /><br />

	<input class="boton_125_de_2"  type="submit" name="accion" value="<bean:message key="general.Aceptar"/>" />
	<input class="boton_125_de_2_izq"  type="submit"  name="accion"  value="<bean:message key="general.Cancelar"/>" />
	<input class="boton_125"  type="submit"  name="accion" value="<bean:message key="general.Validar"/>" />
</fieldset>
