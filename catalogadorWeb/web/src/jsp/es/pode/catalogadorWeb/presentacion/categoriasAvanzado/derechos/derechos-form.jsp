...
<div class="globo_gris_03">
	...
	<div class="formu" >
		...
		<!-- ayuda contextual -->
			<a href="#" class="title_h3" title="${derechoSession.ayudaCoste}"><bean:message key="catalogadorAvanzado.Derechos.Coste"/></a>
	<!--  INICIO GLOBO Blanco   -->
	...
	<div class="fila_de_tabla_especial_03" >
  	...
  	<div class="text">
  		...
  		<cat:select name="form" property="coste" value="${form.coste}" backingList="${form.costeBackingList}" estiloSelect="select_lrg3"  estiloOscuro="oscura" title="${cost}"/>
...
<div class="globo_gris_03">
	...
	<!-- ayuda contextual -->
	<a href="#" class="title_h3" title="${derechoSession.ayudaDerechoAutor}"><bean:message key="catalogadorAvanzado.Derechos.CopyrightyOtrasRestricciones"/></a>
	...
	<div class="fila_de_tabla_especial_03" >
  	...
  	<div class="text">
  		...
  		<cat:select name="form" property="copyRestricciones" value="${form.copyRestricciones}" backingList="${form.copyRestriccionesBackingList}" estiloSelect="select_lrg3" estiloOscuro="oscura" title="${copy}"/>
...
<div class="globo_gris_03">
	...
	<!-- ayuda contextual -->
	<a href="#" class="title_h3" title="${derechoSession.ayudaDescCondUso}"><bean:message key="catalogadorAvanzado.Derechos.Descripcion"/></a>
	<!--  INICIO GLOBO Blanco   -->
				...
				<c:set var="textos" value="${descripcion.textos }"/>
					...
					<div class="fila_de_tabla_especial" style="padding-left:0 !important">
  					<div class="contenedor_izquierda_esp" >
  						...
  						<html:textarea styleClass="input_largo_05 input_mder" property="DesTex${j}" value="${texto.texto}" styleId="Des${j}" onblur="this.style.backgroundColor='#e1e1e1'" titleKey="catalogadorAvanzado.IntroduzcaDescripcion" cols="5" rows="4"/>
  						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
						<div class="text">
...
<div class="globo_gris conmargen" >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<!-- ayuda contextual -->
			<a href="#" class="title_h3 pos_relative" title="${derechoSession.ayudaAcceso}"><bean:message key="catalogadorAvanzado.Derechos.Acceso"/></a>	
			<!--  INICIO GLOBO Blanco   -->
			<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative" >
				<div class="globo_blanco_01">
				...
				<div class="fila_de_tabla_especial" style="padding-left:0 !important">
  					<div class="contenedor_izquierda_esp">
  						<div class="text">
  							<a href="#" class="tipo_label" title="${derechoSession.ayudaTipo}">
	  							<label for="Tipoacceso" ><bean:message key="catalogadorAvanzado.Derechos.SoloTipoAcceso"/>:</label>
	  						</a>
  						</div>
...
<!--  INICIO GLOBO Blanco   -->
			<div class="globo_blanco pos_relative conmargen" >
				...
				<div class="fila_de_tabla_especial" style="padding-left:0 !important">
  					<div class="contenedor_izquierda_esp">
  						<div class="text">
  							<a href="#" class="tipo_label" title="${derechoSession.ayudaAmbito}">
	  							<label ><bean:message key="catalogadorAvanzado.Derechos.SoloAmbitoAcceso"/>:</label>
	  						</a>
  						</div>
 					</div>
					<div class="contenedor_izquierda_esp" >
						<div class="text">
						<div class="caja_de_tabla_invisible pos_relative" id="cata">
