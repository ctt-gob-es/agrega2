...
import es.pode.catalogadorWeb.presentacion.TecnicaSession;
...
//	          DURACION
				...
				//String anyos=""; String meses="";String dias="";String horas="";String minutos="";String segundosP1="";String segundosP2="";
	            TecnicaSession tecnicaSession = this.getTecnicaSession(request);
				if ((catalogadorAvSession.getMDSesion().getTechnical() != null) && (catalogadorAvSession.getMDSesion().getTechnical().getDuracion() !=null)){
					
					DuracionVO duracion = catalogadorAvSession.getMDSesion().getTechnical().getDuracion();
					if (duracion!=null && duracion.getDuracion()!=null)
						descifrarDuration(duracion,tecnicaSession);
				}
				form.setAnyo(tecnicaSession.getAnyos());
				form.setMes(tecnicaSession.getMeses());
				form.setDia(tecnicaSession.getDias());
				form.setHora(tecnicaSession.getHoras());
				form.setMinutos(tecnicaSession.getMinutos());
				form.setSegundosP1(tecnicaSession.getSegundosP1());
				form.setSegundosP2(tecnicaSession.getSegundosP2());
...
//	          si tecnica era null en el objeto de session lo dejamos a null
	            ...
	            cargarAyuda(tecnicaSession, (Locale) request.getSession().getAttribute(ConstantesAgrega.DEFAULT_LOCALE));
			...
			saveErrorMessage(request, " Error en catalogadorWeb, categoría Tecnica, metodo cargarDatosTecnica ");
    ...
    public final void anadirFormato(ActionMapping mapping, es.pode.catalogadorWeb.presentacion.categoriasAvanzado.tecnica.AnadirFormatoForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    	try{
        	...
        	int longitudDecDuracion=((DescripcionVO[])form.getDescripcionDuracionAsArray())[0].getTextos().length;
    	  	...
    	  	//borramos de session
    	  	request.getSession().removeAttribute(TecnicaSession.SESSION_KEY);
    	  	...
    	  	//recogemos el valor de session
    	  	TecnicaSession tecnicaSession = this.getTecnicaSession(request);

    	  	//formatos
           //form.setFormatosAsArray(formatos); 
           form.setFormatosAsArray(tecnicaSession.getFormatos().toArray());
           //Tamaño
           //form.setTamanio(tamaño);
           form.setTamanio(tecnicaSession.getTamanio());
           //localizacion
           //form.setLocalizacionAsArray(localizaciones);
           form.setLocalizacionAsArray(tecnicaSession.getLocalizaciones().toArray());
           //requeriminetos
           //form.setRequerimientoAsArray(requisitos); 	
           form.setRequerimientoAsArray(tecnicaSession.getRequisitos().toArray());
           //notas de instalacion
           //form.setDescripcionInstalacionAsArray(notasDeInstalacion); 
           form.setDescripcionInstalacionAsArray(tecnicaSession.getNotasDeInstalacion().toArray());
           //mas requerimientos
           //form.setDescripcionRequerimientosAsArray(masRequisitos);
           form.setDescripcionRequerimientosAsArray(tecnicaSession.getMasRequisitos().toArray());
           //form.setDescripcionDuracionAsArray(duracionDesc);
           form.setDescripcionDuracionAsArray(tecnicaSession.getDuracionDesc().toArray());
           //form.setAnyo(anyos);
           form.setAnyo(tecnicaSession.getAnyos());
           //form.setMes(meses);
           form.setMes(tecnicaSession.getMeses());
           ...
           form.setSegundosP2(tecnicaSession.getSegundosP2());
        	   ...
        	   tecnicaSession.setFormatos(Arrays.asList(newAFormatos));
			...
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo anadirFormato ");
		}        	
...
//         posicion del formato que se quiere eliminar   
           ...
           for (int i = 0; i<nuevoFormatos.length;i++){
 	     	...
 	     	//actualizamos el elemento de session
 	     	tecnicaSession.setFormatos(Arrays.asList(nuevoFormatos));
  	     	cargarAyuda(tecnicaSession, (Locale) request.getSession().getAttribute(ConstantesAgrega.DEFAULT_LOCALE));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo eliminarFormato ");
		}     
     }
    ...
    public final void anadirLocalizacion(ActionMapping mapping, es.pode.catalogadorWeb.presentacion.categoriasAvanzado.tecnica.AnadirLocalizacionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    	try{
    	   ...
    	   //actualizamos la session 
    	   tecnicaSession.setLocalizaciones(Arrays.asList(newALocalizadores));
    	   ...
    	   cargarAyuda(tecnicaSession, (Locale) request.getSession().getAttribute(ConstantesAgrega.DEFAULT_LOCALE));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo anadirLocalizacion ");
		}     
     }
...
//         posicion de localizacion que se quiere eliminar   
    		...
    		//actualizamos la session
 	     	tecnicaSession.setLocalizaciones(Arrays.asList(nuevoLocalizacion));
 	     	cargarAyuda(tecnicaSession, (Locale) request.getSession().getAttribute(ConstantesAgrega.DEFAULT_LOCALE));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo elimianrLocalizacion ");
		}     
     }
    ...
    public final void anadirRequerimiento(ActionMapping mapping, es.pode.catalogadorWeb.presentacion.categoriasAvanzado.tecnica.AnadirRequerimientoForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    	try{
    	   ...
    	   tecnicaSession.setRequisitos(Arrays.asList(newARequisitos));
    	  ...
    	  cargarAyuda(tecnicaSession, (Locale) request.getSession().getAttribute(ConstantesAgrega.DEFAULT_LOCALE));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo anadirRequerimiento ");
		}     
     }
...
//         posicion de requerimiento que se quiere eliminar   
            ...
            int posicionInt = Integer.parseInt(posicion);
 	     	...
 	     	//actualizamos session
 	     	tecnicaSession.setRequisitos(Arrays.asList(nuevoRequisito));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo eliminarRequerimiento ");
		}     
     }
...
//    	  form.setFormatosAsArray(formatos); 
           ...
           int posicionInt = Integer.parseInt(posicion);
        	...
        	//actualizamos session
    		tecnicaSession.setMasRequisitos(Arrays.asList(reqArray));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo anadirAgregador ");
		}     
     }
    ...
    public final void eliminarAgregador(ActionMapping mapping, es.pode.catalogadorWeb.presentacion.categoriasAvanzado.tecnica.EliminarAgregadorForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    	try{
           ...
           int posicionExtInt = Integer.parseInt(posicionExt);//Agregador
	    	...
	    	RequisitoVO[] requisitos = (RequisitoVO[]) tecnicaSession.getRequisitos()
				.toArray(new RequisitoVO[tecnicaSession.getRequisitos().size()]);
        	...
        	//actualizamos session
    		tecnicaSession.setMasRequisitos(Arrays.asList(aRequisitos));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo eliminarAgregador ");
		}     
     }
    ...
    public final void eliminarInstalacion(ActionMapping mapping, es.pode.catalogadorWeb.presentacion.categoriasAvanzado.tecnica.EliminarInstalacionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
		try{
           ...
           //posicion de la pauta que se quiere eliminar   
        	...
        	//actualizamos la session
    		tecnicaSession.setNotasDeInstalacion(Arrays.asList(aPautas));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo eliminarInstalacion ");
		}     
     }
...
//    	  form.setFormatosAsArray(formatos); 
			...
			//actualizamos la session
			tecnicaSession.setMasRequisitos(Arrays.asList(aMasReq));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo anadirMasRequerimientos ");
		}     
     }
    	...
    	try{
           ...
           //posicion del reque que se quiere eliminar   
             ...
             int posicionInt = Integer.parseInt(posicion);
 	     	...
 	     	//actualizar session
 	     	tecnicaSession.setMasRequisitos(Arrays.asList(aOtros));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo eliminarMasRequerimientos ");
		}     
     }
    ...
    public final void anadirDescDuracion(ActionMapping mapping, es.pode.catalogadorWeb.presentacion.categoriasAvanzado.tecnica.AnadirDescDuracionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
       ...
       //formatos
		...
		//actualizamos session
		tecnicaSession.setDuracionDesc(Arrays.asList(aDuDesc));
		...
		cargarAyuda(tecnicaSession, (Locale) request.getSession().getAttribute(ConstantesAgrega.DEFAULT_LOCALE));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo anadirDescDuracion ");
		}     
     }
       ...
       //formatos
    	...
    	LangStringVO[] nuevolangString = new LangStringVO[langString.length -1];
     	...
     	cargarAyuda(tecnicaSession, (Locale) request.getSession().getAttribute(ConstantesAgrega.DEFAULT_LOCALE));
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo eliminarDescDuracion ");
		}     
     }
...
//    	Guardamos los cambios en el form obtenido de request.getSession.getAttribute("form") para que en caso de faltar
    	...
    	FormatoVO[] formatos = (FormatoVO[])tecnicaSession.getFormatos()
    			.toArray(new FormatoVO[tecnicaSession.getFormatos().size()]);
    	tec.setFormatos(formatos);
    	TamanioVO tam=new TamanioVO();
    	tam.setTexto(tecnicaSession.getTamanio());
    	tec.setTamanio(tam);
    	LocalizacionVO[]localizaciones = (LocalizacionVO[])tecnicaSession.getLocalizaciones()
    			.toArray(new LocalizacionVO[tecnicaSession.getLocalizaciones().size()]);
    	tec.setLocalizaciones(localizaciones);
    	RequisitoVO[] requisitos = (RequisitoVO[]) tecnicaSession.getRequisitos()
    			.toArray(new RequisitoVO[tecnicaSession.getRequisitos().size()]);
    	tec.setRequisitos(requisitos);
    	PautasInstalacionVO[] notasDeInstalacion = (PautasInstalacionVO[])tecnicaSession.getNotasDeInstalacion()
    			.toArray(new PautasInstalacionVO[tecnicaSession.getNotasDeInstalacion().size()]);
    	tec.setPautasInstalacion(notasDeInstalacion[0]);
    	OtrosRequisitosVO[] masRequisitos = (OtrosRequisitosVO[]) tecnicaSession.getMasRequisitos()
    			.toArray(new OtrosRequisitosVO[tecnicaSession.getMasRequisitos().size()]);
    	tec.setOtrosRequisitos(masRequisitos[0]);
    	tec.setDuracion(tecnicaSession.getDuracion());
...
//		Collection errores=new ArrayList();
        ...
        if(tec.getDuracion()!=null){
        	if((tec.getDuracion().getDescripcion()!=null)&&(tec.getDuracion().getDescripcion().getTextos()!=null)&&(tec.getDuracion().getDescripcion().getTextos().length>0)){
		        for(i=0;i<tec.getDuracion().getDescripcion().getTextos().length && todosVacios;i++)
		        {
                    ...
                    if((descripcion!=null && !descripcion.trim().equals("")) || (idioma != null && !idioma.trim().equals("")))
                    {
                         todosVacios=false;
                    }
		        }
        ...
        boolean duracionConLetras=false; //para detectar que existen letras en vez de números
        String anyos = tecnicaSession.getAnyos();
        String meses = tecnicaSession.getMeses();
        String dias = tecnicaSession.getDias();
        String horas = tecnicaSession.getHoras();
        String minutos = tecnicaSession.getMinutos();
        String segundosP1 = tecnicaSession.getSegundosP1();
        String segundosP2 = tecnicaSession.getSegundosP2();
        ...
        if(   (anyos!=null && !anyos.trim().matches("[0-9]*")) || 
                (meses!=null && !meses.trim().matches("[0-9]*")) ||
                (dias!=null && !dias.trim().matches("[0-9]*")) ||
                (horas!=null && !horas.trim().matches("[0-9]*")) ||
                (minutos!=null && !minutos.trim().matches("[0-9]*")) ||
                (segundosP1!=null && !segundosP1.trim().matches("[0-9]*")) ||
                (segundosP2!=null && !segundosP2.trim().matches("[0-9]*")))
          {
        ...
        if(duracionConLetras){
        	mensajes.add(datosResources.getString("CAV.4.7.5"));//La duraci&oacute;n debe indicarse con n&uacute;meros
        }
        ...
        //TAMAÑO
        String tamaño = tecnicaSession.getTamanio();
        if(tamaño!=null && !tamaño.equals("")){
	        try{
	        	Long bigTamaño=new Long(tamaño);
	        	error = datosResources.getString("CAV.4.1");
	        	if(bigTamaño.intValue()<0 && !mensajes.contains(error)){
	        		mensajes.add(datosResources.getString("CAV.4.1"));//Meterle la validación del integer no negativo
	        	}
	        }catch(Exception e){
	        	if(!mensajes.contains(datosResources.getString("CAV.4.1")))
	        		mensajes.add(datosResources.getString("CAV.4.1"));//Meterle la validación del integer no negativo
	        }
        }
	...
	//    	Guardamos los cambios en el form obtenido de request.getSession.getAttribute("form") para que en caso de faltar
	    	...
	    	DescripcionVO[] duracionDesc = (DescripcionVO[])tecnicaSession.getDuracionDesc()
	    				.toArray(new DescripcionVO[tecnicaSession.getDuracionDesc().size()]);
	...
	//		Comprobamos si los campos ha sido rellenados adecuadamente
			...
			if((localizaciones!=null)&&(localizaciones.length!=0)){
				ArrayList lista=new ArrayList();
				for(int i=0;i<localizaciones.length;i++){
					LocalizacionVO loca=localizaciones[i];
				...
				if(requisitos.length==1&&agregadores.length==1 && agregadores[0].getNombre().getValor().equals("")&& 
					...
					for(int i=0;i<requisitos.length;i++){
						if(requisitos!=null){
							...
							RequisitoVO lRequi=requisitos[i];
			...
			if(notasDeInstalacion!=null && notasDeInstalacion.length!=0){
				PautasInstalacionVO pauta=notasDeInstalacion[0];
				LangStringVO[] textos=pauta.getTextos();
				ArrayList lista=new ArrayList();
				for(int j=0;j<textos.length;j++){
					LangStringVO lPat=textos[j];
			...
			if(masRequisitos!=null && masRequisitos.length!=0){
				OtrosRequisitosVO otro=masRequisitos[0];
				LangStringVO[] textos=otro.getTextos();
				ArrayList lista=new ArrayList();
				for(int j=0;j<textos.length;j++){
					LangStringVO lOtro=textos[j];
			...
			if(duracionDesc!=null && duracionDesc.length!=0){
				DescripcionVO descD=duracionDesc[0];
			...
			//throw new java.lang.Exception("tecnica", e);
			saveErrorMessage(request, " Error en catalogadorWeb, categoría Tecnica, metodo guardarTecnica ");
...
//					TecnicaSession tecnicaSession = this.getTecnicaSession(request);
					AvTechnicalVO tecnicaSession = auxAvanzado.getTechnical();
					if (tecnicaSession.getFormatos() == null && tamAux == null && tecnicaSession.getLocalizaciones() == null && tecnicaSession.getRequisitos() == null && pautas == null
	...
	public void anadirInstalacion(ActionMapping mapping, AnadirInstalacionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		try{
           ...
           Object[] aPautas=form.getDescripcionInstalacionAsArray();
			...
			//throw new Exception("tecnica",e);
			saveErrorMessage(request, " Error en Servicio de catalogacionWeb, categoría Tecnica, metodo anadirInstalacion ");
		}     
	...
	private void cambioFormulario(HttpServletRequest request,int longitudFormatos,int longitudLocalizacion,int longitudRequisitos,
			...
			FormatoVO[] formatos=new FormatoVO[longitudFormatos];//form.getIdentificadores().size()
			LocalizacionVO[] localizaciones = new LocalizacionVO[longitudLocalizacion];//form.getIdiomas().size()
			RequisitoVO[] requisitos = new RequisitoVO[longitudRequisitos];//form.getDescripciones().size()
//		  	agregadores = new AgregadorORVO[longitudAgregadores];//form.getPalabrasClave().size()
			PautasInstalacionVO[] notasDeInstalacion =new PautasInstalacionVO[1];
			OtrosRequisitosVO[] masRequisitos =new OtrosRequisitosVO[1];
			DuracionVO duracion=new DuracionVO();
			DescripcionVO[] duracionDesc=new DescripcionVO[1];
	       ...
	       for (Enumeration names = request.getParameterNames(); names.hasMoreElements();)
	       {
	      	...
	      	if (name.startsWith("Tam")){
	      		String tamaño=request.getParameter(name);
	      		tecnicaSession.setTamanio(tamaño);
	           }
	        ...
	        if (name.equals("Anyos")){
	    		   String anyos = request.getParameter(name);
	        	   tecnicaSession.setAnyos(anyos);
	        }
	    	if (name.equals("Meses")){
	    		   String meses = request.getParameter(name);
	    		   tecnicaSession.setMeses(meses);
	    	}
	    	if (name.equals("Dias")) {
	    		   String dias = request.getParameter(name);
	    		   tecnicaSession.setDias(dias);
	    	}
	    	if (name.equals("Horas")) {
	    		   String horas = request.getParameter(name);
	    		   tecnicaSession.setHoras(horas);
	    	}
	    	if (name.equals("Minutos")) {
	    		   String minutos = request.getParameter(name);
	    		   tecnicaSession.setMinutos(minutos);
	    	}
	    	if (name.equals("SegundosP1")) {
	    		   String segundosP1 = request.getParameter(name);
	    		   tecnicaSession.setSegundosP1(segundosP1);
	    	}
	    	if (name.equals("SegundosP2")) {
	    		   String segundosP2 = request.getParameter(name);
	    		   tecnicaSession.setSegundosP2(segundosP2);
	    	}	
	       ...
	       //actualizamos formatos
	       tecnicaSession.setFormatos(Arrays.asList(formatos));
	       ...
	       //actualizamos localizaciones
	       tecnicaSession.setLocalizaciones(Arrays.asList(localizaciones));
	       ...
	       //actualizamos requisitos
	       tecnicaSession.setRequisitos(Arrays.asList(requisitos));
	       ...
	       //actualizamos notasDeInstalacion en sesson
	       tecnicaSession.setNotasDeInstalacion(Arrays.asList(notasDeInstalacion));
	       ...
	       //actualizamos masrequisitos en session
	       tecnicaSession.setMasRequisitos(Arrays.asList(masRequisitos));
...
//	     descripcion duracion
	       ...
	       //actualizamos desc duracion en session
	       tecnicaSession.setDuracionDesc(Arrays.asList(duracionDesc));
	       tecnicaSession.setDuracion(duracion);
	    }
		
	private void dameTerminoId(TecnicaSession tecnicaSession) throws Exception{
	    ...
	    tecnicaSession.setAgregadores(Arrays.asList(requisitos));
	    ...
	    notasDeInstalacion[0].setTextos(langInstalacion);
	    tecnicaSession.setNotasDeInstalacion(Arrays.asList(notasDeInstalacion));
	    ...
	    masRequisitos[0].setTextos(langMas);
	    tecnicaSession.setMasRequisitos(Arrays.asList(masRequisitos));
	   ...
	   //act sesion
	   duracionDesc[0].setTextos(langTADesc);
	   tecnicaSession.setDuracionDesc(Arrays.asList(duracionDesc));
	}
	
	
	private void descifrarDuration(DuracionVO duracion,TecnicaSession tecnicaSession){
...
//		 String segundosP2="";
		if(duraci != null && !duraci.equals("") && correcto && !duraci.equals("P") && !duraci.equals("PT")){
			...
			else 
			{
				...
				if (posiH > -1){
					...
					tecnicaSession.setHoras(duracionParteT.substring(0, posiH));
				}
				...
				if(posiMi > -1){
					...
					tecnicaSession.setMinutos(duracionParteT.substring(0,posiMi));
				}
				...
				if(posiS>-1){
					if (posiPunto < 0 && !duracionParteT.equals("")){
						...
						tecnicaSession.setSegundosP1(duracionParteT.substring(0, duracionParteT.length()-1));
					}
					else{
						//segundosP1 = duracionParteT.substring(0, posiPunto);
						tecnicaSession.setSegundosP1(duracionParteT.substring(0, posiPunto));
						//segundosP2 = duracionParteT.substring(posiPunto+1, duracionParteT.length()-1);
						tecnicaSession.setSegundosP2(duracionParteT.substring(posiPunto+1, duracionParteT.length()-1));
					}
				}
			...
			if (posiY > -1){
				...
				tecnicaSession.setAnyos(duracionResto.substring(0,posiY));
			}
			//duracionResto = [mM][dD]
			...
			if (posiM > -1){
				...
				tecnicaSession.setMeses(duracionResto.substring(0,posiM));
			}
			//duracionResto = [dD]
			...
			if (posiD > -1){
				...
				tecnicaSession.setDias(duracionResto.substring(0,duracionResto.length()-1));
			}
		}
		else {
			tecnicaSession.setAnyos("");tecnicaSession.setMeses("");tecnicaSession.setDias("");tecnicaSession.setHoras("");
			tecnicaSession.setMinutos("");tecnicaSession.setSegundosP1("");tecnicaSession.setSegundosP2("");
		}
	}
	...
	public void cargarTechnicalValidar(ActionMapping mapping, CargarTechnicalValidarForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try{
			...
			for (int x = 0; x < longVocabulario; x++) {
				...
				case 0:
					...
					if ((catalogadorAvSession.getMDSesion().getTechnical() != null)&&(catalogadorAvSession.getMDSesion().getTechnical().getFormatos() !=null)) {
						...
						if (formatosVO!=null && formatosVO.length>0)
						{
							for(int j=0;j<formatosVO.length;j++){
								terminoypadreVO = new TerminoYPadreVO();
								terminoypadreVO.setIdiomaTermino("en");
			...
			//throw new java.lang.Exception("tecnica", e);
			saveErrorMessage(request, " Error en catalogadorWeb, categoría Tecnica, metodo cargarTechnicalValidar ");
		}
	}
...
//	}
	...
	throws Exception 
	{
	    try{
			...
			//throw new java.lang.Exception("tecnica", e);
			saveErrorMessage(request, " Error en catalogadorWeb, categoría Tecnica, metodo reset ");
	...
	private void cargarAyuda(TecnicaSession tec, Locale idioma) {	
		...
		tec.setAyudaAgregadoror(datosResources.getString("cat.ayuda.tecnica.agregadorOR"));
		tec.setAyudaDuracion(datosResources.getString("cat.ayuda.tecnica.duracion"));
		tec.setAyudaFormato(datosResources.getString("cat.ayuda.tecnica.formato"));
		tec.setAyudaLoc(datosResources.getString("cat.ayuda.tecnica.localizacion"));
		tec.setAyudaOtrosReq(datosResources.getString("cat.ayuda.tecnica.otrosreq"));
		tec.setAyudaPautasInst(datosResources.getString("cat.ayuda.tecnica.pautas"));
		tec.setAyudaRequisitos(datosResources.getString("cat.ayuda.tecnica.requisito"));
		tec.setAyudaTam(datosResources.getString("cat.ayuda.tecnica.tamanio"));

		logger.debug("TECNICA CONTROLLER, CARGADA AYUDA CONTEXTUAL idioma " + idioma);
	}  
