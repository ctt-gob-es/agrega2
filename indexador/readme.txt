	...
	Project Name:               indexador
	Project Id:                 indexador
	Project version:            0.1
	Base Project Package:       es.pode.indexador
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\crmunoz\.maven\repository\indexador\

        (*nix)
        /home/crmunoz/.maven/repository/indexador/
