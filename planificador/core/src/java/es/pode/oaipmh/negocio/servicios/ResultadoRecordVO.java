...
public class ResultadoRecordVO  implements java.io.Serializable {
    ...
    /* Fecha publicaci贸n del recurso dentro del repositorio. */
     ...
     * 
     * @return fecha   * Fecha publicaci贸n del recurso dentro del repositorio.
     */
     ...
     * 
     * @param fecha   * Fecha publicaci贸n del recurso dentro del repositorio.
     */
