...
public class ResultadoOAIRequest  implements java.io.Serializable {
    ...
    /* Descripci贸n del error que se produce durante la validaci贸n
     * de la
     ...
     * 
     * @return errorDescripcion   * Descripci贸n del error que se produce durante la validaci贸n
     * de la
     *                                 llamada al protocolo oai-pmh
     */
     ...
     * 
     * @param errorDescripcion   * Descripci贸n del error que se produce durante la validaci贸n
     * de la
     *                                 llamada al protocolo oai-pmh
     */
