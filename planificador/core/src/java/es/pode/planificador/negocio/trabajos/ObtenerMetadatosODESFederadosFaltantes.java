...
public class ObtenerMetadatosODESFederadosFaltantes extends AbstractJob {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		String msgObtenerMetadatosFaltantes=ConstantesAgrega.TRABAJO_CORRECTO;
		String msgNoObtenerMetadatosFaltantes =ConstantesAgrega.TRABAJO_ERRONEO;
		
		log.debug("ObtenerMetadatosODESFederadosFaltantes: " + context.getJobDetail().getFullName() + " ejecutandose a las " + new Date());
		...
		ResultadoTareaVO resultado=servicio.obtenerMetadatosODESFederadosFaltantes(idTarea);
		
		log.debug("Registramos el estado final de la tarea ObtenerMetadatosODESFederadosFaltantes");
		...
		if (resultado!=null) {					
			...
			if(!resultado.getResultadoGlobal().equals("OK")) {
				...
				Planificador.registrarTareaIncorrecta(idTarea, estado, msgNoObtenerMetadatosFaltantes);
				registraEstadoFinal(idTarea, tarea, msgNoObtenerMetadatosFaltantes, estado);		
			} else {						
				registraEstadoFinal(idTarea, tarea, msgObtenerMetadatosFaltantes, estado);		
			}
		}else
		{
			estado = ConstantesAgrega.TRABAJO_ERRONEO;
