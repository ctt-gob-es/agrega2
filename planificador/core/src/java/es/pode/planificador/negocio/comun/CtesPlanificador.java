...
{	
	...
	public final static String TAREA_DESC_REGENERAR_IMAGENES = "RegenerarImagenes";
	public final static String MSG_REGENERACION_OK = "Regeneración de imagenes correcta";
	public final static String MSG_REGENERACION_KO = "Regeneración de imagenes incorrecta";
	public final static String TAREA_DESC_GENERAR_SITEMAPS = "GenerarSitemaps";
	public final static String MSG_GENERACION_SITEMAPS_OK = "Generación de sitemaps correcta";
	public final static String MSG_GENERACION_SITEMAPS_KO = "Generación de sitemaps incorrecta";
	public final static String TAREA_DESC_LANZAR_RSS = "LanzarRSS";
	public final static String MSG_LANZAR_RSS_OK = "Lanzar RSS correcta";
	public final static String MSG_LANZAR_RSS_KO = "Lanzar RSS incorrecta";
	public final static String MSG_DESPUBLICADO = "Despublicación correcta";
	public final static String MSG_NODESPUBLICADO = "Despublicación incorrecta";
	public final static String MSG_GENERAR_OAI_ORE_OK = "Generación Oai-Ore correcta";
	public final static String MSG_GENERAR_OAI_ORE_KO = "Generación Oai-Ore incorrecta";
