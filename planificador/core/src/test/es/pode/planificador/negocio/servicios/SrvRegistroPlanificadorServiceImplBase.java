 ...
 */
public class SrvRegistroPlanificadorServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvRegistroPlanificadorServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.planificador.negocio.servicios.SrvRegistroPlanificadorService
    */
    
    protected es.pode.planificador.negocio.servicios.SrvRegistroPlanificadorService servicio;
	public void setServicio(es.pode.planificador.negocio.servicios.SrvRegistroPlanificadorService servicio) {
