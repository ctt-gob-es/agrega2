 ...
 */
public class SrvPlanificadorServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvPlanificadorServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.planificador.negocio.servicios.SrvPlanificadorService
    */
    
    protected es.pode.planificador.negocio.servicios.SrvPlanificadorService servicio;
	public void setServicio(es.pode.planificador.negocio.servicios.SrvPlanificadorService servicio) {
