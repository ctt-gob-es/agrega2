	...
	Project Creator:            Neme Berges
	Project Name:               HerramientaOffline
	Project Id:                 HerramientaOffline
	Project version:            1
	Base Project Package:       es.agrega
	Acegi Security Generation:  no
	Front-end type:             STRUTS
	BPM support:				no
	Rules support:				no	
	Rule Type:					$ruleEngine
	BIRT Reports:				no
	LOPD support:				$lopdAnswer
	I18N support:				no
    ...
    The project located in this directory has been generated by Neme Berges
    ...
    /HerramientaOffline J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\Neme Berges\.maven\repository\HerramientaOffline\

        (*nix)
        /home/Neme Berges/.maven/repository/HerramientaOffline/
