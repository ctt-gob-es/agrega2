...
<form method="post"  action="<html:rewrite action="/Uploader/InformeAceptar"/>" >
	 ...
	 <div class="caja_tabla bordeada"  >
					...
					summary="${summary}" sort="list" pagesize="8">
						...
						<display:setProperty name="basic.msg.empty_list_row"><tr><td valign="top"  class="tar" ><bean:message key="subir.sinOdes"/></td></tr></display:setProperty>
		...
		<!-- ******************************      Boton Volver     ********************************** -->
		<input type="submit" class="boton_125_de_2 tipo"	value="<bean:message key="comun.Aceptar"/>" />
