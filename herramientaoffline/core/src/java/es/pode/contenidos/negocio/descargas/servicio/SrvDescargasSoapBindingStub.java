...
public class SrvDescargasSoapBindingStub extends org.apache.axis.client.Stub implements es.pode.contenidos.negocio.descargas.servicio.SrvDescargas {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("insertarCategoriasDescarga");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicio.descargas.negocio.contenidos.pode.es", "identificador"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "long"), java.lang.Long.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicio.descargas.negocio.contenidos.pode.es", "categorias"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://servicio.descargas.negocio.contenidos.pode.es", "ArrayOfCategoriaDescargaVO"), es.pode.contenidos.negocio.descargas.servicio.CategoriaDescargaVO[].class, false, false);
        param.setItemQName(new javax.xml.namespace.QName("http://servicio.descargas.negocio.contenidos.pode.es", "item"));
        oper.addParameter(param);
        oper.setReturnType(org.apache.axis.encoding.XMLType.AXIS_VOID);
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("obtenerCategoriaDescargaIdioma");
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://servicio.descargas.negocio.contenidos.pode.es", "ArrayOfCategoriaDescargaVO"));
        oper.setReturnClass(es.pode.contenidos.negocio.descargas.servicio.CategoriaDescargaVO[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://servicio.descargas.negocio.contenidos.pode.es", "obtenerCategoriaDescargaIdiomaReturn"));
        param = oper.getReturnParamDesc();
        param.setItemQName(new javax.xml.namespace.QName("http://servicio.descargas.negocio.contenidos.pode.es", "item"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {identificadores});
  ...
  throw axisFaultException;
    ...
    public void insertarCategoriaDescarga(java.lang.Long identificador, java.lang.String idioma, java.lang.String titulo) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {identificador, idioma, titulo});
  ...
  throw axisFaultException;
    ...
    public void insertarCategoriasDescarga(java.lang.Long identificador, es.pode.contenidos.negocio.descargas.servicio.CategoriaDescargaVO[] categorias) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("insertarCategoriasDescarga");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicio.descargas.negocio.contenidos.pode.es", "insertarCategoriasDescarga"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {identificador, categorias});
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {identificador});
  ...
  throw axisFaultException;
    ...
    public es.pode.contenidos.negocio.descargas.servicio.CategoriaDescargaVO[] obtenerCategoriaDescargaIdioma(es.pode.contenidos.negocio.descargas.servicio.DescargaVO[] descargas, java.lang.String idioma) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("obtenerCategoriaDescargaIdioma");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicio.descargas.negocio.contenidos.pode.es", "obtenerCategoriaDescargaIdioma"));
