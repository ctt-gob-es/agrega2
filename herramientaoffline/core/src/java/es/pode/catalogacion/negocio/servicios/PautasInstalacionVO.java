...
public class PautasInstalacionVO  implements java.io.Serializable {
    private es.pode.catalogacion.negocio.servicios.LangStringVO[] textos;

    public PautasInstalacionVO() {
    }
    ...
    /**
     * Gets the textos value for this PautasInstalacionVO.
     * 
     * @return textos
     */
    ...
    /**
     * Sets the textos value for this PautasInstalacionVO.
     * 
     * @param textos
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PautasInstalacionVO)) return false;
        PautasInstalacionVO other = (PautasInstalacionVO) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PautasInstalacionVO.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios.negocio.catalogacion.pode.es", "PautasInstalacionVO"));
