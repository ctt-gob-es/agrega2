 ...
 */
public class DescomprimeYvalidaImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(DescomprimeYvalidaImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.herramientaOffline.negocio.soporte.DescomprimeYvalida
    */
    
    protected es.pode.herramientaOffline.negocio.soporte.DescomprimeYvalida servicio;
	public void setServicio(es.pode.herramientaOffline.negocio.soporte.DescomprimeYvalida servicio) {
