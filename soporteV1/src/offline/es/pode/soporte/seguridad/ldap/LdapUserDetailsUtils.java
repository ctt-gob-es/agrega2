...
public class LdapUserDetailsUtils {
	...
	/**
	 * Version offline. Siempre usar funcionalidad de usuario sin identidad federada.
	...
	public static String getVisualizador(){
		es.pode.soporte.offline.configuracion.ConfiguracionDao config = es.pode.soporte.offline.configuracion.ConfiguracionDao.instance(); 
		return config.getProperty(es.pode.soporte.offline.configuracion.ConfiguracionDao.VISUALIZADOR);
	}
