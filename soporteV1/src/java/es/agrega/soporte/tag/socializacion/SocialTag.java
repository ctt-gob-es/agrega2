...
//	    	  //Se pinta el enlace para enviar un correo (subdominio + path)
  			  String pathCorreo = "/buscador/EnviarMailCU/EnviarMailCU.do?identificadorODE=" + identificadorODE + "&amp;idioma=" + idioma + "&amp;tipoLayoutBuscador=" + buscadorEmpaquetador + "&amp;urlODE=" + urlEnviar + "&amp;titulo=" + titulo + "&amp;mostrarVuelta=" + mostrarVuelta +"&amp;urlImagen=" + urlImagen +"&amp;nodoOrigen=" + nodoOrigen +"&amp;tieneIdentidadFederada=" + tieneIdentidadFederada;
