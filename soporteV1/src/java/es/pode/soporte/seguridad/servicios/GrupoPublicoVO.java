...
public class GrupoPublicoVO  implements java.io.Serializable {
    ...
    private es.pode.soporte.seguridad.servicios.OdeGrupoVO[] odeGrupo;
    ...
    public GrupoPublicoVO(
           ...
           java.lang.Long id,
           es.pode.soporte.seguridad.servicios.OdeGrupoVO[] odeGrupo) {
           this.nombre = nombre;
     ...
     * @return odeGrupo
     */
    public es.pode.soporte.seguridad.servicios.OdeGrupoVO[] getOdeGrupo() {
        return odeGrupo;
    }
     ...
     * @param odeGrupo
     */
    public void setOdeGrupo(es.pode.soporte.seguridad.servicios.OdeGrupoVO[] odeGrupo) {
        this.odeGrupo = odeGrupo;
    }
