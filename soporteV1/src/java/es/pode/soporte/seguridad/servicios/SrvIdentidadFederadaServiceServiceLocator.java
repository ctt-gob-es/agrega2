...
public class SrvIdentidadFederadaServiceServiceLocator extends org.apache.axis.client.Service implements es.pode.soporte.seguridad.servicios.SrvIdentidadFederadaServiceService {
 ...
 */
    ...
    private java.lang.String SrvIdentidadFederadaService_address = "http://localhost:8080"+LdapUserDetailsUtils.getSubdominioServices()+"/adminusuarios/services/SrvIdentidadFederadaService";
    ...
    public es.pode.soporte.seguridad.servicios.SrvIdentidadFederadaService getSrvIdentidadFederadaService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	es.pode.soporte.seguridad.servicios.SrvIdentidadFederadaServiceSoapBindingStub _stub = new es.pode.soporte.seguridad.servicios.SrvIdentidadFederadaServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.pode.soporte.seguridad.servicios.SrvIdentidadFederadaService.class.isAssignableFrom(serviceEndpointInterface)) {
            	es.pode.soporte.seguridad.servicios.SrvIdentidadFederadaServiceSoapBindingStub _stub = new es.pode.soporte.seguridad.servicios.SrvIdentidadFederadaServiceSoapBindingStub(new java.net.URL(SrvIdentidadFederadaService_address), this);
                _stub.setPortName(getSrvIdentidadFederadaServiceWSDDServiceName());
                return _stub;
            }
        }
