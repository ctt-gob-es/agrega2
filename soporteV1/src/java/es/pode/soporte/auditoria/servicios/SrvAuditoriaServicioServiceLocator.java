 ...
 */
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "SrvAuditoriaServicioService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://servicios.auditoria.soporte.pode.es", "SrvAuditoriaServicio"));
        }
