...
/**
 * ParÃ¡metro que alberga los datos con la informaciÃ³n necesaria
 *                         para realizar la bÃºsqueda en el Ã­ndice de
 * la nube de tags
 */
public class ParamPalabrasClave  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios.buscador.soporte.pode.es", "ParamPalabrasClave"));
