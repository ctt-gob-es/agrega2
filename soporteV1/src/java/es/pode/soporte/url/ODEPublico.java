...
public class ODEPublico {
	...
	private static Logger logger = Logger.getLogger(ODEPublico.class);
	protected final static String URL_SEPARATOR = "/";
	protected final static String FICHA_URL_PREFIX = "ODE2";
	protected final static String FICHA_PRIVADA_URL_PREFIX = "ODE";
	...
	{
		return urlFichaODEPublicado(idODE, idioma , null,false);
	}
	...
	{
		return urlFichaODEPublicado(idODE, idioma , nodo,false);
	}
	
	/**
	 * Construye la url de la ficha privada de un ODE público.
	 * @param idODE Identificador del ODE público.
	 * @param idioma Código del idioma en el que se quiere mostrar la previsualización (es, en, ca ..).
	 * @return URL que permite acceder a la ficha del ODE publicado.
	 */
	public static String urlFichaPrivadaODEPublicado(String idODE, String idioma)
	{
		return urlFichaODEPublicado(idODE, idioma , null,true);
	}	
	 ...
	 * @param idioma Código del idioma en el que se quiere mostrar la previsualización (es, en, ca ..).
	 * @param nodo url de un nodo federado.
	 * @param bFichaPrivada Si es true accede a la ficha privada y sino a la pública.
	 * @return URL que permite acceder a la ficha del ODE publicado.
	 */
	public static String urlFichaODEPublicado(String idODE, String idioma , String nodo, boolean bFichaPrivada)
	{
		...
		if (bFichaPrivada)
			sb.append(FICHA_PRIVADA_URL_PREFIX);
		else
