 ...
 */
public class SrvCorreoImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvCorreoImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.gestorCorreo.negocio.servicios.SrvCorreo
    */
    
    protected es.pode.gestorCorreo.negocio.servicios.SrvCorreo servicio;
	public void setServicio(es.pode.gestorCorreo.negocio.servicios.SrvCorreo servicio) {
