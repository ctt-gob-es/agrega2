...
<form id="eliminarGrupoPublicoConfirmacionEliminacionVolverForm" action='<html:rewrite action="/EliminarImagenPerfil/ResultadoEliminacionVolver"/>' method="post"  >
				...
				<div class="globo_gris_03">
					...
					<div id="formulario" class="ali_c">
						...
						<logic:equal name="form" property="resultado" value="OK" >
							<p><em class="correcto"><bean:message key="usuario.eliminar.imagen.OK" /></em></p>
	                    </logic:equal>
						<logic:equal name="form" property="resultado" value="FALLO" >
                        	<p><em class="incorrecto"><bean:message key="usuario.eliminar.imagen.KO" /></em></p>
	                    </logic:equal>
						<br />
					</div>
