...
<form id=desasociarUsuarioDeGrupoConfirmarDesasociarUsuarioObtenerAccionForm action='<html:rewrite action="/DesasociarUsuarioDeGrupo/ConfirmarDesasociarUsuarioObtenerAccion"/>' method="post"  >
		...
		<div class="globo_gris_02">
			...
			<!--  INICIO CAJA DE FORMULARIO   -->
					...
					<input type="hidden" name="usuario" value="${form.usuario}"/>
						...
						<br />
						<p><em class="corrector"><bean:message key="odes.desasociarUsuarioGrupo.confirmacion"/></em></p>
						<p>${form.usuario}</p>
						<p>${form.nombre}</p>	
