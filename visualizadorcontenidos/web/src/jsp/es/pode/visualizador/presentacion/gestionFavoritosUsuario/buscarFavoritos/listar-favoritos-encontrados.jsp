...
<form id="buscarFavoritosListarFavoritosEncontradosBuscarForm" action='<html:rewrite action="/BuscarFavoritos/ListarFavoritosEncontradosBuscar"/>' method="post" >
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<div class="globo_gris_03" >
				...
				<div id="formulario"   >
				<h3><bean:message key="texto.favoritos.lista"/></h3>
			
			<c:if test="${fn:length(form.favoritosEncontrados)>0}">
			<pg:pager id="pgfavoritos" items="${fn:length(form.favoritosEncontrados)}" maxPageItems="4" maxIndexPages="10" scope="request" export="currentPageNumber=pageNumber">
							<c:forEach items="${form.favoritosEncontrados}" var="favorito">
		...
		<c:if test="${fn:length(form.favoritosEncontrados)<1}">
		<div class="globo_blanco gb_ie" >
				<div class="globo_blanco_01">
					<div class="globo_blanco_02">
