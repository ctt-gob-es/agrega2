...
public class UsuarioPublicoVO  implements java.io.Serializable {
     ...
     * @param grupoPublico
     */
    public void setGrupoPublico(es.pode.adminusuarios.negocio.servicios.GrupoPublicoVO[] grupoPublico) {
        this.grupoPublico = grupoPublico;
    }
     ...
     */
    public void setFavoritoUsuario(es.pode.adminusuarios.negocio.servicios.FavoritoVO[] favoritoUsuario) {
        this.favoritoUsuario = favoritoUsuario;
    }
     ...
     * @param contacto
     */
    public void setContacto(es.pode.adminusuarios.negocio.servicios.ContactoVO[] contacto) {
        this.contacto = contacto;
    }
