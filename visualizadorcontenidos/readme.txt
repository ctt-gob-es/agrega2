	...
	Project Creator:            javi mu¤oz
	Project Name:               visualizadorcontenidos
	Project Id:                 visualizadorcontenidos
	Project version:            1.0
    ...
    The project located in this directory has been generated by javi mu¤oz
    ...
    /visualizadorcontenidos J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\javi mu¤oz\.maven\repository\visualizadorcontenidos\

        (*nix)
        /home/javi mu¤oz/.maven/repository/visualizadorcontenidos/
