		...
		<div class="a_f_i" >
			<div class="rm3">
				<div style="float:left">
					...
					<span class="oculto">-</span><input style="margin-left:12px;" type="checkbox" class="check" id="Formato01" name="Formato"  /><label class="enlinea"><spring:message code="recordarme"/></label><br />
	...
	<div class="acceso_filtro"> 
		...
		<div class="a_f_1">
			<div class="rm2">
				...
				<input type="hidden" name="lt" value="${flowExecutionKey}" />
				<input type="hidden" name="_eventId" value="submit" />
				<input class="boton_125"  type="submit"  value="<spring:message code="acceder"/>" /><br/>
				<c:if test="${el:esRememberMe()}">
					<span class="oculto">-</span><input style="margin-left:12px;" type="checkbox" class="check" id="rememberMe" name="rememberMe" value="true"/><label class="enlinea"><spring:message code="recordarme"/></label><br />
				</c:if>
				<c:if test="${el:esOpenId()}">
					<span class="oculto">-</span><a href="<%=response.encodeRedirectURL("openid" + (request.getQueryString() != null && request.getQueryString().length() > 0 ? "?" + request.getQueryString() : ""))%>"><spring:message code="accesoOpenId"/></a><br />
				</c:if>
