...
<%
	//InputStream fIsSpringProperties = this.getClass().getResourceAsStream("/cas.properties");
	//InputStream fIsSpringProperties = this.getClass().getResourceAsStream("/agrega.properties");	
	//java.util.Properties pSpringProperties = null;
	...
	//}
	//String entorno = pSpringProperties.getProperty("entorno");
	//String entorno = pSpringProperties.getProperty("host");
	...
	response.sendRedirect("http://" +  entorno + subdominio + "/portaladministracion/");
%>
