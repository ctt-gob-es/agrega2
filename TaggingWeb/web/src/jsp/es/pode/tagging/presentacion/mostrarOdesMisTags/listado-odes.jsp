...
<!-- *****************************   Fin  PESTANIAS de FICHA      ********************************** -->	
	...
	<div class="interno_ficha">
		...
		<div class="plantilla_contenido_pestanias">
			...
			<form action="<html:rewrite action="/MostrarOdesMisTags/ListadoOdesVolver"/>" method="post" enctype="multipart/form-data">
				...
				<div class="caja_tabla">
					...
					summary="${summary}" sort="list" pagesize="8">
						...
						<display:column style="valign:top;" class="tar7">
 							<html:link href="${fila.url}" styleClass="paquete">
               					${fila.titulo}
               				</html:link>
            			</display:column>
