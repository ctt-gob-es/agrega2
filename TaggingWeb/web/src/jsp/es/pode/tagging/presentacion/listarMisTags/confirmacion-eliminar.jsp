...
<form id="listarMisTagsConfirmacionEliminarSubmitConfirmacionForm" action="<html:rewrite action="/ListarMisTags/ConfirmacionEliminarSubmitConfirmacion"/>">
<!--  INICIO GLOBO GRIS   -->
<!--  INICIO GLOBO GRIS   -->
<div class="globo_gris" >
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<!--		TAG ELIMINADOS		-->
						<display:column>
							<c:out value="${fila}" escapeXml="true" default=""/>
			        	</display:column>
		        	</display:table>
				</div>
