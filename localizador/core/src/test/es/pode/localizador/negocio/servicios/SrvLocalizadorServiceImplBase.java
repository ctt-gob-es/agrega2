 ...
 */
public class SrvLocalizadorServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvLocalizadorServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.localizador.negocio.servicios.SrvLocalizadorService
    */
    
    protected es.pode.localizador.negocio.servicios.SrvLocalizadorService servicio;
	public void setServicio(es.pode.localizador.negocio.servicios.SrvLocalizadorService servicio) {
