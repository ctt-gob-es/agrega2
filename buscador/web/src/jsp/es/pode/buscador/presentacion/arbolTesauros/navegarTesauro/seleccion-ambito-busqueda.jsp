...
<div class="plantilla_contenido">
		<h2><bean:message key="seleccionar.ambitoBusqueda.titulo.tesauro"/></h2>
		<form method="post" action="<html:rewrite action="/NavegarTesauroCU/SeleccionAmbitoBusquedaCargarTesauroPrincipal.do"/>">
		<p class="parrafo_comun" id="separacion2"><bean:message key="seleccionar.ambitoBusqueda.parrafo.tesauro"/></p>
		...
		<div class="text ft_lateral">
			<div class="fila_de_tabla">
				...
				<span class="vert">
					<bean:message key="navegar.tesauro.todosNodos"/>
				</span>
			</div>
		</div>
		...
		<div class="text ft_lateral">
			<div class="fila_de_tabla">
				...
				<span class="vert">
					<bean:message key="navegar.tesauro.nodoParticular"/><server:serverProperties property="ccaa"/>
				</span>
			</div>
		</div>
		<div class="linea_separadora"></div>
