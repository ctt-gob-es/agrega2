...
/**
 * Value Object con la informaci贸n de los odes que tienen asociado
 * cada nivel de agregaci贸n
 */
public class NivelAgregacionContenido  implements java.io.Serializable {
    /* Identificador del nivel de agregaci贸n */
    private java.lang.String id;

    /* N煤mero de odes que tienen asociado ese nivel de agregaci贸n */
     ...
     * 
     * @return id   * Identificador del nivel de agregaci贸n
     */
     ...
     * 
     * @param id   * Identificador del nivel de agregaci贸n
     */
     ...
     * 
     * @return numDoc   * N煤mero de odes que tienen asociado ese nivel de agregaci贸n
     */
     ...
     * 
     * @param numDoc   * N煤mero de odes que tienen asociado ese nivel de agregaci贸n
     */
