...
public class SrvAuditoriaFederadaServicioSoapBindingStub extends org.apache.axis.client.Stub implements es.pode.auditoria.negocio.servicios.SrvAuditoriaFederadaServicio {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "parametros"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "ParametrosInformeFederadoVO"), es.pode.auditoria.negocio.servicios.ParametrosInformeFederadoVO.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "ArrayOfNivelAgregacionVO"));
        oper.setReturnClass(es.pode.auditoria.negocio.servicios.NivelAgregacionVO[].class);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "parametros"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "ParametrosInformeFederadoVO"), es.pode.auditoria.negocio.servicios.ParametrosInformeFederadoVO.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "NivelAgregacionVO"));
        oper.setReturnClass(es.pode.auditoria.negocio.servicios.NivelAgregacionVO.class);
    ...
    public SrvAuditoriaFederadaServicioSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "ArrayOfNivelAgregacionPublicacion");
            cachedSerQNames.add(qName);
            cls = es.pode.auditoria.negocio.servicios.NivelAgregacionPublicacion[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "NivelAgregacionPublicacion");
            qName2 = new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "item");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "ArrayOfNivelAgregacionVO");
            cachedSerQNames.add(qName);
            cls = es.pode.auditoria.negocio.servicios.NivelAgregacionVO[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "NivelAgregacionVO");
            qName2 = new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "item");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {parametros});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (es.pode.auditoria.negocio.servicios.NivelAgregacionVO[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.pode.auditoria.negocio.servicios.NivelAgregacionVO[]) org.apache.axis.utils.JavaUtils.convert(_resp, es.pode.auditoria.negocio.servicios.NivelAgregacionVO[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
