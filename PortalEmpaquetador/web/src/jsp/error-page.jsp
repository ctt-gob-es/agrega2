...
<emp:layout selected="${selected}" urlArchivos="${urlArchivos}" urlEstructura="${urlEstructura}" urlRecursos="${urlRecursos}" urlSubmanifiestos="${urlSubmanifiestos}" urlOrganizaciones="${urlOrganizaciones}" urlGuardar="${urlGuardar}" urlAsistente="${urlAsistente}" titleKey="title.Comun">
   <div class="plantilla_contenido">
<%@ include file="/layout/messages.jsp" %>

<h2><bean:message key="portalempaquetado.avanzado.errorGeneral"/></h2>
	...
	<div class="globo_gris_01">
		<div class="globo_gris_02">
			...
			<br /><br />
			 ...
			 <p><bean:message key="portalempaquetado.avanzado.seHaProducidoUnError"/> <a href="#"><bean:message key="portalempaquetado.avanzado.contacteConAdministrador"/></a>.</p>
				<br /><br />
				</div>
