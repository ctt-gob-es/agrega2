...
<bean:define id="urlAsistente"><html:rewrite action="/GestorElementos/GestorElementos"/></bean:define>
	...
	<div><h2><bean:message key="portal_empaquetado_avanzado.principalElementosTitulo"/></h2></div>
		<ul>
			<logic:equal name="vistaCarpeta" value="true">
				...
				<li id="pest_activa"><a href="<html:rewrite action="/GestorElementos/GestorElementosVista"/>?vistaArbol=true" id="seleccionada"><bean:message key="gestor_basico.vistaPorCarpeta"/></a></li>
			</logic:equal>
			<logic:equal name="vistaCarpeta" value="false">
				
				<li id="pest_activa"><a href="<html:rewrite action="/GestorElementos/GestorElementosVista"/>?vistaArbol=false" id="seleccionada"><bean:message key="gestor_basico.vistaPorArbol"/></a></li>
