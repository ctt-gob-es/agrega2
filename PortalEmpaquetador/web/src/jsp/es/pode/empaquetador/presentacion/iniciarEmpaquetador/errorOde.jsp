...
<h2><bean:message key="iniciarEmpaquetador.ode.mensaje"/></h2>
<p class="parrafo_comun" id="separacion2"><bean:message key="iniciarEmpaquetador.ode.error"/></p>
<!--  INICIO GLOBO GRIS   -->
<!--  INICIO GLOBO GRIS   -->
		...
		<div class="globo_gris_02">
			...
			<div id="formulario" >
			 ...
			 <div class="fila_de_tabla">
  						<div class="text" style="text-align:center"><a href="pagina de inicio"><bean:message key="iniciarEmpaquetador.ode.texto"/></a></div>
					<br class="oculto" />
				</div>
				<br />
				</div>
