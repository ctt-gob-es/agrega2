...
<bean:define id="urlAsistente"><html:rewrite action="/CrearRecursoAvanzadoElementos/RecursoSubmitArchivos"/>?action=Añadir Archivos</bean:define>
...
<ul>
	<logic:equal name="vistaArbol" value="true">
		...
		<li id="pest_activa"><a href="<html:rewrite action="/CrearRecursoAvanzadoArchivos/ArchivosVista"/>?vistaArbol=true"  id="seleccionada"><bean:message key="presentacion.avanzado.recursos.crear.archivos.pestanias.vista.por.arbol"/></a></li>
	...
	<logic:equal name="vistaArbol" value="false">
		...
		<li id="pest_activa"><a href="<html:rewrite action="/CrearRecursoAvanzadoArchivos/ArchivosVista"/>?vistaArbol=false" id="seleccionada"><bean:message key="presentacion.avanzado.recursos.crear.archivos.pestanias.vista.por.carpeta"/></a></li>
	</logic:equal>
</ul>
</div>
...
<c:set var="contador" value="${!contador}"/>
		...
		<form method="post" action="<html:rewrite action="/CrearRecursoAvanzadoArchivos/ArchivosAAdir"/>">
			<fieldset class="tipo ft_centrada"><input class="boton_125" style="width:150px !important"   type="submit" name="Action"  
				value="<bean:message key="presentacion.avanzado.recursos.crear.archivos.seleccionados.submit.aniadir"/>"  />
			</fieldset>
		</form>
...
<td><bean:message key="presentacion.avanzado.recursos.crear.archivos.table.empty.message"/></td>
		...
		<input class="boton_125_de_2"  type="submit" name="action"  
			value="<bean:message key="presentacion.avanzado.recursos.crear.archivos.submit.seleccionar"/>" />
		<br class="oculto" /><br class="oculto" />
		<input class="boton_125_de_2_izq bot_mar_der"  type="submit" name="action"  
			value="<bean:message key="presentacion.avanzado.recursos.crear.archivos.submit.cancelar"/>" />
		</fieldset>
