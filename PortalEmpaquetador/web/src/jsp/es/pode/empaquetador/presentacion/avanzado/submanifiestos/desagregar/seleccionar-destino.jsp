...
<tiles:put name="urlAsistente" type="string"><html:rewrite action="/GestorSubmanifiestos/GestorSubmanifiestos"/>
</tiles:put>
			...
			<div id="formulario" >
			 ...
			 <div class="fila_de_tabla">
  				...
  				<div class="text ft_lateral">
  					<input type="radio" class="boton_radio" id="Origen01" checked="checked" name="destino" value="<bean:message key="portal_empaquetado_gestorSubmanifiestos.desagregar.repositorio"/>"/>
				...
				<!--     -->
			<div class="fila_de_tabla">
  				<div class="text ft_lateral"><input  type="radio" class="boton_radio" id="Origen02"  name="destino" value="<bean:message key="portal_empaquetado_gestorSubmanifiestos.desagregar.local"/>"/><label for="Origen02"  class="alineada2"><bean:message key="portal_empaquetado_desagregarSubmanifiestos.aSuOrdenador"/></label></div>
