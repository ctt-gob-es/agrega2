...
<form method="post" action="<html:rewrite action="/InicioEmpaquetador/TituloSubmit"/>" >
		...
		<div class="globo_gris_02">
			...
			<div id="formulario" >
			 ...
			 <div class="fila_de_tabla">
  						<div class="text" style="text-align:center"><label for="nombreN"><span class="oculto"><bean:message key="iniciarEmpaquetador.titulo"/></span></label><input name="titulo" class="nombreGrupo" value=""  onblur="this.style.backgroundColor='#e1e1e1'" id="nombreN" onkeypress="return event.keyCode!=13"" type="text" title="<bean:message key="iniciarEmpaquetador.mensaje"/>"  /></div>
					<br class="oculto" />
				</div>
				<br />
				</div>
