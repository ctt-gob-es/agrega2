...
<bean:define id="urlAsistente"><html:rewrite action="/Asociar/ObjectEstructura"/></bean:define>
		...
		<div class="globo_gris_02">
			...
			<div id="formulario" style="padding-top:10px;">
				 ...
				 <div class="fila_de_tabla">
  						<div class="text" style="text-align:center"><label for="nombre_embed"><span class="oculto"><bean:message key="portalempaquetado.basico.asociar.embedNombre"/></span></label><textarea name="texto" rows="5" cols="40" class="ta_minimo_ancho" onblur="this.style.backgroundColor='#e1e1e1'" id="nombre_embed"  title="Introduzca aquí" >${form.texto }</textarea></div>
					<br class="oculto" />
				</div>
				<br />
				</div>
