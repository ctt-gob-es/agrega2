...
<input class="boton_125_de_2_izq" type="submit"  name="action"  value="<bean:message key='presentacion.avanzado.organizaciones.gestor.crearOrganizacion'/>" />
<input class="boton_125_de_2"  type="submit"  name="action" value="<bean:message key='presentacion.avanzado.organizaciones.gestor.eliminar'/>" />
<input class="boton_125"  type="submit"  name="action"  value="<bean:message key='presentacion.avanzado.organizaciones.gestor.orgDefecto'/>"/>
</fieldset>
<!-- Fin Botones  -->
<!-- Fin Botones  -->
