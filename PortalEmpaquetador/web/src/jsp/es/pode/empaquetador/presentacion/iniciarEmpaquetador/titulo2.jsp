...
<ol>
	...
	<li><a href="<html:rewrite action="/InicioEmpaquetador/Titulo2Submit"/>?action=<bean:message key="iniciarEmpaquetador.cancelar"/>" title="<bean:message key="metanavegacion.cerrar" />" id="li_inicial"><bean:message key="metanavegacion.cerrar" /></a></li>
...
<form method="post" action="<html:rewrite action="/InicioEmpaquetador/Titulo2Submit"/>" >
<p class="parrafo_comun" id="separacion2"><bean:message key="iniciarEmpaquetador.editar.mensaje"/></p>
<!--  INICIO GLOBO GRIS   -->
<!--  INICIO GLOBO GRIS   -->
		...
		<div class="globo_gris_02">
			...
			<div id="formulario" >
			 ...
			 <div class="fila_de_tabla">
  						<div class="text" style="text-align:center"><label for="nombreN"><span class="oculto"><bean:message key="iniciarEmpaquetador.titulo"/></span></label><input name="titulo" class="nombreGrupo" value=""  onblur="this.style.backgroundColor='#e1e1e1'" id="nombreN" type="text" title="<bean:message key="iniciarEmpaquetador.editar.mensaje"/>"  /></div>
