...
<%@ attribute name="urlAsistente" required="false" %>
<%@ attribute name="urlImagen" required="false" %>
...
<tiles:insert definition="layout-empaquetador-avanzado">
	...
	<tiles:put name="urlAsistente" type="string">${urlAsistente}</tiles:put>
	<tiles:put name="body" type="string"><jsp:doBody/></tiles:put>
</tiles:insert>
</logic:equal>
