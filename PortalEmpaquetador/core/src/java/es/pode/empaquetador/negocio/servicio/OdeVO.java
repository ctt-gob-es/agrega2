 ...
 * a OdeVO y viceversa
 *                         se emplea la librer铆a Dozer. La configuraci贸n
 * del mapeo se
...
public class OdeVO  implements java.io.Serializable {
    ...
    /* C贸digo MEC del Ode en edicion. */
    private java.lang.String codigoMEC;

    /* Identificador de la organizaci贸n principal del OdeVO. Se
     ...
     * 
     * @return codigoMEC   * C贸digo MEC del Ode en edicion.
     */
     ...
     * 
     * @param codigoMEC   * C贸digo MEC del Ode en edicion.
     */
     ...
     * 
     * @return organizacionPrincipal   * Identificador de la organizaci贸n principal del OdeVO. Se
     *                                 corresponde con el atributo default
     * de la clase Organizations.
     */
     ...
     * 
     * @param organizacionPrincipal   * Identificador de la organizaci贸n principal del OdeVO. Se
     *                                 corresponde con el atributo default
     * de la clase Organizations.
     */
