    ...
    A n d r o M D A  -  3.1.7.p01
    
    Project Generation Parameters:

	Project Creator:            The I-Builder Team
	Project Name:               Portal del Empaquetador Basico
	Project Id:                 PortalEmpaquetador
	Project version:            1
	Base Project Package:       es.pode.empaquetador.presentacion
	Acegi Security Generation:  yes
	Front-end type:             STRUTS
	BPM support:				no
	Rules support:				no	
	Rule Type:					$ruleEngine
	BIRT Reports:				no
	LOPD support:				no
	I18N support:				no
	Web Service support:		yes
	Local Service support:		yes	
	Estimation support:			no	
    ...
    The project located in this directory has been generated by The I-Builder Team
    ...
    /Portal del Empaquetador Basico J2EE project
         |
    ...
    list of examples:
        ...
        %> maven gendocs
            ...
            Builds the entire site with reports like news, checkStyle, Test, xRef, JavaDoc Reports, etc.
            NOTE: If you want to see the coverage of test of you code go to your core subproject and execute the 
            maven goal 'maven cobertura'.
            
        %> maven update-project
        
        This goal updates the proyect to a diferent andromda version.
        The arguments are: 
            - xmiToken    = latest version
            - xmiValue    = new version
            - directory   = base proyect directory to migrate 
            - overwriteXMI = true by default (beware with BPM proyects)        
		...
		%> maven create-update-script
		
			creates a DDL incremental script comparing the current database schema
		    with the current hibernate mapping files
        ...
        %> maven build -Dfilter=java core web deploy

            runs AndroMDA only compiling the implementation classes
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\The I-Builder Team\.maven\repository\PortalEmpaquetador\

        (*nix)
        /home/The I-Builder Team/.maven/repository/PortalEmpaquetador/
