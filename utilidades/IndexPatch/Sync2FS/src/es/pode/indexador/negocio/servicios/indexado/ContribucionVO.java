...
/**
 * Contribución de personas y/o entidades al estado del ODE.
 */
public class ContribucionVO  implements java.io.Serializable {
     ...
     * el
     *                                 ODE */
    private es.pode.indexador.negocio.servicios.indexado.EntidadVO[] entidades;
    ...
    public ContribucionVO(
           ...
           es.pode.indexador.negocio.servicios.indexado.EntidadVO[] entidades) {
     ...
     * 
     * @return codTipoContribucion   * Tipo de contribución
     */
     ...
     * 
     * @param codTipoContribucion   * Tipo de contribución
     */
     ...
     * 
     * @return fecha   * Fecha de la contribución
     */
     ...
     * 
     * @param fecha   * Fecha de la contribución
     */
     ...
     *                                 ODE
     */
    public es.pode.indexador.negocio.servicios.indexado.EntidadVO[] getEntidades() {
        return entidades;
    }
     ...
     *                                 ODE
     */
    public void setEntidades(es.pode.indexador.negocio.servicios.indexado.EntidadVO[] entidades) {
        this.entidades = entidades;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "ContribucionVO"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("codTipoContribucion");
        elemField.setXmlName(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "codTipoContribucion"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fecha");
        elemField.setXmlName(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "fecha"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("entidades");
        elemField.setXmlName(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "entidades"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://indexado.servicios.negocio.indexador.pode.es", "EntidadVO"));
