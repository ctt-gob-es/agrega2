...
public class RobotsFile {
	...
	protected static final Logger logger = Logger.getLogger(RobotsFile.class);
	
	/**
	 * Fichero/s destino de las variables de configuracion
	 */
	public static String directorioDestino = File.separator + ".." + File.separator + ".." + File.separator + "bin" + File.separator + "uploads" + File.separator + "sitemaps" + File.separator + "estatico";
	public static String ficheroDestino = "robots.txt";
	
	public static String ficheroPlantilla = "/plantillas/robots.txt";
