...
//	galeriaImgPath("galeriaImgPath", true, "default_", Ficheros.AGREGA_PROPERTIES.getFilename()),
	...
	private es.pode.configuracionPlataforma.negocio.dominio.PropiedadDao propiedadDao;
	...
	public void setPropiedadDao(es.pode.configuracionPlataforma.negocio.dominio.PropiedadDao propiedadDao) {
		this.propiedadDao = propiedadDao;
	}

	public es.pode.configuracionPlataforma.negocio.dominio.PropiedadDao getPropiedadDao() {
		return propiedadDao;
	}
