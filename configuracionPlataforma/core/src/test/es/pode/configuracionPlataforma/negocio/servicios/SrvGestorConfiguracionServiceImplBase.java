...
import es.pode.configuracionPlataforma.negocio.servicios.SrvGestorConfiguracionService;
 ...
 */
public class SrvGestorConfiguracionServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvGestorConfiguracionServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.configuracionPlataforma.negocio.servicios.SrvGestorConfiguracionService
    */
    
    protected es.pode.configuracionPlataforma.negocio.servicios.SrvGestorConfiguracionService servicio;
	public void setServicio(es.pode.configuracionPlataforma.negocio.servicios.SrvGestorConfiguracionService servicio) {
