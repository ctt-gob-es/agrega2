...
import es.pode.configuracionPlataforma.negocio.servicios.SrvFicherosConfiguracionService;
 ...
 */
public class SrvFicherosConfiguracionServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvFicherosConfiguracionServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.configuracionPlataforma.negocio.servicios.SrvFicherosConfiguracionService
    */
    
    protected es.pode.configuracionPlataforma.negocio.servicios.SrvFicherosConfiguracionService servicio;
	public void setServicio(es.pode.configuracionPlataforma.negocio.servicios.SrvFicherosConfiguracionService servicio) {
