    ...
    extends AbstractTransactionalDataSourceSpringContextTests
{
    ...
    *  Inyeccion del bean del Servicio es.pode.configuracionPlataforma.negocio.servicios.SrvPropiedadService
    */
    
    protected es.pode.configuracionPlataforma.negocio.servicios.SrvPropiedadService servicio;
	public void setServicio(es.pode.configuracionPlataforma.negocio.servicios.SrvPropiedadService servicio) {
