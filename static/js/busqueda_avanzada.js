...
function getChildsCount(){
	...
	if(trim(document.getElementById("idODE").value)!="") count++;
	if(trim(document.getElementById("autor").value)!="") count++;
	//if(trim(document.getElementById("diaPublic").value)!="" || trim(document.getElementById("mesPublic").value)!="" || trim(document.getElementById("anyoPublic").value)!="") count++;
