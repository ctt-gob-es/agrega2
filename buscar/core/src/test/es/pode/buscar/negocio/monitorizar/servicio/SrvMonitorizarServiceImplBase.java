 ...
 */
public class SrvMonitorizarServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvMonitorizarServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarService
    */
    
    protected es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarService servicio;
	public void setServicio(es.pode.buscar.negocio.monitorizar.servicio.SrvMonitorizarService servicio) {
