 ...
 */
public class TestSrvCacheServiceImpl
    extends SrvCacheServiceImplBase
{
     ...
     * Constructor
     */
     public TestSrvCacheServiceImpl(){
		super();
	}
     ...
     * 	 {@link es.indra.servicios.SrvCacheServiceImplBase#initAthenticationUser(String, String) 
    ...
    /**
     *   TEST borrarHitCache
     *   TODO: Implementar el test para el metodo borrarHitCache del servicio SrvCacheService.
     * 	 En el caso de tener que el metodo borrarHitCache acceda a un webservice
     * 	 el cuál implementa seguridad (se necesita la autenticación de usuario),
     * 	 antes de invocarlo en el test, se debe establecer un usuario con
     * 	 derechos de acceso utilizando el método 
     * 	 {@link es.indra.servicios.SrvCacheServiceImplBase#initAthenticationUser(String, String) 
     * 	 initAuthenticationUser(authenticationUser, authenticationPassword)}
     */
     public void testborrarHitCache() {
		String prueba = null; 
		assertNotNull(prueba);
