 ...
 */
public class SrvCacheServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{

protected static Logger logger = Logger.getLogger(SrvCacheServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.buscar.negocio.buscar.servicios.SrvCacheService
    */
    
    protected es.pode.buscar.negocio.buscar.servicios.SrvCacheService servicio;
	public void setServicio(es.pode.buscar.negocio.buscar.servicios.SrvCacheService servicio) {
