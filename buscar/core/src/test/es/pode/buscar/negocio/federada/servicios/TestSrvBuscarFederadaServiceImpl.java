    ...
    extends SrvBuscarFederadaServiceImplBase
{
    ...
    /**
     *   TEST busquedaFederada12
     *   TODO: Implementar el test para el metodo busquedaFederada12 del servicio SrvBuscarFederadaService.
     * 	 En el caso de tener que el metodo busquedaFederada12 acceda a un webservice
     * 	 el cuál implementa seguridad (se necesita la autenticación de usuario),
     * 	 antes de invocarlo en el test, se debe establecer un usuario con
     * 	 derechos de acceso utilizando el método 
     * 	 {@link es.indra.servicios.SrvBuscarFederadaServiceImplBase#initAthenticationUser(String, String) 
     * 	 initAuthenticationUser(authenticationUser, authenticationPassword)}
     */
     public void testbusquedaFederada12() {
		String prueba = null; 
		assertNotNull(prueba);
    ...
    /**
     *   TEST solicitarDocsCountArbolCurricular12
     *   TODO: Implementar el test para el metodo solicitarDocsCountArbolCurricular12 del servicio SrvBuscarFederadaService.
     * 	 En el caso de tener que el metodo solicitarDocsCountArbolCurricular12 acceda a un webservice
     * 	 el cuál implementa seguridad (se necesita la autenticación de usuario),
     * 	 antes de invocarlo en el test, se debe establecer un usuario con
     * 	 derechos de acceso utilizando el método 
     * 	 {@link es.indra.servicios.SrvBuscarFederadaServiceImplBase#initAthenticationUser(String, String) 
     * 	 initAuthenticationUser(authenticationUser, authenticationPassword)}
     */
     public void testsolicitarDocsCountArbolCurricular12() {
		String prueba = null; 
		assertNotNull(prueba);
