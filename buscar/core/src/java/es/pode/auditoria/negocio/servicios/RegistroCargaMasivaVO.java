...
public class RegistroCargaMasivaVO  implements java.io.Serializable {
    ...
    /**
     * Gets the odesSimilares value for this RegistroCargaMasivaVO.
     * 
    ...
    /**
     * Sets the odesSimilares value for this RegistroCargaMasivaVO.
     * 
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://servicios.negocio.auditoria.pode.es", "odesSimilares"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
