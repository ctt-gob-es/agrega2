 ...
 */
public class SrvValoracionServiceImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvValoracionServiceImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.valoracion.negocio.servicios.SrvValoracionService
    */
    
    protected es.pode.valoracion.negocio.servicios.SrvValoracionService servicio;
	public void setServicio(es.pode.valoracion.negocio.servicios.SrvValoracionService servicio) {
