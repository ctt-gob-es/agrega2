...
/**
 * @see SrvAuditoriaValoracionServiceImpl
 ...
 */
public class TestSrvAuditoriaValoracionServiceImpl
    extends SrvAuditoriaValoracionServiceImplBase
{
     ...
     * Constructor
     */
     public TestSrvAuditoriaValoracionServiceImpl(){
		super();
	}
     ...
     * 	 {@link es.indra.servicios.SrvAuditoriaValoracionServiceImplBase#initAthenticationUser(String, String) 
    ...
    /**
     *   TEST contenidosMasValorados
     *   TODO: Implementar el test para el metodo contenidosMasValorados del servicio SrvAuditoriaValoracionService.
     * 	 En el caso de tener que el metodo contenidosMasValorados acceda a un webservice
     * 	 el cuál implementa seguridad (se necesita la autenticación de usuario),
     * 	 antes de invocarlo en el test, se debe establecer un usuario con
     * 	 derechos de acceso utilizando el método 
     * 	 {@link es.indra.servicios.SrvAuditoriaValoracionServiceImplBase#initAthenticationUser(String, String) 
     * 	 initAuthenticationUser(authenticationUser, authenticationPassword)}
     */
     public void testcontenidosMasValorados() {
		String prueba = null; 
		assertNotNull(prueba);
