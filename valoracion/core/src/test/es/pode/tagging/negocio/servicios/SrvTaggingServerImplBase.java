 ...
 */
public class SrvTaggingServerImplBase
    extends AbstractTransactionalDataSourceSpringContextTests
{
		 protected static final Logger logger = Logger.getLogger(SrvTaggingServerImplBase.class);
    
   /** Aqui se deben de inyectar los beans a utilizar dentro del test
    *  Inyeccion del bean del Servicio es.pode.tagging.negocio.servicios.SrvTaggingServer
    */
    
    protected es.pode.tagging.negocio.servicios.SrvTaggingServer servicio;
	public void setServicio(es.pode.tagging.negocio.servicios.SrvTaggingServer servicio) {
